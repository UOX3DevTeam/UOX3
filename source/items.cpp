...
auto ApplyItemSection( CItem *applyTo, CScriptSection *toApply, std::string sectionId ) -> bool
{
	...
	for( const auto &sec : toApply->collection2() )
	{
		...
		{
			case DFNTAG_AMMO:
				applyTo->SetAmmoId( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				if( ssecs.size() > 1 )
				{
					applyTo->SetAmmoHue( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_AMMOFX:
				applyTo->SetAmmoFX( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				if( ssecs.size() > 1 )
				{
					applyTo->SetAmmoFXHue( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					if( ssecs.size() > 2 )
					{
						applyTo->SetAmmoFXRender( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					}
				}
				break;
			case DFNTAG_AMOUNT:
			...
			case DFNTAG_ELEMENTRESIST:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetResist( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )), HEAT );
					applyTo->SetResist( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )), COLD );
					applyTo->SetResist( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )), LIGHTNING );
					applyTo->SetResist( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )), POISON );
				}
				break;
			case DFNTAG_ERBONUS:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetResist( applyTo->GetResist( HEAT ) + static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )), HEAT );
					applyTo->SetResist( applyTo->GetResist( COLD ) + static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )), COLD );
					applyTo->SetResist( applyTo->GetResist( LIGHTNING ) + static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )), LIGHTNING );
					applyTo->SetResist( applyTo->GetResist( POISON ) + static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )), POISON );
				}
				break;
			...
			case DFNTAG_DIR:			applyTo->SetDir( static_cast<UI08>( std::stoi( util::trim( util::strip( cdata, "//" )), nullptr, 0 )));			break;
			...
			case DFNTAG_ID:				// applyTo->SetId( static_cast<UI16>( ndata ));				break;
				if( ssecs.size() == 1 )
				{
					applyTo->SetId( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				else
				{
					SI32 rndEntry = RandomNum( 0, static_cast<SI32>( ssecs.size() - 1 ));
					applyTo->SetId( static_cast<UI16>( std::stoul( util::trim( util::strip( ssecs[rndEntry], "//" )), nullptr, 0 )));
				}
				break;
			...
			case DFNTAG_MORE:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MORE, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MORE, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_MORE0:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MORE0, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE0, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE0, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE0, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MORE0, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_MORE1:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MORE1, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE1, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE1, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE1, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MORE1, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_MORE2:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MORE2, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE2, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE2, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MORE2, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MORE2, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_MOREX:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MOREX, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREX, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREX, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREX, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MOREX, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_MOREY:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MOREY, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREY, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREY, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREY, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MOREY, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			case DFNTAG_MOREZ:
				if( ssecs.size() >= 4 )
				{
					applyTo->SetTempVar( CITV_MOREZ, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREZ, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREZ, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
					applyTo->SetTempVar( CITV_MOREZ, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( ssecs[3], "//" )), nullptr, 0 )));
				}
				else
				{
					applyTo->SetTempVar( CITV_MOREZ, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
				}
				break;
			...
			case DFNTAG_SPELLS:
				if( ssecs.size() == 3 )
				{
					applyTo->SetSpell( 0, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[0], "//" )), nullptr, 0 )));
					applyTo->SetSpell( 1, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[1], "//" )), nullptr, 0 )));
					applyTo->SetSpell( 2, static_cast<UI32>( std::stoul( util::trim( util::strip( ssecs[2], "//" )), nullptr, 0 )));
				}
				else
				{
	...
	if( ItemList )
	{
		...
		if( itemListSize > 0 )
		{
			...
			for( size_t j = 0; j < itemListSize; j++ )
			{
				...
				auto csecs = oldstrutil::sections( util::trim( util::strip( ItemList->MoveTo( j ), "//" )), "|" );
				if( csecs.size() == 2 )
				{
			...
			for( auto j = 0; j < static_cast<int>( itemListSize ); j++ )
			{
				...
				if( csecs.size() == 2 )
				{
					...
					itemWeight = static_cast<int>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 ));
