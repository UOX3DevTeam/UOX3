...
protected:
    ...
    //==============================================================================
    virtual auto ProcessEntry([[maybe_unused]] std::size_t entry, [[maybe_unused]] std::size_t index, [[maybe_unused]] std::vector<std::uint8_t> &data) -> bool {
        return true;
    }
    virtual auto ProcessHash([[maybe_unused]] std::uint64_t hash, [[maybe_unused]] std::size_t entry, [[maybe_unused]] std::vector<std::uint8_t> &data) -> bool {
        return true;
    }
