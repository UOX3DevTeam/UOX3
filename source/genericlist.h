...
//  it is faster.  This can be reimplemented if one assumes: 1. it only is a list of pointers, which
//  it seems to be, and 2: one does not have duplicates stored.  If those are valid, this class can
