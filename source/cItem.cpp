		...
		switch(( UTag.data()[0] ))
		{
			case 'A':
				if( UTag == "AMMO" )
				{
					if( csecs.size() == 2 )
					{
						SetAmmoId( static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetAmmoHue( static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
					}
					else
					{
						SetAmmoId( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
						SetAmmoHue(( 0 ));
					}
					rValue = true;
				}
				else if( UTag == "AMMOFX" )
				{
					if( csecs.size() == 2 )
					{
						SetAmmoFX( static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetAmmoFXHue( static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
						SetAmmoFXRender( static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
					}
					else
					{
						SetAmmoFX( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
						SetAmmoFXHue(( 0 ));
						SetAmmoFXRender(( 0 ));
					}
					rValue = true;
				...
				{
					amount = static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 ));
					rValue = true;
				}
				else if( UTag == "AC" )
				{
					SetArmourClass( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
			case 'B':
				if( UTag == "BOOLS" )
				{
					bools = static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 ));
					rValue = true;
				}
				break;
			case 'C':
				...
				{
					SetCreator( static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "CORPSE" )
				{
					SetCorpse( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				else if( UTag == "COLD" )
				{
					SetWeatherDamage( COLD, static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				break;
			case 'D':
				...
				if( UTag == "DIR" )
				{
					SetDir( static_cast<SI08>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "DYEABLE" )
				{
					SetDye( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				break;
			case 'E':
				...
				{
					EntryMadeFrom( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "EVENT" )
				{
			...
			case 'G':
				if( UTag == "GRIDLOC" )
				{
					SetGridLocation( static_cast<SI08>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "GLOWTYPE" )
				{
					SetGlowEffect( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "GLOWBC" )
				{
					SetGlowColour( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "GLOW" )
				{
					SetGlow( static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "GOOD" )
				{
					SetGood( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
			case 'H':
				if( UTag == "HEAT" )
				{
					SetWeatherDamage( HEAT, static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				break;
			case 'L':
				if( UTag == "LAYER" )
				{
					layer = static_cast<ItemLayers>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 ));
					rValue = true;
				}
				else if( UTag == "LIGHT" )
				{
					SetWeatherDamage( LIGHT, static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				else if( UTag == "LIGHTNING" )
				{
					SetWeatherDamage( LIGHTNING, static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				break;
			case 'M':
				if( UTag == "MAXITEMS" )
				{
					SetMaxItems( static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "MORE" )
				{
					if( csecs.size() >= 4 )
					{
						SetTempVar( CITV_MORE, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MORE, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MORE, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MORE, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[3], "//" )), nullptr, 0 )));
					}
					else
					{
						SetTempVar( CITV_MORE, static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					}
					rValue = true;
				}
				...
				{
					SetTempVar( CITV_MOREX, static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
					SetTempVar( CITV_MOREY, static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
					SetTempVar( CITV_MOREZ, static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
					rValue = true;
				}
				...
				else if( UTag == "MOREX" )
				{
					if( csecs.size() >= 4 )
					{
						SetTempVar( CITV_MOREX, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREX, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREX, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREX, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[3], "//" )), nullptr, 0 )));
					}
					else
					{
						SetTempVar( CITV_MOREX, static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					}
					rValue = true;
				}
				else if( UTag == "MOREY" )
				{
					if( csecs.size() >= 4 )
					{
						SetTempVar( CITV_MOREY, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREY, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREY, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREY, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[3], "//" )), nullptr, 0 )));
					}
					else
					{
						SetTempVar( CITV_MOREY, static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					}
					rValue = true;
				}
				else if( UTag == "MOREZ" )
				{
					if( csecs.size() >= 4 )
					{
						SetTempVar( CITV_MOREZ, 1, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREZ, 2, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREZ, 3, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
						SetTempVar( CITV_MOREZ, 4, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[3], "//" )), nullptr, 0 )));
					}
					else
					{
						SetTempVar( CITV_MOREZ, static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					}
					rValue = true;
				}
				...
				{
					SetMovable( static_cast<SI08>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "MAXHP" )
				{
					SetMaxHP( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "MAXUSES" )
				{
					SetMaxUses( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
			case 'N':
			...
			case 'O':
				if( UTag == "OFFSPELL" )
				{
					SetOffSpell( static_cast<SI08>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
			case 'P':
				if( UTag == "PRIV" )
				{
					SetPriv( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "PILEABLE" )
				{
					SetPileable( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				break;
			case 'R':
				if( UTag == "RESTOCK" )
				{
					SetRestock( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "RACEDAMAGE" )
				{
					SetWeatherDamage( LIGHT, static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )) == 1 );
					SetWeatherDamage( RAIN, static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )) == 1 );
					SetWeatherDamage( HEAT, static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )) == 1 );
					SetWeatherDamage( COLD, static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[3], "//" )), nullptr, 0 )) == 1 );
					SetWeatherDamage( SNOW, static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[4], "//" )), nullptr, 0 )) == 1 );
					SetWeatherDamage( LIGHTNING, static_cast<UI16>( std::stoul( util::trim( util::strip( csecs[5], "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				else if( UTag == "RANK" )
				{
					SetRank( static_cast<SI08>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "RAIN" )
				{
					SetWeatherDamage( RAIN, static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				else if( UTag == "RANGE" )
				{
					if( csecs.size() > 1 )
					{
						SetBaseRange( static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetMaxRange( static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
					}
					else
					{
						auto val = static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 ));
						SetBaseRange( val );
						SetMaxRange( val / 2 );
					}
					rValue = true;
			...
			case 'S':
				if( UTag == "SPEED" )
				{
					SetSpeed( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "SK_MADE" )
				{
					SetMadeWith( static_cast<SI08>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "SNOW" )
				{
					SetWeatherDamage( SNOW, static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1 );
					rValue = true;
				}
				else if( UTag == "SPELLS" )
				{
					SetSpell( 0, static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
					SetSpell( 1, static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
					SetSpell( 2, static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "STEALABLE" )
				{
					SetStealable( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
			case 'T':
				if( UTag == "TYPE" )
				{
					if( csecs.size() != 1 )
					{
						SetType( static_cast<ItemTypes>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
					}
					else
					{
						SetType( static_cast<ItemTypes>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					}
					rValue = true;
				}
				else if( UTag == "TYPE2" )
			...
			case 'U':
				if( UTag == "USESLEFT" )
				{
					SetUsesLeft( static_cast<UI16>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
			case 'V':
				if( UTag == "VALUE" )
				{
					if( csecs.size() > 2 )
					{
						SetBuyValue( static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
						SetSellValue( static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
						SetVendorPrice( static_cast<UI32>( std::stoul( util::trim( util::strip( csecs[2], "//" )), nullptr, 0 )));
					}
					...
					{
						auto val = static_cast<UI32>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 ));
						SetBuyValue( val );
						SetSellValue( val / 2 );
					}
					rValue = true;
			...
			case 'W':
				if( UTag == "WEIGHTMAX" )
				{
					SetWeightMax( static_cast<SI32>( std::stoi(util::trim( util::strip( data, "//" )), nullptr, 0 )));
					rValue = true;
				}
				break;
		}
	...
	if( !rValue )
	{
		...
		switch(( UTag.data()[0] ))
		{
			case 'I':
				if( UTag == "INTERVAL" )
				{
					SetInterval( 0, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[0], "//" )), nullptr, 0 )));
					SetInterval( 1, static_cast<UI08>( std::stoul( util::trim( util::strip( csecs[1], "//" )), nullptr, 0 )));
					rValue = true;
				}
				else if( UTag == "ISSECTIONALIST" )
				{
					IsSectionAList(( static_cast<UI08>( std::stoul( util::trim( util::strip( data, "//" )), nullptr, 0 )) == 1) );
					rValue = true;
				}
				break;
			case 'S':
					...
					for( size_t i = 0; i < itemListSize; i++ )
					{
						...
						if( !listObj.empty() )
						{
							...
							if( util::upper( listObj[0] ) == "ITEMLIST" || util::upper( listObj[0] ) == "LOOTLIST" )
							{
								...
								{
									// Also grab amount
									std::string amountData = util::trim( util::strip( itemListData[1], "//" ));
									...
									{
										auto first = static_cast<UI16>( std::stoul( util::trim( util::strip( tsects[0], "//" )), nullptr, 0 ));
										auto second = static_cast<UI16>( std::stoul( util::trim( util::strip( tsects[1], "//" )), nullptr, 0 ));
							...
							else
							{
								...
								{
									// Grab amount
									std::string amountData = util::trim( util::strip( listObj[1], "//" ));
									auto tsects = oldstrutil::sections( amountData, " " );
									if( tsects.size() > 1 ) // check if the second part of the tag-data contains two sections separated by a space
									{
										auto first = static_cast<UI16>( std::stoul( util::trim( util::strip( tsects[0], "//" )), nullptr, 0 ));
