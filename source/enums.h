...
enum HpRegenMode
{
	HREG_NONE,		// hp regen is disabled
	HREG_LBR,		// hp regen is enabled
	HREG_COUNT
};

enum StaminaRegenMode
{
	SREG_NONE,	// Stamina regen is disabled
	SREG_LBR,	// Stamina regen calculations for LBR or earlier
	SREG_AOS,	// Stamina regen calculations for AoS and beyond
	SREG_SA,	// Stamina regen calculations for SA or beyond
	SREG_COUNT
};

enum ManaRegenMode
{
	MREG_NONE,		// mana regen is disabled
	MREG_LBR,		// mana regen calculations for LBR or earlier
	MREG_AOS1,		// mana regen calculations for AoS, pre-Pub18
	MREG_AOS2,		// mana regen calculations for AoS, post-Pub18
	MREG_ML,		// mana regen calculations for ML,
	MREG_KR,		// mana regen calculations for KR,
	MREG_COUNT
};
