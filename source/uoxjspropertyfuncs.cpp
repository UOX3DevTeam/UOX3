...
JSBool CGuildsProps_getProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                                [[maybe_unused]] jsval id, jsval *vp) {
    *vp = INT_TO_JSVAL(0);
    return JS_TRUE;
}

JSBool CGuildsProps_setProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                                [[maybe_unused]] jsval id, [[maybe_unused]] jsval *vp) {
    return JS_TRUE;
}
...
JSBool CSpellProps_setProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                               [[maybe_unused]] jsval id, [[maybe_unused]] jsval *vp) {
    return JS_TRUE;
}
...
JSBool CGlobalSkillProps_setProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                                     [[maybe_unused]] jsval id, [[maybe_unused]] jsval *vp) {
    return JS_TRUE;
}
...
JSBool CTimerProps_getProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                               jsval id, jsval *vp) {
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
...
JSBool CCreateEntryProps_setProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                                     [[maybe_unused]] jsval id, [[maybe_unused]] jsval *vp) {
    return JS_TRUE;
}
            ...
            if (!ValidateObject(pOwner)) {
                *vp = JSVAL_NULL;
                ...
                JSObject *myObj = JSEngine->AcquireObject(
                    IUE_CHAR, pOwner, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                ...
                *vp = JSVAL_NULL;
                                                  ...
                                                  // and we already know it's not INVALIDSERIAL
                {
                    ...
                    if (ValidateObject(myCont)) {
                        JSObject *myItem = JSEngine->AcquireObject(
                            IUE_ITEM, myCont, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                    ...
                    if (ValidateObject(chCont)) {
                        JSObject *myChar = JSEngine->AcquireObject(
                            IUE_CHAR, chCont, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CIP_RACE: {
            ...
            if (TempRace == nullptr) {
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myRace = JSEngine->AcquireObject(
                    IUE_RACE, TempRace, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CIP_REGION: {
            ...
            if (myReg == nullptr) {
                *vp = JSVAL_NULL;
                ...
                JSObject *myTown = JSEngine->AcquireObject(
                    IUE_REGION, myReg, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CIP_MULTI:
            ...
            if (!ValidateObject(multi)) {
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myObj = JSEngine->AcquireObject(
                    IUE_ITEM, multi, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myObj);
            }
            break;
            ...
            if (*vp != JSVAL_NULL) {
                ...
                if (toExecute == nullptr) {
                    ScriptError(cx, util::format("Unable to assign script trigger - script ID (%i) "
                                                 "not found in jse_fileassociations.scp!",
                                                 scriptId)
                                        .c_str());
                }
                else {
        ...
        case CCP_ACCOUNT: {
            ...
            if (accountBlock == nullptr) {
                *vp = JSVAL_NULL;
                ...
                JSObject *accountObj = JSEngine->AcquireObject(
                    IUE_ACCOUNT, accountBlock, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CCP_OWNER:
            ...
            if (!ValidateObject(TempObj)) {
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myChar = JSEngine->AcquireObject(
                    IUE_CHAR, TempObj, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myChar);
            }
            break;
        case CCP_VISIBLE:
        ...
        case CCP_TARGET:
            ...
            if (!ValidateObject(tempChar)) {
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myChar = JSEngine->AcquireObject(
                    IUE_CHAR, tempChar, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myChar);
            }
            break;
        case CCP_DEXTERITY:
        ...
        case CCP_CHARPACK:
            ...
            if (!ValidateObject(TempItem))
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myItem = JSEngine->AcquireObject(
                    IUE_ITEM, TempItem, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myItem);
            }
            break;
        case CCP_FAME:
        ...
        case CCP_TOWN: {
            ...
            if (tempTownId == 0xFF) {
                *vp = JSVAL_NULL;
                ...
                JSObject *myTown =
                    JSEngine->AcquireObject(IUE_REGION, cwmWorldState->townRegions[tempTownId],
        ...
        case CCP_GUILD: {
            ...
            if (tempGuildId == -1) // isn't there a constant or something like?
            {
                *vp = JSVAL_NULL;
                ...
                JSObject *myGuild =
                    JSEngine->AcquireObject(IUE_GUILD, GuildSys->Guild(tempGuildId),
                                            JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CCP_SOCKET: { // So we can declare the variables here
            ...
            if (tSock == nullptr) {
                *vp = JSVAL_NULL;
                ...
                JSObject *mySock = JSEngine->AcquireObject(
                    IUE_SOCK, tSock, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CCP_PARTY: {
            ...
            if (tempParty == nullptr) { // Return a JS_NULL
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myParty = JSEngine->AcquireObject(
                    IUE_PARTY, tempParty, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
        ...
        case CREGP_MAYOR:
            ...
            if (!ValidateObject(tempMayor))
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myChar = JSEngine->AcquireObject(
                    IUE_CHAR, tempMayor, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myChar);
            }
            break;
        case CREGP_RACE:
        ...
        case CGP_MASTER:
            ...
            if (!ValidateObject(gMaster)) {
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myChar = JSEngine->AcquireObject(
                    IUE_CHAR, gMaster, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myChar);
            }
            break;
        case CGP_STONE:
            ...
            if (!ValidateObject(gStone)) {
                *vp = JSVAL_NULL;
                ...
                // Otherwise Acquire an object
                JSObject *myItem = JSEngine->AcquireObject(
                    IUE_ITEM, gStone, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myItem);
            }
            break;
        case CGP_NUMMEMBERS:
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        case CSOCKP_CURRENTCHAR:
            ...
            if (!ValidateObject(myChar)) {
                *vp = JSVAL_NULL;
                ...
                JSObject *myObj = JSEngine->AcquireObject(
                    IUE_CHAR, myChar, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myObj);
            }
            ...
            if (!ValidateObject(mObj)) {
                *vp = JSVAL_NULL;
                ...
                if (mObj->CanBeObjType(CBaseObject::OT_ITEM)) {
                    ...
                    myObj = JSEngine->AcquireObject(IUE_CHAR, mObj,
                                                    JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                }
                *vp = OBJECT_TO_JSVAL(myObj);
            }
        ...
        case CSOCKP_TARGET: {
            ...
            if (mySerial >= BASEITEMSERIAL) {
                ...
                JSObject *myObj = JSEngine->AcquireObject(
                    IUE_ITEM, myItem, JSEngine->FindActiveRuntime(JS_GetRuntime(cx)));
                *vp = OBJECT_TO_JSVAL(myObj);
            }
            // Char
            else {
...
JSBool CConsoleProps_getProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                                 jsval id, jsval *vp) {
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
        case CCONSOLE_MODE:
...
JSBool CConsoleProps_setProperty(JSContext *cx, [[maybe_unused]] JSObject *obj, jsval id,
                                 jsval *vp) {
    JSEncapsulate encaps(cx, vp);
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
...
JSBool CScriptSectionProps_setProperty([[maybe_unused]] JSContext *cx,
                                       [[maybe_unused]] JSObject *obj, [[maybe_unused]] jsval id,
...
JSBool CScriptProps_getProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj,
                                jsval id, jsval *vp) {
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
