    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            case CSP_ID:
                ...
                break;
            case CSP_ACTION:
                *vp = INT_TO_JSVAL(gPriv->Action());
                break;
            case CSP_BASEDMG:
                *vp = INT_TO_JSVAL(gPriv->BaseDmg());
                break;
            case CSP_DELAY:
                JS_NewNumberValue(cx, gPriv->Delay(), vp);
                break;
            case CSP_DAMAGEDELAY:
                JS_NewNumberValue(cx, gPriv->DamageDelay(), vp);
                break;
            case CSP_RECOVERYDELAY:
                JS_NewNumberValue(cx, gPriv->RecoveryDelay(), vp);
                break;
            case CSP_HEALTH:
                *vp = INT_TO_JSVAL(gPriv->Health());
                break;
            case CSP_STAMINA:
                *vp = INT_TO_JSVAL(gPriv->Stamina());
                break;
            case CSP_MANA:
                *vp = INT_TO_JSVAL(gPriv->Mana());
                break;
            case CSP_MANTRA:
            ...
            case CSP_STRTOSAY:
                ...
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CSP_SCROLLLOW:
                *vp = INT_TO_JSVAL(gPriv->ScrollLow());
                break;
            case CSP_SCROLLHIGH:
                *vp = INT_TO_JSVAL(gPriv->ScrollHigh());
                break;
            case CSP_CIRCLE:
                *vp = INT_TO_JSVAL(gPriv->Circle());
                break;
            case CSP_LOWSKILL:
                *vp = INT_TO_JSVAL(gPriv->LowSkill());
                break;
            case CSP_HIGHSKILL:
                *vp = INT_TO_JSVAL(gPriv->HighSkill());
                break;
            case CSP_GINSENG:
                *vp = INT_TO_JSVAL(gPriv->Reagants().ginseng);
                break;
            case CSP_MOSS:
                *vp = INT_TO_JSVAL(gPriv->Reagants().moss);
                break;
            case CSP_DRAKE:
                *vp = INT_TO_JSVAL(gPriv->Reagants().drake);
                break;
            case CSP_PEARL:
                *vp = INT_TO_JSVAL(gPriv->Reagants().pearl);
                break;
            case CSP_SILK:
                *vp = INT_TO_JSVAL(gPriv->Reagants().silk);
                break;
            case CSP_ASH:
                *vp = INT_TO_JSVAL(gPriv->Reagants().ash);
                break;
            case CSP_SHADE:
                *vp = INT_TO_JSVAL(gPriv->Reagants().shade);
                break;
            case CSP_GARLIC:
                *vp = INT_TO_JSVAL(gPriv->Reagants().garlic);
                break;
            case CSP_REQUIRETARGET:
                *vp = BOOLEAN_TO_JSVAL(gPriv->RequireTarget());
                break;
            case CSP_REQUIREITEM:
                *vp = BOOLEAN_TO_JSVAL(gPriv->RequireItemTarget());
                break;
            case CSP_REQUIRECHAR:
                *vp = BOOLEAN_TO_JSVAL(gPriv->RequireCharTarget());
                break;
            case CSP_REQUIRELOCATION:
                *vp = BOOLEAN_TO_JSVAL(gPriv->RequireLocTarget());
                break;
            case CSP_TRAVELSPELL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->TravelSpell());
                break;
            case CSP_FIELDSPELL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->FieldSpell());
                break;
            case CSP_REFLECTABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->SpellReflectable());
                break;
            case CSP_AGGRESSIVESPELL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->AggressiveSpell());
                break;
            case CSP_RESISTABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->Resistable());
                break;
            case CSP_SOUNDEFFECT:
                *vp = INT_TO_JSVAL(gPriv->Effect());
                break;
            case CSP_ENABLED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->Enabled());
                break;
            default:
                break;
        }
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CGSKILL_MADEWORD:
                ...
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CGSKILL_STRENGTH:
                *vp = INT_TO_JSVAL(gPriv->strength);
                break;
            case CGSKILL_DEXTERITY:
                *vp = INT_TO_JSVAL(gPriv->dexterity);
                break;
            case CGSKILL_INTELLIGENCE:
                *vp = INT_TO_JSVAL(gPriv->intelligence);
                break;
            case CGSKILL_SKILLDELAY:
                *vp = INT_TO_JSVAL(gPriv->skillDelay);
                break;
            case CGSKILL_SCRIPTID:
                *vp = INT_TO_JSVAL(gPriv->jsScript);
                break;
            default:
                break;
        }
...
JSBool CTimerProps_getProperty([[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, jsval id, jsval *vp) {
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            ...
            case TIMER_TIMEOUT:
                *vp = INT_TO_JSVAL(tCHAR_TIMEOUT);
                break;
            case TIMER_INVIS:
                *vp = INT_TO_JSVAL(tCHAR_INVIS);
                break;
            case TIMER_HUNGER:
                *vp = INT_TO_JSVAL(tCHAR_HUNGER);
                break;
            case TIMER_THIRST:
                *vp = INT_TO_JSVAL(tCHAR_THIRST);
                break;
            case TIMER_POISONTIME:
                *vp = INT_TO_JSVAL(tCHAR_POISONTIME);
                break;
            case TIMER_POISONTEXT:
                *vp = INT_TO_JSVAL(tCHAR_POISONTEXT);
                break;
            case TIMER_POISONWEAROFF:
                *vp = INT_TO_JSVAL(tCHAR_POISONWEAROFF);
                break;
            case TIMER_SPELLTIME:
                *vp = INT_TO_JSVAL(tCHAR_SPELLTIME);
                break;
            case TIMER_SPELLRECOVERYTIME:
                *vp = INT_TO_JSVAL(tCHAR_SPELLRECOVERYTIME);
                break;
            case TIMER_ANTISPAM:
                *vp = INT_TO_JSVAL(tCHAR_ANTISPAM);
                break;
            case TIMER_CRIMFLAG:
                *vp = INT_TO_JSVAL(tCHAR_CRIMFLAG);
                break;
            case TIMER_MURDERRATE:
                *vp = INT_TO_JSVAL(tCHAR_MURDERRATE);
                break;
            case TIMER_PEACETIMER:
                *vp = INT_TO_JSVAL(tCHAR_PEACETIMER);
                break;
            case TIMER_FLYINGTOGGLE:
                *vp = INT_TO_JSVAL(tCHAR_FLYINGTOGGLE);
                break;
            case TIMER_FIREFIELDTICK:
                *vp = INT_TO_JSVAL(tCHAR_FIREFIELDTICK);
                break;
            case TIMER_POISONFIELDTICK:
                *vp = INT_TO_JSVAL(tCHAR_POISONFIELDTICK);
                break;
            case TIMER_PARAFIELDTICK:
                *vp = INT_TO_JSVAL(tCHAR_PARAFIELDTICK);
                break;
            case TIMER_YOUNGHEAL:
                *vp = INT_TO_JSVAL(tCHAR_YOUNGHEAL);
                break;
            case TIMER_YOUNGMESSAGE:
                *vp = INT_TO_JSVAL(tCHAR_YOUNGMESSAGE);
                break;
            case TIMER_MOVETIME:
                *vp = INT_TO_JSVAL(tNPC_MOVETIME);
                break;
            case TIMER_SPATIMER:
                *vp = INT_TO_JSVAL(tNPC_SPATIMER);
                break;
            case TIMER_SUMMONTIME:
                *vp = INT_TO_JSVAL(tNPC_SUMMONTIME);
                break;
            case TIMER_EVADETIME:
                *vp = INT_TO_JSVAL(tNPC_EVADETIME);
                break;
            case TIMER_LOYALTYTIME:
                *vp = INT_TO_JSVAL(tNPC_LOYALTYTIME);
                break;
            case TIMER_IDLEANIMTIME:
                *vp = INT_TO_JSVAL(tNPC_IDLEANIMTIME);
                break;
            case TIMER_LOGOUT:
                *vp = INT_TO_JSVAL(tPC_LOGOUT);
                break;
                
                // Socket Timers (PC only)
            case TIMER_SOCK_SKILLDELAY:
                *vp = INT_TO_JSVAL(tPC_SKILLDELAY);
                break;
            case TIMER_SOCK_OBJDELAY:
                *vp = INT_TO_JSVAL(tPC_OBJDELAY);
                break;
            case TIMER_SOCK_SPIRITSPEAK:
                *vp = INT_TO_JSVAL(tPC_SPIRITSPEAK);
                break;
            case TIMER_SOCK_TRACKING:
                *vp = INT_TO_JSVAL(tPC_TRACKING);
                break;
            case TIMER_SOCK_FISHING:
                *vp = INT_TO_JSVAL(tPC_FISHING);
                break;
            case TIMER_SOCK_MUTETIME:
                *vp = INT_TO_JSVAL(tPC_MUTETIME);
                break;
            case TIMER_SOCK_TRACKINGDISPLAY:
                *vp = INT_TO_JSVAL(tPC_TRACKINGDISPLAY);
                break;
            case TIMER_SOCK_TRAFFICWARDEN:
                *vp = INT_TO_JSVAL(tPC_TRAFFICWARDEN);
                break;
            default:
                break;
        }
...
JSBool CCreateEntryProps_getProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CMAKE_COLOUR:
                *vp = INT_TO_JSVAL(gPriv->colour);
                break;
            case CMAKE_SOUND:
                *vp = INT_TO_JSVAL(gPriv->soundPlayed);
                break;
            case CMAKE_MINRANK:
                *vp = INT_TO_JSVAL(gPriv->minRank);
                break;
            case CMAKE_MAXRANK:
                *vp = INT_TO_JSVAL(gPriv->maxRank);
                break;
            case CMAKE_DELAY:
                *vp = INT_TO_JSVAL(gPriv->delay);
                break;
            case CMAKE_SPELL:
                *vp = INT_TO_JSVAL(gPriv->spell);
                break;
            ...
            case CMAKE_AVGMINSKILL:
                *vp = INT_TO_JSVAL(gPriv->AverageMinSkill());
                break;
            case CMAKE_AVGMAXSKILL:
                *vp = INT_TO_JSVAL(gPriv->AverageMaxSkill());
                break;
        }
    }
    return JS_TRUE;
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CIP_TITLE:
                ...
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CIP_X:
                *vp = INT_TO_JSVAL(gPriv->GetX());
                break;
            case CIP_Y:
                *vp = INT_TO_JSVAL(gPriv->GetY());
                break;
            case CIP_Z:
                *vp = INT_TO_JSVAL(gPriv->GetZ());
                break;
            case CIP_OLDX: {
            ...
            case CIP_WORLDNUMBER:
                *vp = INT_TO_JSVAL(gPriv->WorldNumber());
                break;
            case CIP_INSTANCEID:
                *vp = INT_TO_JSVAL(gPriv->GetInstanceId());
                break;
            case CIP_AMOUNT:
                *vp = INT_TO_JSVAL(gPriv->GetAmount());
                break;
            ...
            case CIP_CONTAINER:
                ...
                if (TempSerial == INVALIDSERIAL) {
                    ...
                    *vp = JSVAL_NULL;
                    ...
                    // Otherwise Acquire an object
                    if (TempSerial >= BASEITEMSERIAL) // item's have serials of 0x40000000 and above,
                        // and we already know it's not INVALIDSERIAL
                    {
            ...
            case CIP_ITEMSINSIDE:
                *vp = INT_TO_JSVAL(gPriv->GetContainsList()->Num());
                break;
            case CIP_TOTALITEMCOUNT:
                *vp = INT_TO_JSVAL(GetTotalItemCount(gPriv));
                break;
            case CIP_DECAYABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDecayable());
                break;
            case CIP_DECAYTIME:
                JS_NewNumberValue(cx, gPriv->GetDecayTime(), vp);
                break;
            case CIP_LODAMAGE:
                *vp = INT_TO_JSVAL(gPriv->GetLoDamage());
                break;
            case CIP_HIDAMAGE:
                *vp = INT_TO_JSVAL(gPriv->GetHiDamage());
                break;
            case CIP_AC:
            ...
            case CIP_MAXHP:
                *vp = INT_TO_JSVAL(gPriv->GetMaxHP());
                break;
            case CIP_MAXUSES:
                *vp = INT_TO_JSVAL(gPriv->GetMaxUses());
                break;
            case CIP_USESLEFT:
                *vp = INT_TO_JSVAL(gPriv->GetUsesLeft());
                break;
            case CIP_RANK:
                *vp = INT_TO_JSVAL(gPriv->GetRank());
                break;
            case CIP_CREATOR:
                *vp = INT_TO_JSVAL(gPriv->GetCreator());
                break;
            case CIP_POISON:
                *vp = INT_TO_JSVAL(gPriv->GetPoisoned());
                break;
            case CIP_DIR:
                *vp = INT_TO_JSVAL(gPriv->GetDir());
                break;
            case CIP_WIPABLE:
                *vp = INT_TO_JSVAL(gPriv->IsWipeable());
                break;
            case CIP_BUYVALUE:
                *vp = INT_TO_JSVAL(gPriv->GetBuyValue());
                break;
            case CIP_SELLVALUE:
                *vp = INT_TO_JSVAL(gPriv->GetSellValue());
                break;
            case CIP_VENDORPRICE:
                *vp = INT_TO_JSVAL(gPriv->GetVendorPrice());
                break;
            case CIP_RESTOCK:
                *vp = INT_TO_JSVAL(gPriv->GetRestock());
                break;
            case CIP_DIVINELOCK:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDivineLocked());
                break;
            case CIP_WEIGHT:
                *vp = INT_TO_JSVAL(gPriv->GetWeight());
                break;
            case CIP_WEIGHTMAX:
                *vp = INT_TO_JSVAL(gPriv->GetWeightMax());
                break;
            case CIP_BASEWEIGHT:
                *vp = INT_TO_JSVAL(gPriv->GetBaseWeight());
                break;
            case CIP_MAXITEMS:
                *vp = INT_TO_JSVAL(gPriv->GetMaxItems());
                break;
            case CIP_STRENGTH:
                *vp = INT_TO_JSVAL(gPriv->GetStrength());
                break;
            case CIP_DEXTERITY:
                *vp = INT_TO_JSVAL(gPriv->GetDexterity());
                break;
            case CIP_INTELLIGENCE:
                *vp = INT_TO_JSVAL(gPriv->GetIntelligence());
                break;
            case CIP_CORPSE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsCorpse());
                break;
            case CIP_DESC:
            ...
            case CIP_TEMPLASTTRADED:
                *vp = INT_TO_JSVAL(gPriv->GetTempLastTraded() / 1000);
                break;
            case CIP_TEMPTIMER:
                *vp = INT_TO_JSVAL(gPriv->GetTempTimer() / 1000);
                break;
            case CIP_SHOULDSAVE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->ShouldSave());
                break;
            case CIP_ISNEWBIE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsNewbie());
                break;
            case CIP_ISDISPELLABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDispellable());
                break;
            case CIP_MADEWITH:
                *vp = INT_TO_JSVAL(gPriv->GetMadeWith());
                break;
            case CIP_ENTRYMADEFROM:
                *vp = INT_TO_JSVAL(gPriv->EntryMadeFrom());
                break;
            case CIP_ISPILEABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsPileable());
                break;
            case CIP_ISMARKEDBYMAKER:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsMarkedByMaker());
                break;
            case CIP_ISDYEABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDyeable());
                break;
            case CIP_ISDAMAGEABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDamageable());
                break;
            case CIP_ISWIPEABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsWipeable());
                break;
            case CIP_ISGUARDED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsGuarded());
                break;
            case CIP_ISDOOROPEN:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDoorOpen());
                break;
            case CIP_ISFIELDSPELL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsFieldSpell());
                break;
            case CIP_ISLOCKEDDOWN:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsLockedDown());
                break;
            case CIP_ISSHIELDTYPE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsShieldType());
                break;
            case CIP_ISMETALTYPE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsMetalType());
                break;
            case CIP_ISLEATHERTYPE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsLeatherType());
                break;
            case CIP_CANBELOCKEDDOWN:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanBeLockedDown());
                break;
            case CIP_ISCONTTYPE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsContType());
                break;
            case CIP_CARVESECTION:
                *vp = INT_TO_JSVAL(gPriv->GetCarve());
                break;
            case CIP_AMMOID:
                *vp = INT_TO_JSVAL(gPriv->GetAmmoId());
                break;
            case CIP_AMMOHUE:
                *vp = INT_TO_JSVAL(gPriv->GetAmmoHue());
                break;
            case CIP_AMMOFX:
                *vp = INT_TO_JSVAL(gPriv->GetAmmoFX());
                break;
            case CIP_AMMOFXHUE:
                *vp = INT_TO_JSVAL(gPriv->GetAmmoFXHue());
                break;
            case CIP_AMMOFXRENDER:
                *vp = INT_TO_JSVAL(gPriv->GetAmmoFXRender());
                break;
            case CIP_MAXRANGE:
                *vp = INT_TO_JSVAL(gPriv->GetMaxRange());
                break;
            case CIP_BASERANGE:
                *vp = INT_TO_JSVAL(gPriv->GetBaseRange());
                break;
            case CIP_REGION: {
            ...
            case CIP_SPAWNSERIAL:
                *vp = INT_TO_JSVAL(gPriv->GetSpawn());
                break;
            case CIP_ORIGIN:
                tString = JS_NewStringCopyZ(cx, ServerConfig::shared().ruleSets.normalizedEraString(gPriv->GetOrigin().describe()).describe().c_str());
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CIP_ISITEMHELD:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsHeldOnCursor());
                break;
            case CIP_STEALABLE:
                *vp = INT_TO_JSVAL(gPriv->GetStealable());
                break;
...
JSBool CItemProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CIP_WORLDNUMBER:
                ...
                gPriv->SetLocation(gPriv->GetX(), gPriv->GetY(), gPriv->GetZ(), static_cast<std::uint8_t>(encaps.toInt()), gPriv->GetInstanceId());
                break;
            case CIP_INSTANCEID: {
                gPriv->RemoveFromSight();
                gPriv->SetLocation(gPriv->GetX(), gPriv->GetY(), gPriv->GetZ(), gPriv->WorldNumber(), static_cast<std::uint16_t>(encaps.toInt()));
                break;
            }
            case CIP_AMOUNT:
            ...
            case CIP_MORE: {
                ...
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MORE, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_MORE0: {
                ...
                auto encapsSections = oldstrutil::sections(sEncaps, " ");
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MORE0, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE0, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE0, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE0, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_MORE1: {
                ...
                auto encapsSections = oldstrutil::sections(sEncaps, " ");
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MORE1, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE1, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE1, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE1, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_MORE2: {
                ...
                auto encapsSections = oldstrutil::sections(sEncaps, " ");
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MORE2, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE2, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE2, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MORE2, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_MOREX: {
                ...
                auto encapsSections = oldstrutil::sections(sEncaps, " ");
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MOREX, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREX, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREX, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREX, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_MOREY: {
                ...
                auto encapsSections = oldstrutil::sections(sEncaps, " ");
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MOREY, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREY, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREY, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREY, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_MOREZ: {
                ...
                auto encapsSections = oldstrutil::sections(sEncaps, " ");
                if (encapsSections.size() >= 4) {
                    gPriv->SetTempVar(CITV_MOREZ, 1, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[0], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREZ, 2, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[1], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREZ, 3, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[2], "//")), nullptr, 0)));
                    gPriv->SetTempVar(CITV_MOREZ, 4, static_cast<std::uint8_t>(std::stoul(util::trim(util::strip(encapsSections[3], "//")), nullptr, 0)));
                }
                else {
            ...
            case CIP_CORPSE:
                ...
                break;
            case CIP_DESC:
                gPriv->SetDesc(encaps.toString());
                break;
            case CIP_EVENT:
                gPriv->SetEvent(encaps.toString());
                break;
            case CIP_TEMPLASTTRADED:
                newTime = encaps.toInt();
                if (newTime != 0)
            ...
            case CIP_ISPILEABLE:
                ...
                break;
            case CIP_ISMARKEDBYMAKER:
                gPriv->SetMakersMark(encaps.toBool());
                break;
            case CIP_ISDYEABLE:
                gPriv->SetDye(encaps.toBool());
                break;
            case CIP_ISDAMAGEABLE:
                gPriv->SetDamageable(encaps.toBool());
                break;
            case CIP_ISWIPEABLE:
                gPriv->SetWipeable(encaps.toBool());
                break;
            case CIP_ISGUARDED:
                gPriv->SetGuarded(encaps.toBool());
                break;
            case CIP_ISDOOROPEN:
                gPriv->SetDoorOpen(encaps.toBool());
                break;
            case CIP_CARVESECTION:
            ...
            case CIP_MININTERVAL:
                if (gPriv->GetObjType() == CBaseObject::OT_SPAWNER) {
                    (static_cast<CSpawnItem *>(gPriv))->SetInterval(0, static_cast<std::uint8_t>(encaps.toInt()));
                }
                break;
            case CIP_MAXINTERVAL:
                if (gPriv->GetObjType() == CBaseObject::OT_SPAWNER) {
                    (static_cast<CSpawnItem *>(gPriv))->SetInterval(1, static_cast<std::uint8_t>(encaps.toInt()));
                }
                break;
                // Multis only
            case CIP_MAXLOCKDOWNS:
            ...
            case CIP_MAXSECURECONTAINERS:
                if (gPriv->GetObjType() == CBaseObject::OT_MULTI) {
                    (static_cast<CMultiObj *>(gPriv))->SetMaxSecureContainers(static_cast<std::uint16_t>(encaps.toInt()));
                }
                break;
            case CIP_MAXFRIENDS:
                if (gPriv->GetObjType() == CBaseObject::OT_MULTI) {
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            ...
            Console::shared().warning(util::format("Script context lost after setting Item property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
...
JSBool CCharacterProps_getProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            case CCP_ACCOUNTNUM:
                *vp = INT_TO_JSVAL(gPriv->GetAccountNum());
                break;
            case CCP_ACCOUNT: {
            ...
            case CCP_CREATEDON:
                *vp = INT_TO_JSVAL(gPriv->GetCreatedOn());
                break;
            case CCP_PLAYTIME:
                *vp = INT_TO_JSVAL(gPriv->GetPlayTime());
                break;
            case CCP_NAME: {
            ...
            case CCP_DEXTERITY:
                *vp = INT_TO_JSVAL(gPriv->GetDexterity());
                break;
            case CCP_INTELLIGENCE:
                *vp = INT_TO_JSVAL(gPriv->GetIntelligence());
                break;
            case CCP_STRENGTH:
                *vp = INT_TO_JSVAL(gPriv->GetStrength());
                break;
            case CCP_ACTUALDEXTERITY:
                *vp = INT_TO_JSVAL(gPriv->ActualDexterity());
                break;
            case CCP_ACTUALINTELLIGENCE:
                *vp = INT_TO_JSVAL(gPriv->ActualIntelligence());
                break;
            case CCP_ACTUALSTRENGTH:
                *vp = INT_TO_JSVAL(gPriv->ActualStrength());
                break;
            case CCP_BASESKILLS:
            ...
            case CCP_SKILLUSE:
                ...
                *vp = OBJECT_TO_JSVAL(TempObject);
                break;
            case CCP_MANA:
                *vp = INT_TO_JSVAL(gPriv->GetMana());
                break;
            case CCP_STAMINA:
                *vp = INT_TO_JSVAL(gPriv->GetStamina());
                break;
            case CCP_CHARPACK:
            ...
            case CCP_CANATTACK:
                *vp = BOOLEAN_TO_JSVAL(gPriv->GetCanAttack());
                break;
            case CCP_FLEEAT:
                *vp = INT_TO_JSVAL(gPriv->GetFleeAt());
                break;
            case CCP_REATTACKAT:
                *vp = INT_TO_JSVAL(gPriv->GetReattackAt());
                break;
            case CCP_BRKPEACE:
                *vp = INT_TO_JSVAL(gPriv->GetBrkPeaceChance());
                break;
            case CCP_HUNGER:
                *vp = INT_TO_JSVAL(gPriv->GetHunger());
                break;
            case CCP_HUNGERRATE: {
                CRace *TempRace = nullptr;
                TempRace = Races->Race(gPriv->GetRace());
            ...
            case CCP_THIRST:
                *vp = INT_TO_JSVAL(gPriv->GetThirst());
                break;
            case CCP_THIRSTRATE: {
                CRace *TempRace = nullptr;
                TempRace = Races->Race(gPriv->GetRace());
            ...
            case CCP_FROZEN:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsFrozen());
                break;
            case CCP_COMMANDLEVEL:
                *vp = INT_TO_JSVAL(gPriv->GetCommandLevel());
                break;
            case CCP_RACE: {
                CRace *TempRace = nullptr;
                TempRace = Races->Race(gPriv->GetRace());
            ...
            case CCP_HASSTOLEN:
                *vp = BOOLEAN_TO_JSVAL(gPriv->HasStolen());
                break;
            case CCP_CRIMINAL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsCriminal());
                break;
            case CCP_MURDERER:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsMurderer());
                break;
            case CCP_INNOCENT:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsInnocent());
                break;
            case CCP_NEUTRAL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsNeutral());
                break;
            case CCP_MURDERCOUNT:
                *vp = INT_TO_JSVAL(gPriv->GetKills());
                break;
            case CCP_GENDER:
                switch (gPriv->GetId()) {
                ...
                break;
            case CCP_DEAD:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDead());
                break;
            case CCP_NPC:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsNpc());
                break;
            case CCP_AWAKE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsAwake());
                break;
            case CCP_ONLINE:
                *vp = BOOLEAN_TO_JSVAL(IsOnline((*gPriv)));
                break;
            case CCP_DIRECTION:
                *vp = INT_TO_JSVAL(gPriv->GetDir());
                break;
            ...
            case CCP_ISRUNNING:
                *vp = BOOLEAN_TO_JSVAL(gPriv->GetRunning());
                break;
            case CCP_REGION: {
                CTownRegion *myReg = gPriv->GetRegion();
                if (myReg == nullptr) {
            ...
            case CCP_SOCKET: { // So we can declare the variables here
            ...
            case CCP_MAXHP:
                *vp = INT_TO_JSVAL(gPriv->GetMaxHP());
                break;
            case CCP_MAXSTAMINA:
                *vp = INT_TO_JSVAL(gPriv->GetMaxStam());
                break;
            case CCP_MAXMANA:
                *vp = INT_TO_JSVAL(gPriv->GetMaxMana());
                break;
            case CCP_OLDWANDERTYPE:
                *vp = INT_TO_JSVAL(gPriv->GetOldNpcWander());
                break;
            case CCP_WANDERTYPE:
                *vp = INT_TO_JSVAL(gPriv->GetNpcWander());
                break;
            case CCP_FX1:
                *vp = INT_TO_JSVAL(gPriv->GetFx(0));
                break;
            case CCP_FY1:
                *vp = INT_TO_JSVAL(gPriv->GetFy(0));
                break;
            case CCP_FX2:
                *vp = INT_TO_JSVAL(gPriv->GetFx(1));
                break;
            case CCP_FY2:
                *vp = INT_TO_JSVAL(gPriv->GetFy(1));
                break;
            case CCP_FZ:
                *vp = INT_TO_JSVAL(gPriv->GetFz());
                break;
            case CCP_ISONHORSE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsOnHorse());
                break;
            case CCP_ISFLYING:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsFlying());
                break;
            case CCP_ISGUARDED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsGuarded());
                break;
            case CCP_GUARDING: {
                ...
                if (!ValidateObject(tempObj)) { // Return a JS_NULL
                    *vp = JSVAL_NULL;
                }
                else {
                    // Otherwise Acquire an object
            ...
            case CCP_TDEXTERITY:
                *vp = INT_TO_JSVAL(gPriv->GetDexterity2());
                break;
            case CCP_TINTELLIGENCE:
                *vp = INT_TO_JSVAL(gPriv->GetIntelligence2());
                break;
            case CCP_TSTRENGTH:
                *vp = INT_TO_JSVAL(gPriv->GetStrength2());
                break;
            case CCP_POISON:
                *vp = INT_TO_JSVAL(gPriv->GetPoisoned());
                break;
            case CCP_LIGHTLEVEL:
                *vp = INT_TO_JSVAL(gPriv->GetFixedLight());
                break;
            case CCP_VULNERABLE:
                *vp = BOOLEAN_TO_JSVAL(!gPriv->IsInvulnerable());
                break;
            case CCP_HUNGERSTATUS:
                *vp = BOOLEAN_TO_JSVAL(gPriv->WillHunger());
                break;
            case CCP_THIRSTSTATUS:
                *vp = BOOLEAN_TO_JSVAL(gPriv->WillThirst());
                break;
            case CCP_LODAMAGE:
                *vp = INT_TO_JSVAL(gPriv->GetLoDamage());
                break;
            case CCP_HIDAMAGE:
                *vp = INT_TO_JSVAL(gPriv->GetHiDamage());
                break;
            case CCP_FLAG:
                *vp = INT_TO_JSVAL(gPriv->GetFlag());
                break;
            case CCP_ATWAR:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsAtWar());
                break;
            case CCP_SPELLCAST:
                *vp = INT_TO_JSVAL(gPriv->GetSpellCast());
                break;
            case CCP_ISCASTING:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsCasting() || gPriv->IsJSCasting());
                break;
            case CCP_PRIV:
                *vp = INT_TO_JSVAL(gPriv->GetPriv());
                break;
            case CCP_TOWNPRIV:
                *vp = INT_TO_JSVAL(gPriv->GetTownPriv());
                break;
            case CCP_GUILDTITLE:
                ...
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CCP_HAIRSTYLE:
                *vp = INT_TO_JSVAL(gPriv->GetHairStyle());
                break;
            case CCP_HAIRCOLOUR:
                *vp = INT_TO_JSVAL(gPriv->GetHairColour());
                break;
            case CCP_BEARDSTYLE:
                *vp = INT_TO_JSVAL(gPriv->GetBeardStyle());
                break;
            case CCP_BEARDCOLOUR:
                *vp = INT_TO_JSVAL(gPriv->GetBeardColour());
                break;
            case CCP_FONTTYPE:
                *vp = INT_TO_JSVAL(gPriv->GetFontType());
                break;
            case CCP_SAYCOLOUR:
                *vp = INT_TO_JSVAL(gPriv->GetSayColour());
                break;
            case CCP_EMOTECOLOUR:
                *vp = INT_TO_JSVAL(gPriv->GetEmoteColour());
                break;
            case CCP_ATTACKER: {
                // Hm Quite funny, same thing as .owner
                CChar *tempChar = gPriv->GetAttacker();
                if (!ValidateObject(tempChar)) { // Return a JS_NULL
                    *vp = JSVAL_NULL;
                }
                else {
                    // Otherwise Acquire an object
            ...
            case CCP_OWNEDITEMSCOUNT:
                *vp = INT_TO_JSVAL(gPriv->GetOwnedItems()->size());
                break;
            case CCP_CELL:
                *vp = INT_TO_JSVAL(gPriv->GetCell());
                break;
            case CCP_ALLMOVE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->AllMove());
                break;
            case CCP_HOUSEICONS:
                *vp = BOOLEAN_TO_JSVAL(gPriv->ViewHouseAsIcon());
                break;
            case CCP_SPATTACK:
                *vp = INT_TO_JSVAL(gPriv->GetSpAttack());
                break;
            case CCP_SPDELAY:
                *vp = INT_TO_JSVAL(gPriv->GetSpDelay());
                break;
            case CCP_AITYPE:
                *vp = INT_TO_JSVAL(gPriv->GetNpcAiType());
                break;
            case CCP_SPLIT:
                *vp = INT_TO_JSVAL(gPriv->GetSplit());
                break;
            case CCP_SPLITCHANCE:
                *vp = INT_TO_JSVAL(gPriv->GetSplitChance());
                break;
            case CCP_TRAINER:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanTrain());
                break;
            case CCP_HIRELING:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanBeHired());
                break;
            case CCP_WEIGHT:
                *vp = INT_TO_JSVAL(gPriv->GetWeight());
                break;
            case CCP_SQUELCH:
                *vp = INT_TO_JSVAL(gPriv->GetSquelched());
                break;
            case CCP_ISJAILED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsJailed());
                break;
            case CCP_MAGICREFLECT:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsTempReflected());
                break;
            case CCP_PERMMAGICREFLECT:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsPermReflected());
                break;
            case CCP_TAMED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsTamed());
                break;
            case CCP_TAMEDHUNGERRATE:
                *vp = INT_TO_JSVAL(gPriv->GetTamedHungerRate());
                break;
            case CCP_TAMEDTHIRSTRATE:
                *vp = INT_TO_JSVAL(gPriv->GetTamedThirstRate());
                break;
            case CCP_HUNGERWILDCHANCE:
                *vp = INT_TO_JSVAL(gPriv->GetTamedHungerWildChance());
                break;
            case CCP_THIRSTWILDCHANCE:
                *vp = INT_TO_JSVAL(gPriv->GetTamedThirstWildChance());
                break;
            case CCP_FOODLIST:
                ...
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CCP_MOUNTED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->GetMounted());
                break;
            case CCP_STABLED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->GetStabled());
                break;
            case CCP_USINGPOTION:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsUsingPotion());
                break;
            case CCP_STEALTH:
                *vp = INT_TO_JSVAL(gPriv->GetStealth());
                break;
            case CCP_SKILLTOTAME:
                *vp = INT_TO_JSVAL(gPriv->GetTaming());
                break;
            case CCP_SKILLTOPROV:
                *vp = INT_TO_JSVAL(gPriv->GetProvoing());
                break;
            case CCP_SKILLTOPEACE:
                *vp = INT_TO_JSVAL(gPriv->GetPeaceing());
                break;
            case CCP_POISONSTRENGTH:
                *vp = INT_TO_JSVAL(gPriv->GetPoisonStrength());
                break;
            case CCP_ISPOLYMORPHED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsPolymorphed());
                break;
            case CCP_ISINCOGNITO:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsIncognito());
                break;
            case CCP_ISDISGUISED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDisguised());
                break;
            case CCP_CANRUN:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanRun());
                break;
            case CCP_ISMEDITATING:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsMeditating());
                break;
            case CCP_ISGM:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsGM());
                break;
            case CCP_CANBROADCAST:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanBroadcast());
                break;
            case CCP_SINGCLICKSER:
                *vp = BOOLEAN_TO_JSVAL(gPriv->GetSingClickSer());
                break;
            case CCP_NOSKILLTITLES:
                *vp = BOOLEAN_TO_JSVAL(gPriv->NoSkillTitles());
                break;
            case CCP_ISGMPAGEABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsGMPageable());
                break;
            case CCP_CANSNOOP:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanSnoop());
                break;
            case CCP_ISCOUNSELOR:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsCounselor());
                break;
            case CCP_NONEEDMANA:
                *vp = BOOLEAN_TO_JSVAL(gPriv->NoNeedMana());
                break;
            case CCP_ISDISPELLABLE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDispellable());
                break;
            case CCP_NONEEDREAGS:
            ...
            case CCP_NPCGUILD:
                *vp = INT_TO_JSVAL(gPriv->GetNPCGuild());
                break;
            case CCP_ISSHOP:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsShop());
                break;
            case CCP_MAXLOYALTY:
                *vp = INT_TO_JSVAL(gPriv->GetMaxLoyalty());
                break;
            case CCP_LOYALTY:
                *vp = INT_TO_JSVAL(gPriv->GetLoyalty());
                break;
            ...
            case CCP_MULTI:
                ...
                break;
            case CCP_HOUSESOWNED:
                *vp = INT_TO_JSVAL(gPriv->CountHousesOwned(false));
                break;
            case CCP_HOUSESCOOWNED:
                *vp = INT_TO_JSVAL(gPriv->CountHousesOwned(true));
                break;
            default:
                break;
        }
...
JSBool CCharacterProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            ...
            case CCP_TARGET:
                ...
                break;
            case CCP_DEXTERITY:
                gPriv->SetDexterity(encaps.toInt());
                break;
            case CCP_INTELLIGENCE:
                gPriv->SetIntelligence(encaps.toInt());
                break;
            case CCP_STRENGTH:
                gPriv->SetStrength(encaps.toInt());
                break;
            case CCP_SKILLS:
                break;
            case CCP_MANA:
                gPriv->SetMana(encaps.toInt());
                break;
            case CCP_STAMINA:
                gPriv->SetStamina(encaps.toInt());
                break;
            case CCP_CHARPACK:
                break;
            case CCP_FAME:
            ...
            case CCP_TDEXTERITY:
                ...
                break;
            case CCP_TINTELLIGENCE:
                gPriv->SetIntelligence2(encaps.toInt());
                break;
            case CCP_TSTRENGTH:
            ...
            case CCP_LIGHTLEVEL:
                ...
                break;
            case CCP_VULNERABLE:
                gPriv->SetInvulnerable(!encaps.toBool());
                break;
            case CCP_HUNGERSTATUS:
                gPriv->SetHungerStatus(encaps.toBool());
                break;
            case CCP_THIRSTSTATUS:
            ...
            case CCP_MAGICREFLECT:
                ...
                break;
            case CCP_PERMMAGICREFLECT:
                gPriv->SetPermReflected(encaps.toBool());
                break;
            case CCP_TAMED:
            ...
            case CCP_FOODLIST:
                ...
                break;
            case CCP_MOUNTED:
                gPriv->SetMounted(encaps.toBool());
                break;
            case CCP_STABLED:
                gPriv->SetStabled(encaps.toBool());
                break;
            case CCP_USINGPOTION:
                gPriv->SetUsingPotion(encaps.toBool());
                break;
            case CCP_STEALTH:
                gPriv->SetStealth(encaps.toInt());
                break;
            case CCP_SKILLTOTAME:
                gPriv->SetTaming(encaps.toInt());
                break;
            case CCP_SKILLTOPROV:
                gPriv->SetProvoing(encaps.toInt());
                break;
            case CCP_SKILLTOPEACE:
            ...
            case CCP_ISPOLYMORPHED:
                ...
                break;
            case CCP_ISINCOGNITO:
                gPriv->IsIncognito(encaps.toBool());
                break;
            case CCP_ISDISGUISED:
                gPriv->IsDisguised(encaps.toBool());
                break;
            case CCP_CANRUN:
                gPriv->SetRun(encaps.toBool());
                break;
            case CCP_ISGUARDED:
                gPriv->SetGuarded(encaps.toBool());
                break;
            case CCP_GUARDING:
                ...
                break;
            case CCP_ISMEDITATING:
                gPriv->SetMeditating(encaps.toBool());
                break;
            case CCP_ISGM:
                gPriv->SetGM(encaps.toBool());
                break;
            case CCP_CANBROADCAST:
                gPriv->SetBroadcast(encaps.toBool());
                break;
            case CCP_SINGCLICKSER:
                gPriv->SetSingClickSer(encaps.toBool());
                break;
            case CCP_NOSKILLTITLES:
                gPriv->SetSkillTitles(encaps.toBool());
                break;
            case CCP_ISGMPAGEABLE:
                gPriv->SetGMPageable(encaps.toBool());
                break;
            case CCP_CANSNOOP:
                gPriv->SetSnoop(encaps.toBool());
                break;
            case CCP_ISCOUNSELOR:
                gPriv->SetCounselor(encaps.toBool());
                break;
            case CCP_NONEEDMANA:
                gPriv->SetNoNeedMana(encaps.toBool());
                break;
            case CCP_ISDISPELLABLE:
                gPriv->SetDispellable(encaps.toBool());
                break;
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting Character property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CREGP_MAYOR:
                ...
                break;
            case CREGP_RACE:
                *vp = INT_TO_JSVAL(gPriv->GetRace());
                break;
            case CREGP_TAX:
                *vp = INT_TO_JSVAL(gPriv->TaxedAmount());
                break;
            case CREGP_TAXRESOURCE:
                *vp = INT_TO_JSVAL(gPriv->GetResourceId());
                break;
            case CREGP_CANMARK:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanMark());
                break;
            case CREGP_CANRECALL:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanRecall());
                break;
            case CREGP_CANGATE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanGate());
                break;
            case CREGP_CANTELEPORT:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanTeleport());
                break;
            case CREGP_CANPLACEHOUSE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanPlaceHouse());
                break;
            case CREGP_ISGUARDED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsGuarded());
                break;
            ...
            case CREGP_INSTANCEID:
                *vp = INT_TO_JSVAL(gPriv->GetInstanceId());
                break;
            case CREGP_CANCASTAGGRESSIVE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CanCastAggressive());
                break;
            case CREGP_ISSAFEZONE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsSafeZone());
                break;
            case CREGP_HEALTH:
                *vp = INT_TO_JSVAL(gPriv->GetHealth());
                break;
            case CREGP_ISDUNGEON:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsDungeon());
                break;
            case CREGP_CHANCEBIGORE:
                *vp = INT_TO_JSVAL(gPriv->GetChanceBigOre());
                break;
            case CREGP_NUMOREPREFERENCES:
                *vp = INT_TO_JSVAL(gPriv->GetNumOrePreferences());
                break;
            case CREGP_POPULATION:
                *vp = INT_TO_JSVAL(gPriv->GetPopulation());
                break;
            case CREGP_MEMBERS:
                ...
                *vp = STRING_TO_JSVAL(tString);
                break;
            case CREGP_ID:
                *vp = INT_TO_JSVAL(gPriv->GetRegionNum());
                break;
            case CREGP_NUMGUARDS:
                *vp = INT_TO_JSVAL(gPriv->NumGuards());
                break;
            ...
            case CREGP_TAXES:
                *vp = INT_TO_JSVAL(gPriv->GetTaxes());
                break;
            case CREGP_RESERVES:
                *vp = INT_TO_JSVAL(gPriv->GetReserves());
                break;
            case CREGP_APPEARANCE:
                *vp = INT_TO_JSVAL(gPriv->GetAppearance());
                break;
            case CREGP_MUSIC:
                *vp = INT_TO_JSVAL(gPriv->GetMusicList());
                break;
            case CREGP_WEATHER:
                *vp = INT_TO_JSVAL(gPriv->GetWeather());
                break;
            case CREGP_OWNER:
...
JSBool CRegionProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            ...
            case CREGP_CANMARK:
                ...
                break;
            case CREGP_CANRECALL:
                gPriv->CanRecall(encaps.toBool());
                break;
            case CREGP_CANGATE:
                gPriv->CanGate(encaps.toBool());
                break;
            case CREGP_CANTELEPORT:
                gPriv->CanTeleport(encaps.toBool());
                break;
            case CREGP_CANPLACEHOUSE:
                gPriv->CanPlaceHouse(encaps.toBool());
                break;
            case CREGP_ISGUARDED:
                gPriv->IsGuarded(encaps.toBool());
                break;
            case CREGP_CANCASTAGGRESSIVE:
                gPriv->CanCastAggressive(encaps.toBool());
                break;
            case CREGP_ISSAFEZONE:
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting Region property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!", JSVAL_TO_INT(id), origScriptID));
        }
    }
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CSPAWNREGP_ITEMLIST: {
                // This could potentially be a list of item ids - let's convert it to a comma-separated
                // string!
            ...
            case CSPAWNREGP_NPCLIST: {
                // This could potentially be a list of NPC ids - let's convert it to a comma-separated
                // string!
            ...
            case CSPAWNREGP_ITEMCOUNT:
                *vp = INT_TO_JSVAL(gPriv->GetCurrentItemAmt());
                break;
            case CSPAWNREGP_NPCCOUNT:
                *vp = INT_TO_JSVAL(gPriv->GetCurrentCharAmt());
                break;
            case CSPAWNREGP_MAXITEMS:
                *vp = INT_TO_JSVAL(gPriv->GetMaxItemSpawn());
                break;
            case CSPAWNREGP_MAXNPCS:
                *vp = INT_TO_JSVAL(gPriv->GetMaxCharSpawn());
                break;
            case CSPAWNREGP_MINTIME:
                *vp = INT_TO_JSVAL(gPriv->GetMinTime());
                break;
            case CSPAWNREGP_MAXTIME:
                *vp = INT_TO_JSVAL(gPriv->GetMaxTime());
                break;
            case CSPAWNREGP_ONLYOUTSIDE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->GetOnlyOutside());
                break;
            case CSPAWNREGP_ISSPAWNER:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsSpawner());
                break;
            case CSPAWNREGP_X1:
                *vp = INT_TO_JSVAL(gPriv->GetX1());
                break;
            case CSPAWNREGP_Y1:
                *vp = INT_TO_JSVAL(gPriv->GetY1());
                break;
            case CSPAWNREGP_X2:
                *vp = INT_TO_JSVAL(gPriv->GetX2());
                break;
            case CSPAWNREGP_Y2:
                *vp = INT_TO_JSVAL(gPriv->GetY2());
                break;
            case CSPAWNREGP_DEFZ:
                *vp = INT_TO_JSVAL(gPriv->GetDefZ());
                break;
            case CSPAWNREGP_PREFZ:
                *vp = INT_TO_JSVAL(gPriv->GetPrefZ());
                break;
...
JSBool CSpawnRegionProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            case CSPAWNREGP_NAME:
                ...
                break;
            case CSPAWNREGP_ITEM:
                gPriv->SetItem(encaps.toString());
                break;
            case CSPAWNREGP_ITEMLIST:
                gPriv->SetItemList(encaps.toString());
                break;
            case CSPAWNREGP_NPC:
                gPriv->SetNPC(encaps.toString());
                break;
            case CSPAWNREGP_NPCLIST:
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting SpawnRegion property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CGP_STONE:
                ...
                break;
            case CGP_NUMMEMBERS:
                *vp = INT_TO_JSVAL(gPriv->NumMembers());
                break;
            case CGP_NUMRECRUITS:
                *vp = INT_TO_JSVAL(gPriv->NumRecruits());
                break;
            case CGP_MEMBERS:
            case CGP_RECRUITS:
                break;
...
JSBool CGuildProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            case CGP_NAME:
                ...
                break;
            case CGP_TYPE:
                gPriv->Type(static_cast<GuildType>(encaps.toInt()));
                break;
            case CGP_MASTER:
                if (*vp != JSVAL_NULL) {
                    CChar *myChar = static_cast<CChar *>(encaps.toObject());
            ...
            case CGP_RECRUITS:
                break;
            case CGP_CHARTER:
                gPriv->Charter(encaps.toString());
                break;
            case CGP_ABBREVIATION:
                gPriv->Abbreviation(encaps.toString().c_str());
                break;
            case CGP_WEBPAGE:
                gPriv->Webpage(encaps.toString());
                break;
            default:
                break;
        }
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting Guild property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!", JSVAL_TO_INT(id), origScriptID));
        }
    }
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CRP_WEAKTOWEATHER:
                break;
            case CRP_REQUIRESBEARD:
                *vp = BOOLEAN_TO_JSVAL(gPriv->RequiresBeard());
                break;
            case CRP_REQUIRESNOBEARD:
                *vp = BOOLEAN_TO_JSVAL(gPriv->NoBeard());
                break;
            case CRP_ISPLAYERRACE:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsPlayerRace());
                break;
            case CRP_GENDERRESTRICT:
                *vp = INT_TO_JSVAL(gPriv->GenderRestriction());
                break;
            case CRP_ARMOURCLASS:
                *vp = INT_TO_JSVAL(gPriv->ArmourClassRestriction());
                break;
            case CRP_LANGUAGESKILLMIN:
                *vp = INT_TO_JSVAL(gPriv->LanguageMin());
                break;
            case CRP_SKILLADJUSTMENT:
                break;
            case CRP_POISONRESISTANCE:
                JS_NewNumberValue(cx, gPriv->PoisonResistance(), vp);
                break;
            case CRP_MAGICRESISTANCE:
                JS_NewNumberValue(cx, gPriv->MagicResistance(), vp);
                break;
            case CRP_VISIBLEDISTANCE:
                *vp = INT_TO_JSVAL(gPriv->VisibilityRange());
                break;
            case CRP_NIGHTVISION:
                *vp = INT_TO_JSVAL(gPriv->NightVision());
                break;
            default:
                break;
        }
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            ...
            case CRP_WEAKTOWEATHER:
                break;
            case CRP_REQUIRESBEARD:
                gPriv->RequiresBeard(encaps.toBool());
                break;
            case CRP_REQUIRESNOBEARD:
                gPriv->NoBeard(encaps.toBool());
                break;
            case CRP_ISPLAYERRACE:
            ...
            case CRP_SKILLADJUSTMENT:
                break;
            case CRP_POISONRESISTANCE:
                gPriv->PoisonResistance(encaps.toFloat());
                break;
            case CRP_MAGICRESISTANCE:
...
JSBool CSocketProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            ...
            case CSOCKP_IDLETIMEOUT:
                break;
            case CSOCKP_WASIDLEWARNED:
                gPriv->WasIdleWarned(encaps.toBool());
                break;
            case CSOCKP_TEMPINT:
                gPriv->TempInt(encaps.toInt());
                break;
            case CSOCKP_TEMPINT2:
                gPriv->TempInt2(encaps.toInt());
                break; // Reserved for JS usage
            case CSOCKP_TEMPOBJ:
                if (*vp == JSVAL_NULL) {
            ...
            case CSOCKP_ADDID:
                break;
            case CSOCKP_NEWCLIENT:
                gPriv->NewClient(encaps.toBool());
                break;
            case CSOCKP_FIRSTPACKET:
                gPriv->FirstPacket(encaps.toBool());
                break;
            case CSOCKP_CRYPTCLIENT:
                gPriv->CryptClient(encaps.toBool());
                break;
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning( util::format("Script context lost after setting Socket property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            ...
            case CSOCKP_IDLETIMEOUT:
                break;
            case CSOCKP_WASIDLEWARNED:
                *vp = BOOLEAN_TO_JSVAL(gPriv->WasIdleWarned());
                break;
            case CSOCKP_TEMPINT:
                *vp = INT_TO_JSVAL(gPriv->TempInt());
                break;
            case CSOCKP_TEMPINT2:
                *vp = INT_TO_JSVAL(gPriv->TempInt2());
                break;
            case CSOCKP_TEMPOBJ: {
            ...
            case CSOCKP_ADDID:
                break;
            case CSOCKP_NEWCLIENT:
                *vp = BOOLEAN_TO_JSVAL(gPriv->NewClient());
                break;
            case CSOCKP_FIRSTPACKET:
                *vp = BOOLEAN_TO_JSVAL(gPriv->FirstPacket());
                break;
            case CSOCKP_CRYPTCLIENT:
                *vp = BOOLEAN_TO_JSVAL(gPriv->CryptClient());
                break;
            case CSOCKP_CLIENTIP:
                break;
            case CSOCKP_WALKSEQUENCE:
                *vp = INT_TO_JSVAL(gPriv->WalkSequence());
                break;
            case CSOCKP_CURRENTSPELLTYPE:
                *vp = INT_TO_JSVAL(gPriv->CurrentSpellType());
                break;
            case CSOCKP_LOGGING:
                *vp = BOOLEAN_TO_JSVAL(gPriv->Logging());
                break;
            case CSOCKP_BYTESSENT:
                *vp = INT_TO_JSVAL(gPriv->BytesSent());
                break;
            case CSOCKP_BYTESRECEIVED:
                *vp = INT_TO_JSVAL(gPriv->BytesReceived());
                break;
            case CSOCKP_TARGETOK:
                *vp = BOOLEAN_TO_JSVAL(gPriv->TargetOK());
                break;
            case CSOCKP_CLICKX:
                *vp = INT_TO_JSVAL(gPriv->ClickX());
                break;
            case CSOCKP_CLICKY:
                *vp = INT_TO_JSVAL(gPriv->ClickY());
                break;
            case CSOCKP_PICKUPX:
                *vp = INT_TO_JSVAL(gPriv->PickupX());
                break;
            case CSOCKP_PICKUPY:
                *vp = INT_TO_JSVAL(gPriv->PickupY());
                break;
            case CSOCKP_PICKUPZ:
                *vp = INT_TO_JSVAL(gPriv->PickupZ());
                break;
            case CSOCKP_PICKUPSPOT:
                *vp = INT_TO_JSVAL(gPriv->PickupSpot());
                break;
            case CSOCKP_PICKUPSERIAL:
                break;
            case CSOCKP_LANGUAGE:
...
JSBool CSkillsProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting Skill property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
...
JSBool CAccountProps_getProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        ...
        switch (JSVAL_TO_INT(id)) {
            case CACCOUNT_ID:
                *vp = INT_TO_JSVAL(myAccount->accountNumber);
                break;
            ...
            case CACCOUNT_PATH:     // Nah.
                break;
            case CACCOUNT_FLAGS:
                *vp = INT_TO_JSVAL((myAccount->flag).to_ulong());
                break;
            ...
            case CACCOUNT_TIMEBAN:
                *vp = INT_TO_JSVAL(myAccount->timeBan);
                break;
            case CACCOUNT_FIRSTLOGIN:
                *vp = INT_TO_JSVAL(myAccount->firstLoginTime);
                break;
            case CACCOUNT_TOTALPLAYTIME:
                *vp = INT_TO_JSVAL(myAccount->totalPlayingTime);
                break;
            ...
            case CACCOUNT_LASTIP: {
                std::string ipString = util::ntos(static_cast<std::int32_t>((myAccount->lastIP & 0xFF000000) >> 24)) + "." + util::ntos(static_cast<std::int32_t>((myAccount->lastIP & 0x00FF0000) >> 16)) + "." + util::ntos(static_cast<std::int32_t>((myAccount->lastIP & 0x0000FF00) >> 8)) + "." + util::ntos(static_cast<std::int32_t>((myAccount->lastIP & 0x000000FF) % 256));
...
JSBool CAccountProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting Account property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
...
JSBool CScriptSectionProps_getProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            case CSS_NUMTAGS:
                *vp = INT_TO_JSVAL(gPriv->NumEntries());
                break;
            case CSS_ATEND:
                *vp = BOOLEAN_TO_JSVAL(gPriv->AtEnd());
                break;
            case CSS_ATENDTAGS:
                *vp = BOOLEAN_TO_JSVAL(gPriv->AtEndTags());
                break;
            default:
                break;
        }
...
JSBool CResourceProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning(util::format("Script context lost after setting Resource property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!",JSVAL_TO_INT(id), origScriptID));
        }
    }
...
JSBool CResourceProps_getProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            case CRESP_LOGAMT:
                *vp = INT_TO_JSVAL(gPriv->logAmt);
                break;
            case CRESP_LOGTIME:
                JS_NewNumberValue(cx, gPriv->logTime, vp);
                break;
            case CRESP_OREAMT:
                *vp = INT_TO_JSVAL(gPriv->oreAmt);
                break;
            case CRESP_ORETIME:
                JS_NewNumberValue(cx, gPriv->oreTime, vp);
                break;
            case CRESP_FISHAMT:
                *vp = INT_TO_JSVAL(gPriv->fishAmt);
                break;
            case CRESP_FISHTIME:
                JS_NewNumberValue(cx, gPriv->fishTime, vp);
                break;
            default:
                break;
        }
...
JSBool CPartyProps_setProperty(JSContext *cx, JSObject *obj, jsval id, jsval *vp) {
    ...
    if (origScript != JSMapping->GetScript(JS_GetGlobalObject(cx))) {
        ...
        if (retVal == JS_FALSE) {
            // Dummy function not found, let shard admin know!
            Console::shared().warning( util::format("Script context lost after setting Party property %u. Add 'function _restorecontext_() {}' to original script (%u) as safeguard!", JSVAL_TO_INT(id), origScriptID));
        }
    }
    ...
    if (JSVAL_IS_INT(id)) {
        switch (JSVAL_TO_INT(id)) {
            ...
            case CPARTYP_MEMBERCOUNT:
                *vp = INT_TO_JSVAL(gPriv->MemberList()->size());
                break;
            case CPARTYP_ISNPC:
                *vp = BOOLEAN_TO_JSVAL(gPriv->IsNPC());
                break;
        ...
        if (trgObj.isType(JSEncapsulate::JSOT_OBJECT)) {
            if (srcObj.ClassName() != trgObj.ClassName()) {
                *bp = JS_FALSE;
                ...
                else {// both valid base objects!  Now, we'll declare equality based on SERIAL, not
                    // pointer
