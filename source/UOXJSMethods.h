...
inline JSFunctionSpec CChar_Methods[] =
{
	...
	JS_FN( "WalkTo",				CChar_WalkTo,			2, 0 ),
	JS_FN( "RunTo",				CChar_RunTo,			2, 0 ),
	...
	JS_FN( "ReverseTempEffect",	CBase_ReverseTempEffect,		1, 0 ),
	JS_FN( "PauseTempEffect",	CBase_PauseTempEffect,		1, 0 ),
	JS_FN( "ResumeTempEffect",	CBase_ResumeTempEffect,		1, 0 ),
	JS_FN( "PauseJSTimer",	CBase_PauseJSTimer,		1, 0 ),
	JS_FN( "ResumeJSTimer",	CBase_ResumeJSTimer,		1, 0 ),
	JS_FS_END
};
...
inline JSFunctionSpec CItem_Methods[] =
{
	...
	JS_FN( "AddVendor",			CMulti_AddVendor,			1, 0 ),
	JS_FN( "RemoveVendor",		CMulti_RemoveVendor,		1, 0 ),
...
inline JSFunctionSpec CGuild_Methods[] =
{
	...
	JS_FN( "AddMember",			CGuild_AddMember,			1, 0 ),
	JS_FN( "AddRecruit",			CGuild_AddRecruit,			1, 0 ),
	JS_FN( "RemoveRecruit",		CGuild_RemoveRecruit,		1, 0 ),
	JS_FN( "RemoveMember",		CGuild_RemoveMember,		1, 0 ),
	JS_FN( "RecruitToMember",	CGuild_RecruitToMember,		1, 0 ),
	JS_FN( "IsAtWar",			CGuild_IsAtWar,				1, 0 ),
	JS_FN( "IsAlly",				CGuild_IsAlly,				1, 0 ),
	JS_FN( "IsNeutral",			CGuild_IsNeutral,			1, 0 ),
	JS_FS_END
};
...
inline JSFunctionSpec CRace_Methods[] =
{
	...
	JS_FN( "CanEquip",	        CRace_CanEquip,		        1, 0 ),
...
inline JSFunctionSpec CConsole_Methods[] =
{
	...
	JS_FN( "BeginRestart",		CConsole_BeginRestart,		0, 0 ),
