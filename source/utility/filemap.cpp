...
namespace util {
    //=================================================================================
    filemap_t::filemap_t(filemap_t &&object):path(std::exchange(object.path, std::filesystem::path())),ptr(std::exchange(object.ptr,nullptr)),length(std::exchange(object.length, 0)) {
        
    }
    //=================================================================================
    auto filemap_t::operator=(filemap_t &&object)->filemap_t& {
        this->path = std::exchange(object.path, std::filesystem::path());
        this->ptr = std::exchange(object.ptr,nullptr);
