...
auto strcopy(char *dest, rsize_t size, const char *src) -> void { strcpy_s(dest, size, src); }
...
auto mgmtime(struct tm *dest, const time_t *timer) -> struct tm * { return gmtime_r(timer, dest); }
