...
public:
    ...
    virtual void	HitPointsRegeneration( UI16 value );
    virtual void    StaminaRegeneration( UI16 value );
    virtual void    ManaRegeneration( UI16 value );
    virtual void    ReflectPhysicalDamage( UI16 value );
    virtual void    EnhancePotions( UI16 value );
    ...
    virtual void    StrengthIncrease( UI16 value );
    virtual void    DexterityIncrease( UI16 value );
    virtual void    IntelligenceIncrease( UI16 value );
    virtual void    HitPointsIncrease( UI16 value );
    virtual void    StaminaIncrease( UI16 value );
    virtual void    ManaIncrease( UI16 value );
    virtual void    MaxHitPointsIncrease( UI16 value );
    virtual void    MaxStaminaIncrease( UI16 value );
    virtual void    MaxManaIncrease( UI16 value );
};
