...
public:
	...
	CItem *		CreateBaseScriptItem( CItem *mCont, std::string ourItem, const UI08 worldNumber, const UI16 iAmount, const UI16 instanceID = 0, const ObjectType itemType = OT_ITEM, const UI16 iColor = 0xFFFF );
...
private:
	...
	CItem *		CreateRandomItem( CItem *mCont, const std::string& sItemList, const UI08 worldNumber, const UI16 instanceID = 0, bool useLootlist = false );
};
