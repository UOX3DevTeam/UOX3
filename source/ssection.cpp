...
const UI08 dfnDataTypes[DFNTAG_COUNTOFTAGS] =
{
	...
	DFN_NUMERIC,		//	DFNTAG_REGENHITS,
	DFN_NUMERIC,		//	DFNTAG_REGENSTAM,
	DFN_NUMERIC,		//	DFNTAG_REGENMANA,
...
const std::map<std::string, DFNTAGS> strToDFNTag
{
	...
	{"REGENHITS"s,			DFNTAG_REGENHITS},
	{"REGENSTAM"s,			DFNTAG_REGENSTAM},
	{"REGENMANA"s,			DFNTAG_REGENMANA},
