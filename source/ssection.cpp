...
const UI08 dfnDataTypes[DFNTAG_COUNTOFTAGS] =
{
	...
	DFN_NUMERIC,		//	DFNTAG_HEALTHREGEN,
	...
	DFN_NUMERIC,		//	DFNTAG_STAMINAREGEN,
...
const std::map<std::string, DFNTAGS> strToDFNTag
{
	...
	{"HEALTHREGEN"s,		DFNTAG_HEALTHREGEN},
	{"HEAT"s,				DFNTAG_HEAT},
	...
	{"STAMINAREGEN"s,		DFNTAG_STAMINAREGEN},
