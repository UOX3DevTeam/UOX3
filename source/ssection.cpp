...
// o------------------------------------------------------------------------------------------------o
bool CScriptSection::AtEnd() { return (currentPos == data.end()); }
...
// o------------------------------------------------------------------------------------------------o
auto CScriptSection::NumEntries() const -> size_t { return data.size(); }
...
// o------------------------------------------------------------------------------------------------o
auto CScriptSection::ItemListExist() const -> bool { return itemList; }
...
// o------------------------------------------------------------------------------------------------o
auto CScriptSection::NpcListExist() const -> bool { return npcList; }
...
// o------------------------------------------------------------------------------------------------o
auto CScriptSection::ItemListData() const -> std::string { return itemListData; }
