...
void cMagic::Recall( cSocket *s )
{
	...
	{
		mChar->SetLocation(static_cast<SI16>( i->GetTempVar( CITV_MOREX )), static_cast<SI16>(i->GetTempVar( CITV_MOREY )), static_cast<SI08>(i->GetTempVar( CITV_MOREZ )) );
		s->sysmessage( 682 );
	}
}
...
void cMagic::Mark( cSocket *s )
{
	...
	i->SetTempVar( CITV_MOREX, mChar->GetX() );
	i->SetTempVar( CITV_MOREY, mChar->GetY() );
	i->SetTempVar( CITV_MOREZ, mChar->GetZ() );
...
void cMagic::Gate( cSocket *s )
{
	...
	if( i->GetTempVar( CITV_MOREX ) <= 200 && i->GetTempVar( CITV_MOREY ) <= 200 )
		...
		SpawnGate( mChar, mChar->GetX(), mChar->GetY(), mChar->GetZ(), static_cast<SI16>(i->GetTempVar( CITV_MOREX )), static_cast<SI16>(i->GetTempVar( CITV_MOREY )), static_cast<SI08>(i->GetTempVar( CITV_MOREZ )) );
}
