...
JSBool CPacket_WriteByte( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "(CPacket_WriteByte) Invalid Number of Arguments %d, needs: 2 ", cx, argc );
		return JS_TRUE;
	}
	...
	if( myPacket == nullptr )
	{
		ScriptError( "(CPacket_WriteByte) Invalid Object Passed", cx );
		return JS_TRUE;
	}
...
JSBool CPacket_WriteShort( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "(CPacket_WriteShort) Invalid Number of Arguments %d, needs: 2 ", cx, argc );
		return JS_TRUE;
	}
	...
	if( myPacket == nullptr )
	{
		ScriptError( "(CPacket_WriteShort) Invalid Object Passed", cx );
		return JS_TRUE;
	}
...
JSBool CPacket_WriteLong( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "(CPacket_WriteLong) Invalid Number of Arguments %d, needs: 2 ", cx, argc );
		return JS_TRUE;
	}
	...
	if( myPacket == nullptr )
	{
		ScriptError( "(CPacket_WriteLong) Invalid Object Passed", cx );
		return JS_TRUE;
	}
...
JSBool CPacket_WriteString( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 3 )
	{
		ScriptError( "(CPacket_WriteString) Invalid Number of Arguments %d, needs: 3 ", cx, argc );
		return JS_TRUE;
	}
	...
	if( myPacket == nullptr )
	{
		ScriptError( "(CPacket_WriteString) Invalid Object Passed", cx );
		return JS_TRUE;
	}
...
JSBool CPacket_ReserveSize( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(CPacket_ReserveSize) Invalid Number of Arguments %d, needs: 1 ", cx, argc );
		return JS_TRUE;
	}
	...
	if( myPacket == nullptr )
	{
		ScriptError( "(CPacket_ReserveSize) Invalid Object Passed", cx );
		return JS_TRUE;
	}
...
JSBool CSocket_Send( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(CSocket_Send) Invalid Number of Arguments %d, needs: 1 ", cx, argc );
		return JS_TRUE;
	}
...
JSBool CGumpData_GetEdit( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc == 0 )
	{
		ScriptError( "(GumpData_getEdit) Invalid Number of Arguments %d, needs: 1 ", cx, argc );
	...
	if( myItem == nullptr  )
	{
		ScriptError( "(DataGump-getEdit) Invalid object assigned", cx );
		*rval = STRING_TO_JSVAL( "" );
		return JS_TRUE;
	}
...
JSBool CGumpData_GetId( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc == 0 )
	{
		ScriptError( "(GumpData_getID) Invalid Number of Arguments %d, needs: 1 ", cx, argc );
		*rval = INT_TO_JSVAL( -1 );
		return JS_TRUE;
	}
	...
	if( myItem == nullptr  )
	{
		ScriptError( "(DataGump_getID) Invalid object assigned", cx );
		*rval = INT_TO_JSVAL( -1 );
		return JS_TRUE;
	}
	size_t index = JSVAL_TO_INT( argv[0] );
...
JSBool CGumpData_GetButton( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc == 0 )
	{
		ScriptError( "(GumpData_getbutton) Invalid Number of Arguments %d, needs: 1 ", cx, argc );
		*rval = INT_TO_JSVAL( -1 );
		return JS_TRUE;
	}
	...
	if( myItem == nullptr  )
	{
		ScriptError( "(DataGump-getID) Invalid object assigned", cx );
		*rval = INT_TO_JSVAL( -1 );
		return JS_TRUE;
	}
	size_t index = JSVAL_TO_INT( argv[0] );
...
JSBool CGump_AddCheckbox( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 5 || argc > 6 )
	{
		ScriptError( "AddCheckbox: Wrong count of Parameters, needs 5 or 6", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "Gump_AddCheckbox: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_NoClose( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "NoClose: Wrong count of Parameters, needs 0", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "NoClose: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_NoMove( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "NoMove: Wrong count of Parameters, needs 0", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "NoMove: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_NoDispose( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "NoDispose: Wrong count of Parameters, needs 0", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "NoDispose: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_NoResize( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "NoResize: Wrong count of Parameters, needs 0", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "NoResize: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_MasterGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "MasterGump: Wrong count of Parameters, needs 1", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "MasterGump: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddBackground( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 5 )
	{
		ScriptError( "AddBackground: Invalid number of arguments (takes 5)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddBackground: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddButton( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 6 || argc > 7 )
	{
		ScriptError( "AddButton: Invalid number of arguments (takes 6 or 7)", cx );
		return JS_FALSE;
	}
	SI16 tL = static_cast<SI16>( JSVAL_TO_INT( argv[0] ));
	SI16 tR = static_cast<SI16>( JSVAL_TO_INT( argv[1] ));
	...
	if( gList == nullptr )
	{
		ScriptError( "AddButton: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddButtonTileArt( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 11 )
	{
		ScriptError( "AddButtonTileArt: Invalid number of arguments (takes 11)", cx );
		return JS_FALSE;
	}
	SI16 tL = static_cast<SI16>( JSVAL_TO_INT( argv[0] ));
	SI16 tR = static_cast<SI16>( JSVAL_TO_INT( argv[1] ));
	...
	if( gList == nullptr )
	{
		ScriptError( "AddButtonTileArt: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddPageButton( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 4 || argc > 5 )
	{
		ScriptError( "AddPageButton: Invalid number of arguments (takes 4 or 5)", cx );
		return JS_FALSE;
	}
	SI16 tL = static_cast<SI16>( JSVAL_TO_INT( argv[0] ));
	SI16 tR = static_cast<SI16>( JSVAL_TO_INT( argv[1] ));
	...
	if( gList == nullptr )
	{
		ScriptError( "AddPageButton: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddCheckerTrans( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 4 )
	{
		ScriptError( "AddCheckerTrans: Invalid number of arguments (takes 5 x y width height)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddCheckerTrans: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddCroppedText( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 6 )
	{
		ScriptError( "AddCroppedText: Invalid number of arguments (takes 6 x y hue width height text)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "AddCroppedText: Text is required", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddCroppedText: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddGroup( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddGroup: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddGroup: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_EndGroup( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "EndGroup: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "EndGroup: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 3 && argc != 4 )
	{
		ScriptError( "AddGump: Invalid number of arguments (takes 3 or 4 - topLeft, topRight, imageID and hue (optional))", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddGump: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddGumpColor( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 4 )
	{
		ScriptError( "AddGumpColor: Invalid number of arguments (takes 4)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddGumpColor: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddToolTip( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 1 || argc > 11 )
	{
		ScriptError( "AddToolTip: Invalid number of arguments (takes at least 1, maximum 11)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddToolTip: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddHTMLGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 7 )
	{
		ScriptError( "AddHTMLGump: Invalid number of arguments (takes 7)", cx );
		return JS_FALSE;
	}
	...
	if( TextString == nullptr )
	{
		ScriptError( "AddHTMLGump: Text is required", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddHTMLGump: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddPage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddPage: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddPage: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddPicture( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 3 )
	{
		ScriptError( "AddPicture: Invalid number of arguments (takes 3)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddPicture: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddPictureColor( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 4 )
	{
		ScriptError( "AddPicture: Invalid number of arguments (takes 4)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddPictureColor: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddPicInPic( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 7 )
	{
		ScriptError( "AddPicInPic: Invalid number of arguments (takes 7)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddPicInPic: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddItemProperty( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddItemProperty: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "SetCont: Invalid Object/Argument, takes 1 arg: item", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddItemProperty: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddRadio( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 5 || argc > 6 )
	{
		ScriptError( "Gump_AddRadio: Invalid number of arguments (takes 5 or 6)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddRadio: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddText( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 4 )
	{
		ScriptError( "AddText: Invalid number of arguments (takes 4)", cx );
		return JS_FALSE;
	}
	...
	if( TextString == nullptr )
	{
		ScriptError( "AddText: Text is required", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddText: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddTextEntry( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 8 )
	{
		ScriptError( "AddTextEntry: Invalid number of arguments (takes 8)", cx );
		return JS_FALSE;
	}
	...
	if( test == nullptr )
	{
		ScriptError( "AddTextEntry: Text is required", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddTextEntry: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddTextEntryLimited( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 9 )
	{
		ScriptError( "AddTextEntryLimited: Invalid number of arguments (takes 9)", cx );
		return JS_FALSE;
	}
	...
	if( test == nullptr )
	{
		ScriptError( "AddTextEntryLimited: Text is required", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddTextEntryLimited: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddTiledGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 5 )
	{
		ScriptError( "AddTiledGump: Invalid number of arguments (takes 5 x y width height gump)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddTiledGump: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddXMFHTMLGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 7 )
	{
		ScriptError( "AddXMFHTMLGump: Invalid number of arguments (takes 7)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddXMFHTMLGump: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddXMFHTMLGumpColor( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 8 )
	{
		ScriptError( "AddXMFHTMLGumpColor: Invalid number of arguments (takes 8)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddXMFHTMLGumpColor: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_AddXMFHTMLTok( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 8 )
	{
		ScriptError( "AddXMFHTMLTok: Invalid number of arguments (takes at least 8)", cx );
		return JS_FALSE;
	}
	...
	if( gList == nullptr )
	{
		ScriptError( "AddXMFHTMLTok: Couldn't find gump associated with object", cx );
		return JS_FALSE;
	}
...
JSBool CGump_Send( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Send: Invalid number of arguments (takes 1, socket or char)", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "You have to pass a valid Socket or Character", cx );
	}
	...
	if( myClass.ClassName() == "UOXSocket" )
	{
		...
		if( mySock == nullptr )
		{
			ScriptError( "Send: Passed an invalid Socket", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		{
			ScriptError( "Send: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	...
	{
		ScriptError( "Send: Unknown Object has been passed", cx );
		return JS_FALSE;
	}
...
JSBool CBase_TextMessage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 1 || argc > 7 )
	{
		ScriptError( "TextMessage: Invalid number of arguments (takes 1 - 7)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "You have to supply a message-text", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXItem" )
	{
		...
		{
			ScriptError( "TextMessage: Invalid Item", cx );
			return JS_FALSE;
		}
		if( !txtHue )
		{
	...
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "TextMessage: Invalid Character", cx );
			return JS_FALSE;
		}
...
JSBool CBase_KillTimers( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval)
{
	if( argc > 1 )
	{
		ScriptError( "KillTimers: Invalid count of arguments :%d, needs :0 or 1", cx, argc );
		return JS_FALSE;
	}
	auto myObj = static_cast<CBaseObject*>( JS_GetPrivate( cx, obj ));
	if( myObj == nullptr )
	{
		ScriptError( "KillTimers: Invalid object assigned.", cx );
		return JS_FALSE;
	}
	SI32 triggerNum = -1;
	if( argc == 1 )
...
JSBool CBase_GetJSTimer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
	if( argc != 2 )
	{
		ScriptError( "GetJSTimer: Invalid count of arguments :%d, needs 2 (timerId, scriptId)", cx, argc );
		return JS_FALSE;
	}
	...
	if( myObj == nullptr )
	{
		ScriptError( "GetJSTimer: Invalid object assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CBase_SetJSTimer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
	if( argc != 3 )
	{
		ScriptError( "SetJSTimer: Invalid count of arguments :%d, needs 3 (timerId, timeInMilliseconds, scriptId)", cx, argc );
		return JS_FALSE;
	}
	...
	if( myObj == nullptr )
	{
		ScriptError( "SetJSTimer: Invalid object assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CBase_KillJSTimer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
	if( argc != 2 )
	{
		ScriptError( "KillJSTimer: Invalid count of arguments :%d, needs 2 (timerId, scriptId)", cx, argc );
		return JS_FALSE;
	}
	auto myObj = static_cast<CBaseObject*>( JS_GetPrivate( cx, obj ));
	if( myObj == nullptr )
	{
		ScriptError( "KillJSTimer: Invalid object assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CBase_Delete( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	{
		ScriptError( "Delete: Invalid object", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Wander( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 3 && argc != 4 )
	{
		ScriptError( "Wander: Invalid number of arguments (takes 3-4, coordinates)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "WanderBox: Invalid character", cx );
		return JS_FALSE;
	}
	myChar->SetFx( x1, 0 );
	myChar->SetFy( y1, 0 );
...
JSBool CChar_Follow( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Follow: Invalid number of arguments (takes 1, char object or null)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ) || !myChar->IsNpc() )
	{
		ScriptError( "Follow: Invalid NPC character object referenced!", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Follow: Invalid character parameter provided!", cx );
		return JS_FALSE;
	}
...
JSBool CChar_DoAction( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 1 || argc > 5 )
	{
		ScriptError( "DoAction: Invalid number of arguments (takes 1 - (actionID), 2 (actionID, subActionID), 3 (actionID, null, frameCount), 4 (actionID, null, frameCount, frameDelay ) or 5 (actionID, null, frameCount, frameDelay, playBackwards)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "Action: Invalid character", cx );
		return JS_FALSE;
	}
...
JSBool CChar_EmoteMessage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 1 || argc > 5 )
	{
		ScriptError( "EmoteMessage: Invalid number of arguments (takes 1 - 5: text, allSay, hue, speech target and speech serial)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "EmoteMessage: Invalid character or speech", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Dismount( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Dismount: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "Dismount: Invalid character", cx );
		return JS_FALSE;
	}
	if( myChar->IsOnHorse() )
	{
...
JSBool CMisc_SysMessage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc == 0 || argc > 11 )
	{
		ScriptError( "SysMessage: Invalid number of arguments (takes at least 1, and at most 11)", cx );
		return JS_FALSE;
	}
	...
	if( mySock == nullptr )
	{
		ScriptError( "SysMessage: invalid socket", cx );
		return JS_FALSE;
	}
	...
	if( trgMessage == nullptr )
	{
		ScriptError( "SysMessage: Invalid speech (%s)", cx, targMessage );
		return JS_FALSE;
	}
...
JSBool CSocket_Disconnect( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Disconnect: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CBase_Teleport( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	switch( argc )
	{
		...
		case 0:
			...
			ScriptError( "For Items you need at least one parameter for Teleport", cx );
			break;
		...
		case 1:
			...
			{	// we can work with this, it should be either a character or item, hopefully
				...
				if( jsToGoTo.ClassName() == "UOXItem" || jsToGoTo.ClassName() == "UOXChar" )
				{
					...
					{
						ScriptError( "No object associated with this object", cx );
						break;
					}
				...
				{
					ScriptError( "Invalid class of object", cx );
					break;
				}
			}
			...
			{
				ScriptError( "Text-styled Parameters may be added later", cx );
			}
			break;
		...
		default:
			ScriptError( "Invalid number of arguments passed to Teleport, needs either 1, 2, 3, 4 or 5", cx );
			break;
	}
	...
	if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( myItem ))
		{
			ScriptError( "Teleport: Invalid Item", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "Teleport: Invalid Character", cx );
			return JS_FALSE;
		}
		...
		if(( world != myChar->WorldNumber() || instanceId != myChar->GetInstanceId() ) && !myChar->IsNpc() )
		{
			...
			{
				ScriptError( "Teleport: Not a valid World", cx );
				return JS_FALSE;
			}
...
JSBool CBase_StaticEffect( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "StaticEffect: Invalid Object", cx );
		return JS_FALSE;
	}
...
JSBool CMisc_MakeMenu( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "MakeMenu: Invalid number of arguments (takes 2, number of menu, skill used)", cx );
		return JS_FALSE;
	}
	...
	if( mySock == nullptr )
	{
		ScriptError( "MakeMenu: invalid socket", cx );
		return JS_FALSE;
	}
...
JSBool CMisc_SoundEffect( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 2 || argc > 3 )
	{
		ScriptError( "SoundEffect: Invalid number of arguments (takes min 2, max 3)", cx );
		return JS_FALSE;
	}
...
JSBool CMisc_SellTo( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	*rval = JSVAL_FALSE;
	if( argc != 1 )
	{
		ScriptError( "SellTo: Invalid Number of Arguments: %d", cx, argc );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "SellTo: Invalid NPC", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXSocket" )
	{
		...
		if( mySock == nullptr )
		{
			ScriptError( "Passed an invalid socket to SellTo", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "Passed an invalid char to SellTo", cx );
			return JS_FALSE;
		}
...
JSBool CMisc_BuyFrom( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( myNPC ))
	{
		ScriptError( "BuyFrom: Invalid NPC", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXSocket" )
	{
		...
		if( mySock == nullptr )
		{
			ScriptError( "Invalid source socket in BuyFrom", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "Passed an invalid char to BuyFrom", cx );
			return JS_FALSE;
		}
...
JSBool CMisc_HasSpell( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "HasSpell: Invalid Number of Arguments: %d", cx, argc );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "Invalid char for HasSpell", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( myItem ))
		{
			ScriptError( "Invalid item for HasSpell", cx );
			return JS_FALSE;
		}
...
JSBool CMisc_RemoveSpell( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "RemoveSpell: Invalid Number of Arguments: %d", cx, argc );
		return JS_FALSE;
	}
	...
	else if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( myItem ))
		{
			ScriptError( "Invalid item for RemoveSpell", cx );
			return JS_FALSE;
		}
...
JSBool CBase_GetTag( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "GetTag: Invalid Count of Parameters: %d, need: 1", cx, argc );
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "GetTag: Invalid Object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CBase_SetTag( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if(( argc != 2 ) && ( argc != 1 ))
	{
		ScriptError( "SetTag: Invalid Count of Parameters: %d, need: 2", cx, argc );
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "SetTag: Invalid Object assigned (SetTag)", cx );
		return JS_FALSE;
	}
...
JSBool CBase_GetTempTag( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "GetTempTag: Invalid Count of Parameters: %d, need: 1", cx, argc );
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "GetTempTag: Invalid Object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CBase_SetTempTag( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if(( argc != 2 ) && ( argc != 1 ))
	{
		ScriptError( "SetTempTag: Invalid Count of Parameters: %d, need: 2", cx, argc );
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "SetTempTag: Invalid Object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CBase_GetNumTags( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Invalid Count of Parameters: %d, need: 0", cx, argc );
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Invalid Object assigned (GetNumTags)", cx );
		return JS_FALSE;
	}
...
JSBool CBase_GetTagMap( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Invalid Object assigned (GetTagMap)", cx );
		return JS_FALSE;
	}
...
JSBool CBase_GetTempTagMap( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Invalid Object assigned (GetTempTagMap)", cx );
		return JS_FALSE;
	}
...
JSBool CChar_OpenBank( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "OpenBank: Invalid Character object assigned", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "OpenBank, Invalid count of Paramters: %d", cx, argc );
		return JS_FALSE;
	}
...
JSBool CSocket_OpenContainer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( mSock == nullptr )
	{
		ScriptError( "OpenContainer: Invalid socket", cx );
		return JS_FALSE;
	}

	if( argc < 1 || argc > 2 )
	{
		ScriptError( "OpenContainer, Invalid count of Paramters: %d", cx, argc );
		return JS_FALSE;
	}
...
JSBool CChar_OpenLayer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "OpenLayer: Invalid Character object assigned", cx );
		return JS_FALSE;
	}

	if( argc != 2 )
	{
		ScriptError( "OpenLayer, Invalid count of Paramters: %d", cx, argc );
		return JS_FALSE;
	}
...
JSBool CChar_TurnToward( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(TurnToward) Wrong object assigned", cx );
		return JS_FALSE;
	}
	...
	if( argc == 1 )
	{
		if( !JSVAL_IS_OBJECT( argv[0] ))
		{
			ScriptError( "(TurnToward) Invalid Object passed", cx );
			return JS_FALSE;
		}
	...
	{
		ScriptError( "(TurnToward) Wrong paramter count: %d, needs either one char/item or x+y", cx, argc );
		return JS_FALSE;
	}
...
JSBool CChar_DirectionTo( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(DirectionTo) Wrong object assigned", cx );
		return JS_FALSE;
	}
	...
	if( argc == 1 )
	{
		if( !JSVAL_IS_OBJECT( argv[0] ))
		{
			ScriptError( "(DirectionTo) Invalid Object passed", cx );
			return JS_FALSE;
		}
	...
	{
		ScriptError( "(DirectionTo) Wrong paramter count: %d, needs either one char/item or x+y", cx, argc );
		return JS_FALSE;
	}
...
JSBool CChar_ExecuteCommand( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "ExecuteCommand: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "ExecuteCommand: Invalid socket or speech (%s)", cx, targMessage );
		return JS_FALSE;
	}
...
JSBool CGuild_AcceptRecruit( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( myGuild == nullptr )
	{
		ScriptError( "(AcceptRecruit) Invalid Object assigned", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(AcceptRecruit) Invalid Parameter Count: %d", cx, argc );
		return JS_FALSE;
	}
...
JSBool CGuild_IsAtPeace( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(IsAtPeace) Invalid Parameter Count: %d", cx, argc );
		return JS_FALSE;
	}
	...
	if( myGuild == nullptr )
	{
		ScriptError( "(IsAtPeace) Invalid Object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CChar_ResourceCount( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(ResourceCount) Invalid Object assigned", cx );
		return JS_FALSE;
	}
	...
	if(( argc < 1 ) || ( argc > 4 ))
	{
		ScriptError( "(ResourceCount) Invalid count of parameters: %d, needs from 1 to 4 parameters", cx, argc );
		return JS_FALSE;
	}
...
JSBool CBase_UseResource( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "(UseResource) Invalid Object assigned", cx );
		return JS_FALSE;
	}
	...
	if(( argc < 2 ) || ( argc > 5 ))
	{
		ScriptError( "(UseResource) Invalid count of parameters: %d, needs from 2 to 5 parameters", cx, argc );
		return JS_FALSE;
	}
...
JSBool CMisc_CustomTarget( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if(( argc > 3 ) || ( argc < 1 ))
	{
		ScriptError( "(CustomTarget) Invalid count of parameters: %d, either needs 1, 2 or 3 (targetID, textToShow, cursorType", cx, argc );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "(CustomTarget) Invalid Character assigned", cx );
			return JS_FALSE;
		}
...
JSBool CMisc_PopUpTarget( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if(( argc > 2 ) || ( argc < 1 ))
	{
		ScriptError( "(PopUpTarget) Invalid count of parameters: %d, either needs 1 or 2", cx, argc );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "(PopUpTarget) Invalid Character assigned", cx );
			return JS_FALSE;
		}
...
JSBool CBase_InRange( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "(InRange): Invalid count of parameters: %d needs 2 (Item/Char and distance)", cx, argc );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(InRange) Invalid Object assigned to self", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(InRange) Invalid Object assigned to target", cx );
		return JS_FALSE;
	}
...
JSBool CBase_StartTimer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "(StartTimer) Invalid Object assigned", cx );
		return JS_FALSE;
	}

	if( argc != 2 && argc != 3 )
	{
		ScriptError( "(StartTimer) Invalid count of parameter: %d (needs 2 or 3)", cx, argc );
		return JS_FALSE;
	}
...
JSBool CChar_CheckSkill( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 3 && argc != 4 )
	{
		ScriptError( "CheckSkill: Invalid number of arguments (takes 3 or 4, skillNum, minSkill, maxSkill and isCraftSkill (optional))", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "CheckSkill: Invalid character", cx );
		return JS_FALSE;
	}
...
JSBool CChar_FindItemLayer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(FindItemLayer) Invalid Charobject assigned", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(FindItemLayer) Unknown Count of Arguments: %d, needs: 1", cx, argc );
		return JS_FALSE;
	}
...
JSBool CChar_FindItemType( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(FindItemType) Invalid Count of Arguments, takes 1", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(FindItemType) Invalid Charobject assigned", cx );
		return JS_FALSE;
	}
...
JSBool CChar_FindItemSection( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(FindItemSection) Invalid Count of Arguments, takes 1", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(FindItemSection) Invalid Charobject assigned", cx );
		return JS_FALSE;
	}
...
JSBool CItem_OpenPlank( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(OpenPlank) Invalid Count of Arguments: %d, needs: 0", cx, argc );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myItem ))
	{
		ScriptError( "(OpenPlank) Invalid Object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SpeechInput( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	{
		ScriptError( "(SpeechInput) Invalid Count of parameters: %d, needs: either 1 or 2", cx, argc );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(SpeechInput) Invalid object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CChar_CastSpell( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if(( argc != 1 ) && ( argc != 2 ))
	{
		ScriptError( "(CastSpell) Invalid Number of Arguments %d, needs: 1 or 2", cx, argc );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "(CastSpell) Invalid object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CChar_GetSerial( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, jsval *argv, jsval *rval )
{
	...
	{
		ScriptError( "GetSerial: Invalid Object/Argument, takes 1 arg: part of serial (1-4)", cx );
		*rval = INT_TO_JSVAL( 0 );
		return JS_FALSE;
	}
...
JSBool CBase_UpdateStats(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval)
{
	if( argc != 1 )
	{
		ScriptError( "(UpdateStats) Invalid Number of Arguments %d, needs: 1 (stat type - 0, 1 or 2 for Health, Mana or Stamina)", cx, argc );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "UpdateStats: Invalid object assigned", cx );
		return JS_FALSE;
	}
	...
	if( myObj->CanBeObjType( OT_MULTI ) || myObj->CanBeObjType( OT_ITEM ))
	{
		if( statType != 0 )
		{
			ScriptError( "UpdateStatus: For Items/Multis, only the Health stat (type 0) can be sent as an update to the client", cx );
			return JS_FALSE;
		}

		if( !myObj->IsDamageable() )
		{
			ScriptError( "UpdateStatus: Can only be used with characters, or Items/Multis with damagable flag set to true", cx );
			return JS_FALSE;
		}
	}
	...
	switch( statType )
	{
		...
		case 2: // Stamina - only relevant for characters
			...
			break;
		default:
			ScriptError( "UpdateStats: Argument can only contain values 0, 1 or 2 for Health, Mana or Stamina respectively", cx );
			return JS_FALSE;
	}
...
JSBool CChar_SetPoisoned( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 2 || argc > 3 )
	{
		ScriptError( "(SetPoisoned) Invalid Number of Arguments %d, needs: 2 or 3", cx, argc );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(SetPoisoned) Invalid object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CChar_ExplodeItem( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 4 )
	{
		ScriptError( "(ExplodeItem) Invalid Number of Arguments %d, needs: 4", cx, argc );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(ExplodeItem) Invalid object", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SetInvisible( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 1 || argc > 2 )
	{
		ScriptError( "(SetInvisible) Invalid Number of Arguments %d, needs: 1 or 2", cx, argc );
		return JS_FALSE;
	}
...
JSBool CItem_SetCont( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, jsval *argv, jsval *rval )
{
	...
	{
		ScriptError( "SetCont: Invalid Object/Argument, takes 1 arg: containerobject", cx );
		return JS_FALSE;
	}
...
JSBool CItem_IsMulti( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(IsMulti) Invalid Number of Arguments %d, needs: 0", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ))
	{
		ScriptError( "(IsMulti) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CBase_IsBoat( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(IsBoat) Invalid Number of Arguments %d, needs: 0", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_IsInMulti( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(IsInMulti) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	{
		ScriptError( "(IsInMulti) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	{
		ScriptError( "(IsInMulti) Invalid object in house", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_IsOnBanList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(IsOnBanList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(IsOnBanList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(IsOnBanList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_IsOnFriendList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(IsOnFriendList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(IsOnFriendList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(IsOnFriendList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_IsOnGuestList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(IsOnGuestList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(IsOnGuestList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(IsOnGuestList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_IsOnOwnerList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(IsOnOwnerList) Invalid Number of Arguments %d, needs: 1 or 2", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(IsOnOwnerList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(IsOnOwnerList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_IsOwner( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(IsOwner) Invalid Number of Arguments %d, needs: 1 or 2", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(IsOwner) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(IsOwner) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_AddToBanList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(AddToBanList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(AddToBanList) Invalid object assigned", cx );
		return JS_FALSE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(AddToBanList) Invalid character", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_AddToFriendList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(AddToFriendList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(AddToFriendList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(AddToFriendList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_AddToGuestList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(AddToGuestList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(AddToGuestList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(AddToGuestList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_AddToOwnerList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(AddToOwnerList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(AddToOwnerList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(AddToOwnerList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_RemoveFromBanList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(RemoveFromBanList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(RemoveFromBanList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(RemoveFromBanList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_RemoveFromFriendList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(RemoveFromFriendList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(RemoveFromFriendList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(RemoveFromFriendList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_RemoveFromGuestList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(RemoveFromGuestList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(RemoveFromGuestList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(RemoveFromGuestList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_RemoveFromOwnerList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(RemoveFromOwnerList) Invalid Number of Arguments %d, needs: 1", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(RemoveFromOwnerList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, JSVAL_TO_OBJECT( argv[0] )));
	if( !ValidateObject( toFind ))
	{
		ScriptError( "(RemoveFromOwnerList) Invalid character", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_ClearBanList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(ClearBanList) Invalid Number of Arguments %d, needs: 0", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(ClearBanList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_ClearFriendList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(ClearFriendList) Invalid Number of Arguments %d, needs: 0", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(ClearFriendList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_ClearGuestList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(ClearGuestList) Invalid Number of Arguments %d, needs: 0", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(ClearGuestList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_ClearOwnerList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(ClearOwnerList) Invalid Number of Arguments %d, needs: 0", cx, argc );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(ClearOwnerList) Invalid object assigned", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CItem_PlaceInPack( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "(PlaceInPack) Invalid Number of Arguments %d, needs: 0 or 1", cx, argc );
		return JS_FALSE;
	}
	CItem *myItem = static_cast<CItem *>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myItem ) || !myItem->CanBeObjType( OT_ITEM ))
	{
		ScriptError( "(PlaceInPack) Invalid object assigned", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_OpenURL( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	{
		ScriptError( "OpenURL: Invalid Number of Arguments %d, needs: 1", cx );
		return JS_FALSE;
	}
	...
	if( mySock == nullptr )
	{
		ScriptError( "OpenURL: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_GetByte( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 ) // 1 parameters
	{
		ScriptError( "GetByte: Invalid Number of Arguments %d, needs: 1 (offset)", cx );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	...
	if( mySock == nullptr )
	{
		ScriptError( "GetByte: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_GetSByte( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 ) // 1 parameters
	{
		ScriptError( "GetSByte: Invalid Number of Arguments %d, needs: 1 (offset)", cx );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	...
	if( mySock == nullptr )
	{
		ScriptError( "GetSByte: Invalid socket!", cx );
		return JS_FALSE;
	}
	SI32 offset	= JSVAL_TO_INT( argv[0] );
...
JSBool CSocket_GetWord( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 ) // 1 parameters
	{
		ScriptError( "GetWord: Invalid Number of Arguments %d, needs: 1 (offset)", cx );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	...
	if( mySock == nullptr )
	{
		ScriptError( "GetWord: Invalid socket!", cx );
		return JS_FALSE;
	}
	SI32 offset = JSVAL_TO_INT( argv[0] );
...
JSBool CSocket_GetSWord( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 ) // 1 parameters
	{
		ScriptError( "GetSWord: Invalid Number of Arguments %d, needs: 1 (offset)", cx );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	...
	if( mySock == nullptr )
	{
		ScriptError( "GetSWord: Invalid socket!", cx );
		return JS_FALSE;
	}
	SI32 offset = JSVAL_TO_INT( argv[0] );
...
JSBool CSocket_GetDWord( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 ) // 1 parameters
	{
		ScriptError( "GetDWord: Invalid Number of Arguments %d, needs: 1 (offset)", cx );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	...
	if( mySock == nullptr )
	{
		ScriptError( "GetDWord: Invalid socket!", cx );
		return JS_FALSE;
	}
	SI32 offset = JSVAL_TO_INT( argv[0] );
...
JSBool CSocket_GetSDWord( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 ) // 1 parameters
	{
		ScriptError( "GetSDWord: Invalid Number of Arguments %d, needs: 1 (offset)", cx );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	...
	if( mySock == nullptr )
	{
		ScriptError( "GetSDWord: Invalid socket!", cx );
		return JS_FALSE;
	}
	SI32 offset = JSVAL_TO_INT( argv[0] );
...
JSBool CSocket_GetString( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 && argc != 2 )
	{
		ScriptError( "GetString: Invalid number of arguments (takes 1 or 2)", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "GetString: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_SetByte( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SetByte: Invalid number of arguments (takes 3)", cx );
		return JS_FALSE;
	}
	CSocket *mSock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	if( mSock == nullptr )
	{
		ScriptError( "SetByte: Invalid socket!", cx );
		return JS_FALSE;
	}
	SI32 offset = JSVAL_TO_INT( argv[0] );
...
JSBool CSocket_SetWord( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SetWord: Invalid number of arguments (takes 3)", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "SetWord: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_SetDWord( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SetDWord: Invalid number of arguments (takes 3)", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "SetDWord: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_SetString( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SetString: Invalid number of arguments (takes 3)", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "SetString: Invalid socket!", cx );
		return JS_FALSE;
	}
	...
	if( trgMessage == nullptr )
	{
		ScriptError( "SetString: No string to set", cx );
		return JS_FALSE;
	}
	// FIXME
...
JSBool CSocket_ReadBytes( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "ReadBytes: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "ReadBytes: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_WhoList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( mySock == nullptr )
	{
		ScriptError( "WhoList: Invalid socket!", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_Music( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Music: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
...
JSBool CChar_YellMessage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "YellMessage: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( trgMessage == nullptr )
	{
		ScriptError( "YellMessage: You have to supply a messagetext", cx );
	}

	CChar *myChar = static_cast<CChar*>( myObj );
	if( !ValidateObject( myChar ))
	{
		ScriptError( "YellMessage: Invalid Character", cx );
		return JS_FALSE;
	}
...
JSBool CChar_WhisperMessage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "WhisperMessage: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( trgMessage == nullptr )
	{
		ScriptError( "WhisperMessage: You have to supply a messagetext", cx );
	}

	CChar *myChar = static_cast<CChar*>( myObj );
	if( !ValidateObject( myChar ))
	{
		ScriptError( "WhisperMessage: Invalid Character", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_OpenGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "OpenGump: Invalid number of arguments (takes 1, number)", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_INT( argv[0] ))
	{
		ScriptError( "You have to pass a valid menu number", cx );
	}
	...
	if( mySock == nullptr )
	{
		ScriptError( "OpenGump: Unknown Object has been passed", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_CloseGump( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "CloseGump: Invalid number of arguments (takes 2 - gumpId to close, and buttonId to send as response)", cx );
		return JS_FALSE;
	}
...
JSBool CRace_CanWearArmour( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "CanWearArmour: Invalid number of arguments (takes 1, number)", cx );
		return JS_FALSE;
	}
	...
	if( myRace == nullptr )
	{
		ScriptError( "CanWearArmour: Unknown Object has been passed", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( toFind ))
	{
		ScriptError( "CanWearArmour: Invalid item passed", cx );
		return JS_TRUE;
	}
...
JSBool CRace_IsValidHairColour( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "IsValidHairColour: Invalid number of arguments (takes 1, number)", cx );
		return JS_FALSE;
	}
	...
	if( myRace == nullptr )
	{
		ScriptError( "IsValidHairColour: Unknown Object has been passed", cx );
		return JS_FALSE;
	}
...
JSBool CRace_IsValidSkinColour( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "IsValidSkinColour: Invalid number of arguments (takes 1, number)", cx );
		return JS_FALSE;
	}
	...
	if( myRace == nullptr )
	{
		ScriptError( "IsValidSkinColour: Unknown Object has been passed", cx );
		return JS_FALSE;
	}
...
JSBool CRace_IsValidBeardColour( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "IsValidBeardColour: Invalid number of arguments (takes 1, number)", cx );
		return JS_FALSE;
	}
	...
	if( myRace == nullptr )
	{
		ScriptError( "IsValidBeardColour: Unknown Object has been passed", cx );
		return JS_FALSE;
	}
...
JSBool CBase_ApplySection( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "ApplySection: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "You have to supply a section to apply", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( myItem ))
		{
			ScriptError( "ApplySection: Invalid Item", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( myChar ))
		{
			ScriptError( "ApplySection: Invalid Character", cx );
			return JS_FALSE;
		}
...
JSBool CChar_AddSpell( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddSpell: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SpellFail( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "SpellFail: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CBase_Refresh( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Refresh: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Refresh: Invalid object assigned - only Charaacters or Items accepted", cx );
		return JS_FALSE;
	}
...
JSBool CItem_ApplyRank( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "ApplyRank: Invalid number of arguments (takes 2)", cx );
		return JS_FALSE;
	}
	CItem *myItem	= static_cast<CItem *>( JS_GetPrivate( cx, obj ));
...
JSBool CItem_IsOnFoodList( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 || argc > 7 )
	{
		ScriptError( "(IsOnFoodList) Invalid Number of Arguments %d, needs: 1 - foodlist name", cx, argc );
		return JS_TRUE;
	}
	...
	if( !ValidateObject( myItem ))
	{
		ScriptError( "(IsOnFoodList) Invalid object assigned", cx );
		return JS_TRUE;
	}

	if( !JSVAL_IS_STRING( argv[0] ))
	{
		ScriptError( "IsOnFoodList: Invalid parameter specifled, string required!", cx );
		return JS_FALSE;
	}
...
JSBool CAccount_AddAccount( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 4 )
	{
		ScriptError( "Account.AddAccount(user,pass,email,flags): Invalid number of arguments (takes 4)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Account.AddAccount(user,pass,email,flags): Invalid parameter specifled, please check param types.", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Account.AddAccount( user, pass, email, flags ): Account was not added. Duplicate expected.", cx );
		return JS_FALSE;
	}
	return JS_TRUE;
}
...
JSBool CAccount_DelAccount( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Account.DelAccount([username/id]): Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( JSVAL_IS_STRING( argv[0] ))
	{
		...
		{
			ScriptError( " Account.DelAccount(username): Unable to remove account specified.", cx );
			return JS_FALSE;
		}
	...
	else if( JSVAL_IS_INT( argv[0] ))
	{
		...
		{
			ScriptError( " Account.DelAccount(accountID): Unable to remove account specified.", cx );
			return JS_FALSE;
		}
	}
	else
...
JSBool CFile_Free( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Free: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CFile_Open( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 2 || argc > 4 )
	{
		ScriptError( "Open: Invalid number of arguments (takes 2 to 4 - filename, file mode and - optionally - folderName and useScriptDataDir bool)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
	...
	{
		ScriptError( "Open: Invalid mode must be \"read\", \"write\", or \"append\"!", cx );
		return JS_FALSE;
	}
	if( strstr( fileName, ".." ) || strstr( fileName, "\\" ) || strstr( fileName, "/" ))
	{
		ScriptError( "Open: file names may not contain \"..\", \"\\\", or \"/\".", cx );
		return JS_FALSE;
	}
	...
	if( folderName != nullptr )
	{
		...
		{
			ScriptError( "Open: folder names may not contain \"..\", \"\\\", or \"/\".", cx );
			return JS_FALSE;
		}
...
JSBool CFile_Close( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Open: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
...
JSBool CFile_Read( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Read: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
	...
	{
		ScriptError( "Read: Error reading file, is not opened or has reached EOF", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Read: Invalid byte count, must be from 1 to 512!", cx );
		return JS_FALSE;
	}
...
JSBool CFile_ReadUntil( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "ReadUntil: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
	...
	if( !mFile || !mFile->mWrap || feof( mFile->mWrap ))
	{
		ScriptError( "ReadUntil: Error reading file, is not opened or has reached EOF", cx );
		return JS_FALSE;
	}
	...
	if( until[0] == '\\' && strlen( until ) > 1 )
	{
		switch( until[1] )
		{
			...
			case '\"': until[0] = '\"'; break;
			case 'n':  until[0] = '\n'; break;
			default: ScriptError( "ReadUntil: Unsupported character escape sequence %s", cx, until );	break;
		}
	}
...
JSBool CFile_Write( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Write: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
	...
	if( !mFile || !mFile->mWrap || feof( mFile->mWrap ))
	{
		ScriptError( "Write: Error writing to file, file was not opened sucessfully!", cx );
		return JS_FALSE;
	}
	else if( ftell( mFile->mWrap ) > ( 10 * 1024 * 1024 ))
	{
		ScriptError( "Write: Error writing to file.  File may not exceed 10mb.", cx );
		return JS_FALSE;
	}
...
JSBool CFile_EOF( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "EOF: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
...
JSBool CFile_Length( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Length: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
...
JSBool CFile_Pos( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 0 && argc != 1 )
	{
		ScriptError( "Pos: Invalid number of arguments (takes 0 or 1)", cx );
		return JS_FALSE;
	}
	UOXFileWrapper_st *mFile = static_cast<UOXFileWrapper_st *>( JS_GetPrivate( cx, obj ));
...
JSBool CBase_FirstItem( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "FirstItem: Invalid count of arguments :%d, needs :0", cx, argc );
		return JS_FALSE;
	}
	CBaseObject *myObj = static_cast<CBaseObject*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myObj ))
	{
		ScriptError( "FirstItem: Invalid object assigned.", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "FirstItem: Unknown object type assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CBase_NextItem( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "NextItem: Invalid count of arguments :%d, needs :0", cx, argc );
		return JS_FALSE;
	}
	CBaseObject *myObj = static_cast<CBaseObject*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myObj ))
	{
		ScriptError( "NextItem: Invalid object assigned.", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "NextItem: Unknown object type assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CBase_FinishedItems( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "FinishedItems: Invalid count of arguments :%d, needs :0", cx, argc );
		return JS_FALSE;
	}
	CBaseObject *myObj = static_cast<CBaseObject*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myObj ))
...
JSBool CChar_WalkTo( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 && argc != 3 )
	{
		ScriptError( "WalkTo: Invalid number of arguments (takes 2 or 3)", cx );
		return JS_FALSE;
	}
	CChar *cMove = static_cast<CChar*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( cMove ))
	{
		ScriptError( "WalkTo: Invalid source character", cx );
		return JS_FALSE;
	}
	SI16 gx			= 0;
	SI16 gy			= 0;
	...
	switch( argc )
	{
		...
		case 3:
			...
			break;
		default:
			ScriptError( "Invalid number of arguments passed to WalkTo, needs either 2 or 3", cx );
			break;
	}
...
JSBool CChar_RunTo( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 && argc != 3 )
	{
		ScriptError( "RunTo: Invalid number of arguments (takes 2 or 3)", cx );
		return JS_FALSE;
	}
	CChar *cMove = static_cast<CChar*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( cMove ))
	{
		ScriptError( "RunTo: Invalid source character", cx );
		return JS_FALSE;
	}
	UI16 gx			= 0;
	UI16 gy			= 0;
	...
	switch( argc )
	{
		...
		case 3:
			...
			break;
		default:
			ScriptError( "Invalid number of arguments passed to RunTo, needs either 2 or 3", cx );
			break;
	}
...
JSBool CMisc_GetTimer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "GetTimer: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( cMove ))
		{
			ScriptError( "GetTimer: Invalid source character", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXSocket" )
	{
		...
		if( mSock == nullptr )
		{
			ScriptError( "GetTimer: Invalid source socket", cx );
			return JS_FALSE;
		}
...
JSBool CMisc_SetTimer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SetTimer: Invalid number of arguments (takes 2)", cx );
		return JS_FALSE;
	}
	JSEncapsulate encaps( cx, &( argv[0] ));
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( cMove ))
		{
			ScriptError( "SetTimer: Invalid source character", cx );
			return JS_FALSE;
		}
	...
	else if( myClass.ClassName() == "UOXSocket" )
	{
		...
		if( mSock == nullptr )
		{
			ScriptError( "SetTimer: Invalid source socket", cx );
			return JS_FALSE;
		}
...
JSBool CBase_DistanceTo( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "DistanceTo: Invalid number of arguments (takes 1, game object)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "DistanceTo: Invalid character", cx );
		return JS_FALSE;
	}
...
JSBool CItem_Glow( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	{
		ScriptError( "Glow: Invalid object", cx );
...
JSBool CItem_UnGlow( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	if( !ValidateObject( mItem ))
	{
		ScriptError( "UnGlow: Invalid item", cx );
...
JSBool CChar_Gate( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 && argc != 4 )
	{
		ScriptError( "Gate: Invalid number of arguments (takes 1; item/place, or 4; x y z world)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "Gate: Invalid source character", cx );
		return JS_FALSE;
	}
	...
	if( argc == 1 )
	{
		if( JSVAL_IS_OBJECT( argv[0] ))
		{
			...
			if( !ValidateObject( mItem ))
			{
				ScriptError( "Gate: Invalid item passed", cx );
				return JS_FALSE;
			}
...
JSBool CChar_Recall( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Recall: Invalid number of arguments (takes 1, item)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "Recall: Invalid source character", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mItem ))
	{
		ScriptError( "Recall: Invalid item passed", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Mark( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Mark: Invalid number of arguments (takes 1, character)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "Mark: Invalid source character", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mItem ))
	{
		ScriptError( "Mark: Invalid item passed", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SetRandomName( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "SetRandomName: Invalid number of arguments (takes 1, namelist string)", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SetSkillByName( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SetSkillByName: Invalid number of arguments (takes 2, string, value)", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Kill( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Kill: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	CChar *mChar = static_cast<CChar *>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( mChar ))
	{
		ScriptError( "Kill: Invalid character passed", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Resurrect( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Resurrect: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	CChar *mChar = static_cast<CChar *>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( mChar ))
	{
		ScriptError( "Resurrect: Invalid character passed", cx );
		return JS_FALSE;
	}
...
JSBool CItem_Dupe( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Dupe: Invalid number of arguments (takes 1 - socket/null)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Dupe: Bad parameters passed. Either item or socket is invalid!", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Dupe( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Dupe: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "Dupe: Invalid character object passed?", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Dupe: Unable to duplicate character due to unknown error!", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Jail( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "Jail: Invalid number of arguments (takes 0 or 1, seconds to Jail)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myChar ))
	{
		ScriptError( "Jail: Invalid character", cx );
		return JS_FALSE;
	}
...
JSBool CChar_Release( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "Release: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_Page( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "Page: Invalid number of arguments (takes 1, pageType)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_Print( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Print: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_Log( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 && argc != 2 )
	{
		ScriptError( "Log: Invalid number of arguments (takes 1 or 2)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
	JSEncapsulate arg1;
...
JSBool CConsole_Error( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Error: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
...
JSBool CConsole_Warning( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Warning: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
...
JSBool CConsole_PrintSectionBegin( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "PrintSectionBegin: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_TurnYellow( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "TurnYellow: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.TurnYellow();
	return JS_TRUE;
...
JSBool CConsole_TurnRed( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "TurnRed: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.TurnRed();
	return JS_TRUE;
...
JSBool CConsole_TurnGreen( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "TurnGreen: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.TurnGreen();
	return JS_TRUE;
...
JSBool CConsole_TurnBlue( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "TurnBlue: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.TurnBlue();
	return JS_TRUE;
...
JSBool CConsole_TurnNormal( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "TurnNormal: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.TurnNormal();
	return JS_TRUE;
...
JSBool CConsole_TurnBrightWhite( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "TurnBrightWhite: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_PrintDone( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 && argc != 1 )
	{
		ScriptError( "PrintDone: Invalid number of arguments (takes 0 or 1)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_PrintFailed( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 && argc != 1 )
	{
		ScriptError( "PrintFailed: Invalid number of arguments (takes 0 or 1)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_PrintPassed( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "PrintPassed: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.PrintPassed();
	return JS_TRUE;
...
JSBool CConsole_ClearScreen( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "ClearScreen: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	Console.ClearScreen();
	return JS_TRUE;
...
JSBool CConsole_PrintBasedOnVal( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "PrintBasedOnVal: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
...
JSBool CConsole_MoveTo( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "MoveTo: Invalid number of arguments (takes 2)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
...
JSBool CConsole_PrintSpecial( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "PrintSpecial: Invalid number of arguments (takes 2)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
	JSEncapsulate arg1( cx, &( argv[1] ));
...
JSBool CConsole_BeginShutdown( [[maybe_unused]] JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "BeginShutdown: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
...
JSBool CConsole_Reload( JSContext *cx, [[maybe_unused]] JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Reload: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	JSEncapsulate arg0( cx, &( argv[0] ));
	...
	if( mArg < 0 || mArg > 8 )
	{
		ScriptError( "Reload: Section to reload must be between 0 and 8", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SpellMoveEffect( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "SpellMoveEffect: Invalid number of arguments (takes 2)", cx );
		return JS_FALSE;
	}
	...
	if( mySpell == nullptr )
	{
		ScriptError( "SpellMoveEffect: Invalid spell", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "SpellMoveEffect: Invalid object passed", cx );
		return JS_FALSE;
	}
...
JSBool CChar_SpellStaticEffect( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "SpellStaticEffect: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "SpellStaticEffect: Invalid character passed", cx );
		return JS_FALSE;
	}
	...
	if( mySpell == nullptr )
	{
		ScriptError( "SpellStaticEffect: Invalid spell", cx );
		return JS_FALSE;
	}
...
JSBool CChar_BreakConcentration( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "BreakConcentration: Invalid number of arguments (takes 0 or 1)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "BreakConcentration: Invalid character", cx );
		return JS_FALSE;
	}
	...
	if( argc == 1 )
	{
		...
		if( mSock == nullptr )
		{
			ScriptError( "BreakConcentration: Invalid socket", cx );
			return JS_FALSE;
		}
	}
...
JSBool CSocket_SendAddMenu( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "SendAddMenu: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "SendAddMenu: Invalid socket", cx );
		return JS_FALSE;
	}
...
JSBool CItem_LockDown( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "LockDown: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( mItem == nullptr )
	{
		ScriptError( "LockDown: Invalid item", cx );
		return JS_FALSE;
	}
...
JSBool CChar_InitWanderArea( JSContext *cx, JSObject *obj, [[maybe_unused]] uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	...
	{
		ScriptError( "InitWanderArea: Invalid character", cx );
		return JS_FALSE;
	}
...
JSBool CItem_Carve( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "Carve: Invalid number of arguments (1)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "Carve: Invalid item", cx );
		return JS_FALSE;
	}
	...
	if( mSock == nullptr )
	{
		ScriptError( "Carve: Invalid socket", cx );
		return JS_FALSE;
	}
...
JSBool CItem_GetTileName( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "GetTileName: needs 0 arguments!", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( mItem ))
	{
		ScriptError( "GetTileName: Invalid item", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_GetMultiCorner( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "GetMultiCorner: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "(GetMultiCorner) Invalid object referenced - multi required", cx );
		*rval = JSVAL_FALSE;
		return JS_TRUE;
	}
...
JSBool CMulti_SecureContainer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "SecureContainer: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(SecureContainer) Invalid object referenced - multi required", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(SecureContainer) Invalid Object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_UnsecureContainer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "UnsecureContainer: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(UnsecureContainer) Invalid object referenced - multi required", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(UnsecureContainer) Invalid Object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_IsSecureContainer( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "IsSecureContainer: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(IsSecureContainer) Invalid object referenced - multi required", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(IsSecureContainer) Invalid Object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_LockDownItem( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "LockDownItem: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(LockDownItem) Invalid multi object referenced", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(LockDownItem) Invalid item object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_ReleaseItem( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "ReleaseItem: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(ReleaseItem) Invalid multi object referenced", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(ReleaseItem) Invalid item object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_AddTrashCont( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddTrashCont: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(AddTrashCont) Invalid multi object referenced", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(AddTrashCont) Invalid item object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_RemoveTrashCont( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "RemoveTrashCont: Invalid number of arguments (1 required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(RemoveTrashCont) Invalid multi object referenced", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_OBJECT( argv[0] ))
	{
		ScriptError( "(RemoveTrashCont) Invalid item object passed", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_KillKeys( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 0 && argc != 1 )
	{
		ScriptError( "KillKeys: Invalid number of arguments (0 or 1 (character) required)", cx );
		return JS_FALSE;
	}
	...
	*rval = JSVAL_FALSE;
	...
	if( !ValidateObject( multiObject ) || !multiObject->CanBeObjType( OT_MULTI ))
	{
		ScriptError( "(KillKeys) Invalid multi object referenced", cx );
		return JS_FALSE;
	}
	...
	if( argc == 1 )
	{
		...
		if( !ValidateObject( myObj ))
		{
			ScriptError( "(KillKeys) Invalid character object provided", cx );
			return JS_FALSE;
		}
...
JSBool CMulti_FirstChar( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "FirstChar: Invalid count of arguments :%d, needs :0 or 1", cx, argc );
		return JS_FALSE;
	}
	CMultiObj *myObj = static_cast<CMultiObj*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myObj ))
	{
		ScriptError( "FirstChar: Invalid object assigned - multi required.", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "FirstChar: Unknown listType provided. Supported listTypes: visitor (default), owner, friend or banned", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_NextChar( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "NextChar: Invalid count of arguments :%d, needs :0 or 1", cx, argc );
		return JS_FALSE;
	}
	CMultiObj *myObj = static_cast<CMultiObj*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myObj ))
	{
		ScriptError( "NextChar: Invalid object assigned - multi required.", cx );
		return JS_FALSE;
	}
	...
	{
		ScriptError( "FinishedChars: Unknown listType provided. Supported listTypes: visitor (default), owner, friend or banned", cx );
		return JS_FALSE;
	}
...
JSBool CMulti_FinishedChars( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "FinishedChars: Invalid count of arguments :%d, needs :0 or 1", cx, argc );
		return JS_FALSE;
	}
	CMultiObj *myObj = static_cast<CMultiObj*>( JS_GetPrivate( cx, obj ));
	if( !ValidateObject( myObj ))
	{
		ScriptError( "FinishedChars: Invalid object assigned - multi required.", cx );
		return JS_FALSE;
	}
...
JSBool CBase_CanSee( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 && argc != 3 )
	{
		ScriptError( "CanSee: Invalid number of arguments (takes 1, a char/item or 3, an x/y/z)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXSocket" )
	{
		...
		if( mSock == nullptr )
		{
			ScriptError( "CanSee: Passed an invalid Socket", cx );
			return JS_FALSE;
		}
		mChar = mSock->CurrcharObj();
		if( !ValidateObject( mChar ))
		{
			ScriptError( "CanSee: Socket to look from has an invalid Character attached", cx );
			return JS_FALSE;
		}
	}
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "CanSee: Passed an invalid Character", cx );
			return JS_FALSE;
		}
		mSock = mChar->GetSocket();
	}
	...
	if( argc == 1 )	// we've been passed an item, character, or socket
	{
		...
		if( myClass.ClassName() == "UOXSocket" )
		{
			...
			if( tSock == nullptr )
			{
				ScriptError( "CanSee: Passed an invalid Socket to look at", cx );
				*rval = JSVAL_FALSE;
				return JS_TRUE;
			}
			...
			{
				ScriptError( "CanSee: Socket to look at has invalid Character attached", cx );
				*rval = JSVAL_FALSE;
				return JS_TRUE;
			}
		...
		else if( myClass.ClassName() == "UOXChar" || myClass.ClassName() == "UOXItem" )
		{
			...
			{
				ScriptError( "CanSee: Object to look at is invalid", cx );
				*rval = JSVAL_FALSE;
				return JS_TRUE;
			}
			...
			if( tObj->CanBeObjType( OT_ITEM ))
			{
				...
				{
					ScriptError( "CanSee: Object to look at cannot be in a container", cx );
					*rval = JSVAL_FALSE;
					return JS_TRUE;
				}
...
JSBool CSocket_DisplayDamage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "(CSocket_DisplayDamage) Invalid Number of Arguments %d, needs: 2", cx, argc );
		return JS_TRUE;
	}
	...
	{
		ScriptError( "CSocket_DisplayDamage: Passed an invalid Character", cx );
		return JS_FALSE;
	}
...
JSBool CChar_ReactOnDamage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 && argc != 2 )
	{
		ScriptError( "(CChar_ReactOnDamage) Invalid Number of Arguments %d, needs: 1 (damageType) or 2 (damageType and attacker)", cx, argc );
		return JS_TRUE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "(CChar_ReactOnDamage): Operating on an invalid Character", cx );
		return JS_TRUE;
	}
	...
	if( argc >= 2 )
	{
		...
		{
			ScriptError( "CChar_ReactOnDamage: Passed an invalid Character", cx );
			return JS_FALSE;
		}
...
JSBool CChar_Damage( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc < 1 || argc > 4 )
	{
		ScriptError( "(CChar_Damage) Invalid Number of Arguments %d, needs: 1 (amount), 2 (amount, damageType), 3 (amount, damageType and attacker) or 4 (amount, damageType, attacker and doRepsys)", cx, argc );
		return JS_TRUE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "(CChar_Damage): Operating on an invalid Character", cx );
		return JS_TRUE;
	}
	JSEncapsulate damage( cx, &( argv[0] ));
	...
	if( argc >= 3 )
	{
		...
		if( attackerClass.ClassName() != "UOXChar" )	// It must be a character!
		{
			ScriptError( "CChar_Damage: Passed an invalid Character", cx );
			return JS_FALSE;
		}
...
JSBool CChar_InitiateCombat( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "(InitiateCombat) Invalid Number of Arguments %d, takes: 1 (targetChar))", cx, argc );
		return JS_TRUE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "(InitiateCombat): Operating on an invalid Character", cx );
		return JS_TRUE;
	}
...
JSBool CChar_InvalidateAttacker( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "(InvalidateAttacker) Invalid Number of Arguments %d, takes: 0)", cx, argc );
		return JS_TRUE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "(InvalidateAttacker): Operating on an invalid Character", cx );
		return JS_TRUE;
	}
...
JSBool CChar_Heal( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 && argc != 2 )
	{
		ScriptError( "(CChar_Heal) Invalid Number of Arguments %d, needs: 1 (amount) or 2 (amount and healer)", cx, argc );
		return JS_TRUE;
	}
	...
	if( !ValidateObject( mChar ))
	{
		ScriptError( "(CChar_Heal): Operating on an invalid Character", cx );
		return JS_TRUE;
	}
	...
	if( argc == 2 )
	{
		...
		{
			ScriptError( "CChar_Heal: Passed an invalid Character", cx );
			return JS_FALSE;
		}
...
JSBool CBase_Resist( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 && argc != 2 )
	{
		ScriptError( "Resist: Invalid number of arguments (takes 1, the resist type or 2, the resist type and value to set)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( mItem ))
		{
			ScriptError( "Resist: Passed an invalid Item", cx );
			return JS_FALSE;
		}
	}
	else if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "Resist: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
...
JSBool CChar_Defense( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 3)
	{
		ScriptError( "Defense: Invalid number of arguments (takes 3, the hit location, the resist type and if the armor should get damaged)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "Defense: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
...
JSBool CItem_GetMoreVar( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 2 )
	{
		ScriptError( "GetMoreVar: Invalid number of arguments (takes 2, the moreVarName (more, morex, morey or morez - and the moreVarPart (1 to 4))", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( mItem ))
		{
			ScriptError( "GetMoreVar: Passed an invalid Item", cx );
			return JS_FALSE;
		}
	}
	else
	...
	{
		ScriptError( "GetMoreVar: Passed an invalid argument: tempVarName", cx );
		return JS_FALSE;
	}
...
JSBool CItem_SetMoreVar( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 3 )
	{
		ScriptError( "SetMoreVar: Invalid number of arguments (takes 3, the moreVarName (more, morex, morey or morez); the moreVarPart (1 to 4) and the moreVarValue (0-255)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXItem" )
	{
		...
		if( !ValidateObject( mItem ))
		{
			ScriptError( "SetMoreVar: Passed an invalid Item", cx );
			return JS_FALSE;
		}
	}
	else
	...
	{
		ScriptError( "SetMoreVar: Passed an invalid argument: moreVarName", cx );
		return JS_FALSE;
	}
...
JSBool CBase_AddScriptTrigger( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddScriptTrigger: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Invalid Object assigned (AddScriptTrigger)", cx );
		return JS_FALSE;
	}

	if( !JSVAL_IS_INT( argv[0] ))
	{
		ScriptError( "That is not a valid script trigger! Only integers between 0-65535 are accepted.", cx );
	}
...
JSBool CBase_RemoveScriptTrigger( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, [[maybe_unused]] jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "RemoveScriptTrigger: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Invalid Object assigned (RemoveScriptTrigger)", cx );
		return JS_FALSE;
	}
...
JSBool CBase_HasScriptTrigger( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "HasScriptTrigger: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( !ValidateObject( myObj ))
	{
		ScriptError( "Invalid Object assigned (HasScriptTrigger)", cx );
		return JS_FALSE;
	}
...
JSBool CChar_AddFriend( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "AddFriend: Invalid number of arguments (takes 1 - playerObject)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "AddFriend: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
	...
	{
		ScriptError( "(AddFriend) Invalid Object passed as function parameter", cx );
		return JS_FALSE;
	}
...
JSBool CChar_RemoveFriend( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "RemoveFriend: Invalid number of arguments (takes 1 - playerObject)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "RemoveFriend: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
...
JSBool CChar_GetFriendList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "GetFriendList: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "GetFriendList: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
...
JSBool CChar_ClearFriendList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "ClearFriendList: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "ClearFriendList: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
...
JSBool CChar_GetPetList( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "GetPetList: Invalid number of arguments (takes 0)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "GetPetList: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
...
JSBool CChar_HasBeenOwner( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "HasBeenOwner: Invalid number of arguments (takes 1)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "HasBeenOwner: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
	...
	{
		ScriptError( "HasBeenOwner: Invalid Character passed as parameter", cx );
		return JS_FALSE;
	}
...
JSBool CChar_CalculateControlChance( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "CalculateControlChance: Invalid number of arguments (takes 1 - pChar)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXChar" )
	{
		...
		if( !ValidateObject( mChar ))
		{
			ScriptError( "CalculateControlChance: Passed an invalid Character", cx );
			return JS_FALSE;
		}
	}
	else
	...
	if( !ValidateObject( pChar ))
	{
		ScriptError( "CalculateControlChance: Invalid Character passed as parameter", cx );
		return JS_FALSE;
	}
...
JSBool CParty_Remove( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "Remove: Invalid number of arguments (1)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXParty" )
	{
		...
		if( ourParty == nullptr )
		{
			ScriptError( "Remove: Invalid party", cx );
			return JS_FALSE;
		}
		...
		{
			ScriptError( "Remove: Invalid character to remove", cx );
			return JS_FALSE;
		}
...
JSBool CParty_Add( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc != 1 )
	{
		ScriptError( "Add: Invalid number of arguments (1)", cx );
		return JS_FALSE;
	}
	...
	*rval = BOOLEAN_TO_JSVAL( false );
	...
	if( myClass.ClassName() == "UOXParty" )
	{
		...
		if( ourParty == nullptr )
		{
			ScriptError( "Add: Invalid party", cx );
			return JS_FALSE;
		}
		...
		{
			ScriptError( "Add: Invalid character to add", cx );
			return JS_FALSE;
		}
		if( charToAdd->IsNpc() )
		{
			...
			{
				*rval = BOOLEAN_TO_JSVAL( false );
				ScriptError( "Add: Adding NPC to a PC party attempted", cx );
			}
		}
		else
		{
			...
			{
				*rval = BOOLEAN_TO_JSVAL( false );
				ScriptError( "Add: Adding PC to a NPC party attempted", cx );
			}
			else
			{	// Send PC the invite
				...
				if( targSock != nullptr )
				{
					...
					{
						*rval = BOOLEAN_TO_JSVAL( false );
						ScriptError( "Add: PC selected is not online", cx );
					}
				}
				else
				{
...
JSBool CParty_GetMember( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
	if( argc > 1 )
	{
		ScriptError( "GetMember: Invalid number of arguments (1)", cx );
		return JS_FALSE;
	}
	...
	if( myClass.ClassName() == "UOXParty" )
	{
		...
		if( ourParty == nullptr )
		{
			ScriptError( "GetMember: Invalid party", cx );
			return JS_FALSE;
		}
		...
		{
			ScriptError( "GetMember: Invalid character to get, index out of bounds", cx );
			*rval = JSVAL_NULL;
			return JS_TRUE;
		}
...
JSBool CSocket_FirstTriggerWord( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "FirstTriggerWord: Invalid count of arguments :%d, needs :0", cx, argc );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	if( mySock == nullptr )
	{
		ScriptError( "FirstTriggerWord: Invalid socket assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_NextTriggerWord( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "NextTriggerWord: Invalid count of arguments :%d, needs :0", cx, argc );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	if( mySock == nullptr )
	{
		ScriptError( "NextTriggerWord: Invalid socket assigned.", cx );
		return JS_FALSE;
	}
...
JSBool CSocket_FinishedTriggerWords( JSContext *cx, JSObject *obj, uintN argc, [[maybe_unused]] jsval *argv, jsval *rval )
{
	if( argc != 0 )
	{
		ScriptError( "FinishedTriggerWords: Invalid count of arguments :%d, needs :0", cx, argc );
		return JS_FALSE;
	}
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, obj ));
	if( mySock == nullptr )
	{
		ScriptError( "FinishedTriggerWords: Invalid socket assigned.", cx );
		return JS_FALSE;
	}
