	...
	switch( argc )
	{
		...
		case 1:
			...
			{	// we can work with this, it should be either a character or item, hopefully
				JSEncapsulate jsToGoTo( cx, &( args.get(0) ));
...
bool CBase_SetTag( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( argc == 2 )
	{
		JSEncapsulate encaps( cx, &( args.get(1) ));
...
bool CChar_OpenBank( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	{
		mySock = static_cast<CSocket*>( JS_GetPrivate( cx, &args.get(0).toObject()));
		if( mySock != nullptr )
		{
			mySock->OpenBank( myChar );
		}
...
bool CSocket_OpenContainer( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *contToOpen = static_cast<CItem*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_OpenLayer( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CSocket *mySock = static_cast<CSocket*>( JS_GetPrivate( cx, &args.get(0).toObject()));
	if( mySock != nullptr )
	{
...
bool CChar_TurnToward( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( argc == 1 )
	{
		...
		CBaseObject *myObj = static_cast<CBaseObject*>( JS_GetPrivate( cx, &args.get(0).toObject()));
		if( !ValidateObject( myObj ))
		{
			ScriptError( cx, "(TurnToward) Invalid Object passed" );
			return false;
...
bool CGuild_AcceptRecruit( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	{
		CChar *myChar = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(0).toObject()));
		myGuild->RecruitToMember( *myChar );
	}
	else
	{
...
bool CGuild_AddMember( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( myClass.ClassName() == "UOXGuild" )
	{
		...
		JSEncapsulate toAdd( cx, &( args.get(0) ));
...
bool CBase_InRange( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CBaseObject *them = static_cast<CBaseObject*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_SetPoisoned( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( poisonLevel > 0 && argc > 1 )
	{
		...
		if( argc >= 3 )
		{
			CChar *poisonSourceChar = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(2).toObject()));
...
bool CMulti_IsInMulti( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CBaseObject *toFind = static_cast<CBaseObject *>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_IsOnBanList( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *toFind = static_cast<CChar *>( JS_GetPrivate( cx, &args.get(0).toObject()));
	if( !ValidateObject( toFind ))
	{
...
bool CRace_CanWearArmour( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *toFind = static_cast<CItem *>( JS_GetPrivate( cx, &args.get(0).toObject()));
	if( !ValidateObject( toFind ))
	{
...
bool CConsole_Print( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate arg0( cx, &( args.get(0) ));
...
bool CConsole_MoveTo( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate arg0( cx, &( args.get(0) ));
	JSEncapsulate arg1( cx, &( args.get(1) ));
...
bool CChar_SpellMoveEffect( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CSpellInfo *mySpell = static_cast<CSpellInfo *>( JS_GetPrivate( cx, &args.get(1).toObject()));
	if( mySpell == nullptr )
	{
	...
	CBaseObject *target = static_cast<CBaseObject *>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_SpellStaticEffect( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CSpellInfo *mySpell = static_cast<CSpellInfo *>( JS_GetPrivate( cx, &args.get(0).toObject()));
	if( mySpell == nullptr )
	{
...
bool CChar_BreakConcentration( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( argc == 1 )
	{
		mSock = static_cast<CSocket *>( JS_GetPrivate( cx, &args.get(0).toObject()));
		if( mSock == nullptr )
		{
...
bool CItem_Carve( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CSocket *mSock = static_cast<CSocket *>( JS_GetPrivate( cx, &args.get(0).toObject()));
	if( mSock == nullptr )
	{
...
bool CMulti_SecureContainer( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *itemToSecure = static_cast<CItem*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_UnsecureContainer( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *itemToUnsecure = static_cast<CItem*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_IsSecureContainer( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *itemToCheck = static_cast<CItem*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_LockDownItem( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *itemToLockDown = static_cast<CItem*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_ReleaseItem( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CItem *itemToRemove = static_cast<CItem*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_AddVendor( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *vendorToAdd = static_cast<CChar *>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CMulti_RemoveVendor( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *vendorToRemove = static_cast<CChar *>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CSocket_DisplayDamage( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate damage( cx, &( args.get(1) ));
...
bool CChar_ReactOnDamage( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate damage( cx, &( args.get(0) ));
...
bool CChar_Damage( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( argc >= 3 )
	{
		JSEncapsulate attackerClass( cx, &( args.get(2) ));
		if( attackerClass.ClassName() != "UOXChar" )	// It must be a character!
		{
...
bool CChar_InitiateCombat( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *ourTarget = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_Heal( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( argc == 2 )
	{
		JSEncapsulate healerClass( cx, &( args.get(1) ));
...
bool CBase_Resist( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate resistType( cx, &( args.get(0) ));
	...
	{
		JS_SET_RVAL( cx, vp, true );
		JSEncapsulate value( cx, &( args.get(1) ));
		if( ValidateObject( mChar ))
		{
...
bool CChar_Defense( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate hitLoc( cx, &( args.get(0) ));
	JSEncapsulate resistType( cx, &( args.get(1) ));
	JSEncapsulate doArmorDamage( cx, &( args.get(2) ));
...
bool CChar_AddFriend( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *newFriend = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_RemoveFriend( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *friendToRemove = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_HasBeenOwner( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	JSEncapsulate toCheck( cx, &( args.get(0) ));
...
bool CChar_AddFollower( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *newFollower = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CChar_RemoveFollower( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	CChar *followerToRemove = static_cast<CChar*>( JS_GetPrivate( cx, &args.get(0).toObject()));
...
bool CParty_Remove( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( myClass.ClassName() == "UOXParty" )
	{
		...
		JSEncapsulate toRemove( cx, &( args.get(0) ));
...
bool CParty_GetMember( JSContext *cx, unsigned argc, JS::Value* vp )
{
	...
	if( myClass.ClassName() == "UOXParty" )
	{
		...
		JSEncapsulate toGetMember( cx, &( args.get(0) ));
