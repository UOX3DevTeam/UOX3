...
public:
	...
	static auto dump(std::ostream &output,const std::uint8_t *buffer, std::size_t length,radix_t radix=radix_t::hex,int entries_line = 8)->void;
...
public:
	...
	auto log(std::ostream &output,radix_t radix=radix_t::hex,int entries_line = 8)const ->void;
