...
{ 
	...
	if( loot == 1 || loot == 2 ) 
	{
		srcSock.SysMessage( "You don't manage to pick coconuts." );
		return;
	}
	if( loot == 3 ) 
	{
		srcSock.SysMessage( "You pick a coconut." );
		var itemMade = SpawnItem( srcSock, pUser, "0x1726", false );	// makes an item and puts in Char's pack
