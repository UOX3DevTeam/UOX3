...
{ 
	...
	if( loot == 1 || loot == 2 ) 
	{
		srcSock.SysMessage( "You don't manage to pick grapes." );
		return;
	}
	if( loot == 3 ) 
	{
		srcSock.SysMessage( "You pick a bunch of grapes." );
		var itemMade = SpawnItem( srcSock, pUser, "0x09D1", false );	// makes an item and puts in Char's pack
