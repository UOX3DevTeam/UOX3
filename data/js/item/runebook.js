...
function RuneBookGump( pSocket, runeBook )
{
	...
	// Display front page
	runeBookGump.AddHTMLGump( 40, 30, 120, 25, true, true, "<BASEFONT size=4>" + GetDictionaryEntry( 9252, pSocket.language ) + " " + runeBookCharges +  "</BASEFONT>" ); // Charges:
	runeBookGump.AddHTMLGump( 200, 30, 130, 25, true, true, "<BASEFONT size=4>" + GetDictionaryEntry( 9253, pSocket.language ) + " " + maxCharges + "</BASEFONT>" ); // Max Charges:
	...
	runeBookGump.AddHTMLGump( 55, 10, 100, 25, true, true, "<BASEFONT size=4>" + GetDictionaryEntry( 9254, pSocket.language ) + "</BASEFONT>" ); // Rename Book
	...
	for( var i = 1; i <= 16; i++ )
	{
		...
		if( i <= 8 )
		{
			...
			{
				runeBookGump.AddHTMLGump( leftTxtOffsetX, leftTxtOffsetY + ( 15 * ( i - 1 )), 120, 20, true, true, "<BASEFONT size=5>" + GetDictionaryEntry( 9255, pSocket.language ) + "</BASEFONT>" ); // Empty
			}
			else
			{
				runeBookGump.AddHTMLGump( leftTxtOffsetX, leftTxtOffsetY + ( 15 * ( i - 1)), 120, 20, true, true, "<BASEFONT color=#0xfd size=10>" + splitData[0] + "</BASEFONT>" );
		...
		else
		{
			...
			if( runeData == 0 || splitData == 0 )
			{
				runeBookGump.AddHTMLGump( rightTxtOffsetX, rightTxtOffsetY + ( 15 * ( i - 9 )), 120, 20, true, true, "<BASEFONT size=5>" + GetDictionaryEntry( 9255, pSocket.language ) + "</BASEFONT>" ); // Empty
			}
			else
			{
				runeBookGump.AddHTMLGump( rightTxtOffsetX, rightTxtOffsetY + ( 15 * ( i - 9 )), 120, 20, true, true, "<BASEFONT color=0xfd size=5>" + splitData[0] + "</BASEFONT>" );
				runeBookGump.AddToolTip( tooltipClilocID, pSocket, splitData[0] );
			}
	...
	for( i = 0; i <= 7; i++ )
	{
		...
		{
			case 0:
				runeBookGump.AddHTMLGump( 38, 178, 40, 20, true, true, "<BASEFONT size=5>1</BASEFONT>" );
				break;
			case 1:
				runeBookGump.AddHTMLGump( 70, 178, 40, 20, true, true, "<BASEFONT size=5>2</BASEFONT>" );
				break;
			case 2:
				runeBookGump.AddHTMLGump( 105, 178, 40, 20, true, true, "<BASEFONT size=5>3</BASEFONT>" );
				break;
			case 3:
				runeBookGump.AddHTMLGump( 139, 178, 40, 20, true, true, "<BASEFONT size=5>4</BASEFONT>" );
				break;
			case 4:
				runeBookGump.AddHTMLGump( 207, 178, 40, 20, true, true, "<BASEFONT size=5>5</BASEFONT>" );
				break;
			case 5:
				runeBookGump.AddHTMLGump( 241, 178, 40, 20, true, true, "<BASEFONT size=5>6</BASEFONT>" );
				break;
			case 6:
				runeBookGump.AddHTMLGump( 275, 178, 40, 20, true, true, "<BASEFONT size=5>7</BASEFONT>" );
				break;
			case 7:
				runeBookGump.AddHTMLGump( 310, 178, 40, 20, true, true, "<BASEFONT size=5>8</BASEFONT>" );
				break;
		}
		...
		runeBookGump.AddButton( 60, 10, setDefaultBtn, 1, 0, ( i * 2 ) + 1 ); // ButtonIDs 1, 3, 5, 7, 9, 11, 13, 15
	  	runeBookGump.AddHTMLGump( 74, 6, 120, 40, true, true, "<BASEFONT size=2>" + GetDictionaryEntry( 9256, pSocket.language ) + "</BASEFONT>" ); // Set Default
		...
		if( splitData == 0 )
		{
	  		runeBookGump.AddHTMLGump( 41, 52, 120, 25, true, true, "<BASEFONT size=5>" + GetDictionaryEntry( 9255, pSocket.language ) + "</BASEFONT>" ); // Empty
		}
	  	else
	  	{
		  	...
		  	runeBookGump.AddHTMLGump( 41, 52, 130, 40, true, true, "<BASEFONT color=#0xfd size=5>" + splitData[0] + "</BASEFONT>" );
		  	runeBookGump.AddToolTip( tooltipClilocID, pSocket, splitData[0] );

		  	runeBookGump.AddHTMLGump( 35, 90, 125, 25, true, true, "<CENTER><BASEFONT size=3>" + yLatDeg + "o " + yLatMin + "'" + ( ySouth ? "N" : "S" ) + " " + xLongDeg + "o " + xLongMin + "'" + ( xEast ? "W" : "E" ) + "</BASEFONT></CENTER>" );
		  	if( showCoords )
		  	{
		...
		runeBookGump.AddHTMLGump( 45, 110, 100, 25, true, true, "<BASEFONT size=5>" + GetDictionaryEntry( 9257, pSocket.language ) + "</BASEFONT>" ); // Drop Rune
		...
		runeBookGump.AddButton( 190, 10, setDefaultBtn, 1, 0, ( i * 2 ) + 2 ); // ButtonIDs 2, 4, 6, 8, 10, 12, 14, 16
	  	runeBookGump.AddHTMLGump( 204, 6, 120, 40, true, true, "<BASEFONT size=2>" + GetDictionaryEntry( 9256, pSocket.language ) + "</BASEFONT>" ); // Set Default
		...
		if( splitData == 0 )
		{
		  	runeBookGump.AddHTMLGump( 203, 52, 120, 25, true, true, "<BASEFONT size=5>" + GetDictionaryEntry( 9255, pSocket.language ) + "</BASEFONT>" ); // Empty
		}
		else
		{
		  	let mapCoords = TriggerEvent( 2503, "GetMapCoordinates", parseInt( splitData[2] ), parseInt( splitData[3] ), parseInt( splitData[5] ))
		  	...
		  	runeBookGump.AddHTMLGump( 203, 52, 120, 50, true, true, "<BASEFONT color=#0xfd size=5>" + splitData[0] + "</BASEFONT>" );
		  	runeBookGump.AddToolTip( tooltipClilocID, pSocket, splitData[0] );

		  	runeBookGump.AddHTMLGump( 195, 90, 125, 25, true, true, "<CENTER><BASEFONT size=3>" + yLatDeg + "o " + yLatMin + "'" + ( ySouth ? "S" : "N" ) + " " + xLongDeg + "o " + xLongMin + "'" + ( xEast ? "E" : "W" ) + "</BASEFONT></CENTER>" );
		  	if( showCoords )
		  	{
		  		runeBookGump.AddToolTip( tooltipClilocID, pSocket, splitData[2] + ", " + splitData[3].toString() );
		  	}
		...
		runeBookGump.AddButton( 193, 110, 0x985, 1, 0, ( 102 + ( i * 2 ))); // ButtonIDs 102, 104, 106, 108, 110, 112, 114, 116
	  	runeBookGump.AddHTMLGump( 203, 110, 100, 25, true, true, "<BASEFONT size=5>" + GetDictionaryEntry( 9257, pSocket.language ) + "</BASEFONT>" ); // Drop Rune
