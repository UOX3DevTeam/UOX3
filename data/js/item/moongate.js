...
function onGumpPress( srcSock, myButton )
{
	...
	switch( myButton )
	{
		...
		{
			// Britain
			targetLocation = [ 1336, 1997, 5, tWorld, srcChar.instanceID ];
			break;
		}
		case 6:
		case 14:
		{
			// Magincia
			targetLocation = [ 3563, 2139, 31, tWorld, srcChar.instanceID ];
			break;
		}
		case 7:
		case 15:
		{
			// Moonglow
			targetLocation = [ 4467, 1283, 5, tWorld, srcChar.instanceID ];
			break;
		}
		case 8:
		case 16:
		{
			// Skara Brae
			targetLocation = [ 643, 2067, 5, tWorld, srcChar.instanceID ];
			break;
		}
		...
		{
			// Trinsic
			targetLocation = [ 1828, 2948, -20, tWorld, srcChar.instanceID ];
			break;
		}
		case 10:
		case 18:
		{
			// Vesper
			targetLocation = [ 2701, 692, 5, tWorld, srcChar.instanceID ];
			break;
		}
		case 11:
		case 19:
		{
			// Yew
			targetLocation = [ 771, 752, 5, tWorld, srcChar.instanceID ];
			break;
		}
		case 12:
		case 20:
		{
			// Jhelom
			targetLocation = [ 1499, 3771, 5, tWorld, srcChar.instanceID ];
			break;
		}
		...
		{
			// Compassion
			targetLocation = [ 1215, 467, -13, 2, srcChar.instanceID ];
			break;
		}
		case 22:
		{
			// Honesty
			targetLocation = [ 722, 1366, -60, 2, srcChar.instanceID ];
			break;
		}
		case 23:
		{
			// Honor
			targetLocation = [ 744, 724, -28, 2, srcChar.instanceID ];
			break;
		}
		case 24:
		{
			// Humility
			targetLocation = [ 281, 1016, 0, 2, srcChar.instanceID ];
			break;
		}
		case 25:
		{
			// Justice
			targetLocation = [ 987, 1011, -32, 2, srcChar.instanceID ];
			break;
		}
		case 26:
		{
			// Sacrifice
			targetLocation = [ 1174, 1286, -30, 2, srcChar.instanceID ];
			break;
		}
		case 27:
		{
			// Sprirituality
			targetLocation = [ 1532, 1340, -3, 2, srcChar.instanceID ];
			break;
		}
		case 28:
		{
			// Valor
			targetLocation = [ 528, 216, -45, 2, srcChar.instanceID ];
			break;
		}
		case 29:
		{
			// Chaos
			targetLocation = [ 1721, 218, 96, 2, srcChar.instanceID ];
			break;
		}
		//Malas
		case 30:
		{
			// New Luna
			targetLocation = [ 1015, 527, -65, 3, srcChar.instanceID ];
			break;
		}
		case 31:
		{
			//Old Luna
			targetLocation = [ 1054, 358, -86, 3, srcChar.instanceID ];
			break;
		}
		case 32:
		{
			// Umbra
			targetLocation = [ 1997, 1386, -85, 3, srcChar.instanceID ];
			break;
		}
		//Tokuno Islands
		case 33:
		{
			// Isamu~Jima
			targetLocation = [ 1169, 998, 42, 4, srcChar.instanceID ];
			break;
		}
		case 34:
		{
			// Makoto~Jima
			targetLocation = [ 801, 1204, 25, 4, srcChar.instanceID ];
			break;
		}
		case 35:
		{
			// Homare~Jima
			targetLocation = [ 270, 628, 15, 4, srcChar.instanceID ];
			break;
		}
		default:
			return;
