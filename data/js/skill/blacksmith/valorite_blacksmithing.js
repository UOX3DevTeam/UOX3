...
function ValoriteSmithGump( socket, pUser )
{
    if ( socket == null )
        return;
    ...
    bsGump.AddHTMLGump( 178, 4, 160, 25, 0, 0, GetDictionaryEntry( 2273, socket.language ) );       // Valorite Blacksmithy Selection Menu
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + "16 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 19.4 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 14 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 16.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 18 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 21.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 20 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 39.1 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 12 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 58.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 25 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 75.0 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 15 Valorite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 8.3 <\center>" )
	...
	switch ( pButton )
	{
		...
		case 1:
            if ( anvil > 0 )
            {
				...
				{
					case 2:
                        MakeItem( pSock, pUser, 1106 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Ringmail Gloves
					case 3:
                        MakeItem( pSock, pUser, 1108 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Ringmail Legs
					case 4:
                        MakeItem( pSock, pUser, 1107 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Ringmail Arms
					case 5:
                        MakeItem( pSock, pUser, 1109 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Ringmail Chest
					case 6:
                        MakeItem( pSock, pUser, 1110 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Chain Coif
					case 7:
                        MakeItem( pSock, pUser, 1111 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Chain Legs
					case 8:
                        MakeItem( pSock, pUser, 1112 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Chain Chest
					case 9:
                        MakeItem( pSock, pUser, 1115 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Plate Arms
					case 10:
                        MakeItem( pSock, pUser, 1114 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Plate Gloves
					case 11:
                        MakeItem( pSock, pUser, 1113 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Plate Gorget
					case 12:
                        MakeItem( pSock, pUser, 1116 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Plate Legs
					case 13:
                        MakeItem( pSock, pUser, 1117 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Plate Chest
					case 14:
                        MakeItem( pSock, pUser, 1118 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Female Plate Chest
					case 15:
                        MakeItem( pSock, pUser, 1120 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Bascinet
					case 16:
                        MakeItem( pSock, pUser, 1122 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Close Helm
					case 17:
                        MakeItem( pSock, pUser, 1119 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Helmet
					case 18:
                        MakeItem( pSock, pUser, 1121 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Norse Helm
					case 19:
                        MakeItem( pSock, pUser, 1123 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Plate Helm
					case 20:
                        MakeItem( pSock, pUser, 1100 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Buckler
					case 21:
                        MakeItem( pSock, pUser, 1101 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Bronze Shield
					case 22:
                        MakeItem( pSock, pUser, 1105 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Heater Shield
					case 23:
                        MakeItem( pSock, pUser, 1102 );
                        ValoriteSmithGump( pSock, pUser );
              			break;//Metal Shield
					case 24:
                        MakeItem( pSock, pUser, 1104 );
                        ValoriteSmithGump( pSock, pUser );
