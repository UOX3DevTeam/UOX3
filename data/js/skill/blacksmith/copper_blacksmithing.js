...
function CopperSmithGump( socket, pUser )
{
    if ( socket == null )
        return;
    ...
    bsGump.AddHTMLGump( 178, 4, 160, 25, 0, 0, GetDictionaryEntry( 2268, socket.language ) );       // Copper Blacksmithy Selection Menu
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + "16 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 19.4 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 14 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 16.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 18 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 21.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 20 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 39.1 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 12 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 58.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 25 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 75.0 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 15 Copper Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 8.3 <\center>" )
	...
	switch ( pButton )
	{
		...
		case 1:
            if ( anvil > 0 )
            {
				...
				{
					case 2:
						MakeItem( pSock, pUser, 706 );
						CopperSmithGump( pSock, pUser );
						break;//Ringmail Gloves
					case 3:
						MakeItem( pSock, pUser, 708 );
						CopperSmithGump( pSock, pUser );
						break;//Ringmail Legs
					case 4:
						MakeItem( pSock, pUser, 707 );
						CopperSmithGump( pSock, pUser );
						break;//Ringmail Arms
					case 5:
						MakeItem( pSock, pUser, 709 );
						CopperSmithGump( pSock, pUser );
						break;//Ringmail Chest
					case 6:
						MakeItem( pSock, pUser, 710 );
						CopperSmithGump( pSock, pUser );
						break;//Chain Coif
					case 7:
						MakeItem( pSock, pUser, 711 );
						CopperSmithGump( pSock, pUser );
						break;//Chain Legs
					case 8:
						MakeItem( pSock, pUser, 712 );
						CopperSmithGump( pSock, pUser );
						break;//Chain Chest
					case 9:
						MakeItem( pSock, pUser, 715 );
						CopperSmithGump( pSock, pUser );
						break;//Plate Arms
					case 10:
						MakeItem( pSock, pUser, 714 );
						CopperSmithGump( pSock, pUser );
						break;//Plate Gloves
					case 11:
						MakeItem( pSock, pUser, 713 );
						CopperSmithGump( pSock, pUser );
						break;//Plate Gorget
					case 12:
						MakeItem( pSock, pUser, 716 );
						CopperSmithGump( pSock, pUser );
						break;//Plate Legs
					case 13:
						MakeItem( pSock, pUser, 717 );
						CopperSmithGump( pSock, pUser );
						break;//Plate Chest
					case 14:
						MakeItem( pSock, pUser, 718 );
						CopperSmithGump( pSock, pUser );
						break;//Female Plate Chest
					case 15:
						MakeItem( pSock, pUser, 720 );
						CopperSmithGump( pSock, pUser );
						break;//Bascinet
					case 16:
						MakeItem( pSock, pUser, 722 );
						CopperSmithGump( pSock, pUser );
						break;//Close Helm
					case 17:
						MakeItem( pSock, pUser, 719 );
						CopperSmithGump( pSock, pUser );
						break;//Helmet
					case 18:
						MakeItem( pSock, pUser, 721 );
						CopperSmithGump( pSock, pUser );
						break;//Norse Helm
					case 19:
						MakeItem( pSock, pUser, 723 );
						CopperSmithGump( pSock, pUser );
						break;//Plate Helm
					case 20:
						MakeItem( pSock, pUser, 700 );
						CopperSmithGump( pSock, pUser );
						break;//Buckler
					case 21:
						MakeItem( pSock, pUser, 701 );
						CopperSmithGump( pSock, pUser );
						break;//Bronze Shield
					case 22:
						MakeItem( pSock, pUser, 705 );
						CopperSmithGump( pSock, pUser );
						break;//Heater Shield
					case 23:
						MakeItem( pSock, pUser, 702 );
						CopperSmithGump( pSock, pUser );
						break;//Metal Shield
					case 24:
						MakeItem( pSock, pUser, 704 );
						CopperSmithGump( pSock, pUser );
