...
function AgapiteSmithGump( socket, pUser )
{
    if ( socket == null )
        return;
    ...
    bsGump.AddHTMLGump( 178, 4, 160, 25, 0, 0, GetDictionaryEntry( 2269, socket.language ) );       // Agapite Blacksmithy Selection Menu
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + "16 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 19.4 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 14 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 16.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 18 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 21.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 20 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 39.1 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 12 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 58.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 25 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 75.0 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 15 Agapite Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 8.3 <\center>" )
	...
	switch ( pButton )
	{
		...
		case 1:
			if ( anvil > 0 )
			{
				...
				{
					case 2:
						MakeItem( pSock, pUser, 1206 );
						AgapiteSmithGump( pSock, pUser );
						break;//Ringmail Gloves
					case 3:
						MakeItem( pSock, pUser, 1208 );
						AgapiteSmithGump( pSock, pUser );
						break;//Ringmail Legs
					case 4:
						MakeItem( pSock, pUser, 1207 );
						AgapiteSmithGump( pSock, pUser );
						break;//Ringmail Arms
					case 5:
						MakeItem( pSock, pUser, 1209 );
						AgapiteSmithGump( pSock, pUser );
						break;//Ringmail Chest
					case 6:
						MakeItem( pSock, pUser, 1210 );
						AgapiteSmithGump( pSock, pUser );
						break;//Chain Coif
					case 7:
						MakeItem( pSock, pUser, 1211 );
						AgapiteSmithGump( pSock, pUser );
						break;//Chain Legs
					case 8:
						MakeItem( pSock, pUser, 1212 );
						AgapiteSmithGump( pSock, pUser );
						break;//Chain Chest
					case 9:
						MakeItem( pSock, pUser, 1215 );
						AgapiteSmithGump( pSock, pUser );
						break;//Plate Arms
					case 10:
						MakeItem( pSock, pUser, 1214 );
						AgapiteSmithGump( pSock, pUser );
						break;//Plate Gloves
					case 11:
						MakeItem( pSock, pUser, 1213 );
						AgapiteSmithGump( pSock, pUser );
						break;//Plate Gorget
					case 12:
						MakeItem( pSock, pUser, 1216 );
						AgapiteSmithGump( pSock, pUser );
						break;//Plate Legs
					case 13:
						MakeItem( pSock, pUser, 1217 );
						AgapiteSmithGump( pSock, pUser );
						break;//Plate Chest
					case 14:
						MakeItem( pSock, pUser, 1218 );
						AgapiteSmithGump( pSock, pUser );
						break;//Female Plate Chest
					case 15:
						MakeItem( pSock, pUser, 1220 );
						AgapiteSmithGump( pSock, pUser );
						break;//Bascinet
					case 16:
						MakeItem( pSock, pUser, 1222 );
						AgapiteSmithGump( pSock, pUser );
						break;//Close Helm
					case 17:
						MakeItem( pSock, pUser, 1219 );
						AgapiteSmithGump( pSock, pUser );
						break;//Helmet
					case 18:
						MakeItem( pSock, pUser, 1221 );
						AgapiteSmithGump( pSock, pUser );
						break;//Norse Helm
					case 19:
						MakeItem( pSock, pUser, 1223 );
						AgapiteSmithGump( pSock, pUser );
						break;//Plate Helm
					case 20:
						MakeItem( pSock, pUser, 1200 );
						AgapiteSmithGump( pSock, pUser );
						break;//Buckler
					case 21:
						MakeItem( pSock, pUser, 1201 );
						AgapiteSmithGump( pSock, pUser );
						break;//Bronze Shield
					case 22:
						MakeItem( pSock, pUser, 1205 );
						AgapiteSmithGump( pSock, pUser );
						break;//Heater Shield
					case 23:
						MakeItem( pSock, pUser, 1202 );
						AgapiteSmithGump( pSock, pUser );
						break;//Metal Shield
					case 24:
						MakeItem( pSock, pUser, 1204 );
						AgapiteSmithGump( pSock, pUser );
