...
function BronzeSmithGump( socket, pUser )
{
    if ( socket == null )
        return;
    ...
    bsGump.AddHTMLGump( 178, 4, 160, 25, 0, 0, GetDictionaryEntry( 2266, socket.language ) );       // Bronze Blacksmithy Selection Menu
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + "16 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 19.4 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 14 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 16.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 18 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 21.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 20 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 39.1 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 12 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 58.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 25 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 75.0 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 15 Bronze Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 8.3 <\center>" )
