...
function GoldSmithGump( socket, pUser )
{
    if ( socket == null )
        return;
    ...
    bsGump.AddHTMLGump( 178, 4, 160, 25, 0, 0, GetDictionaryEntry( 2271, socket.language ) );       // Gold Blacksmithy Selection Menu
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + "16 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 19.4 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 14 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 16.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 18 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 21.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 20 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 39.1 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 12 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 58.9 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 25 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 75.0 <\center>" )
    ...
    bsGump.AddToolTip( 1114778, socket, "<center> <basefont color=#FFFF00>" + GetDictionaryEntry( 2214, socket.language ) + "</basefont> \n" + GetDictionaryEntry( 2215, socket.language ) + " 15 Gold Ingots \n" + GetDictionaryEntry( 2216, socket.language ) + " 8.3 <\center>" )
	...
	switch ( pButton )
	{
		...
		case 1:
            if ( anvil > 0 )
            {
				...
				{
					case 2:
                        MakeItem( pSock, pUser, 906 );
                        GoldSmithGump( pSock, pUser );
              			break;//Ringmail Gloves
					case 3:
                        MakeItem( pSock, pUser, 908 );
                        GoldSmithGump( pSock, pUser );
              			break;//Ringmail Legs
					case 4:
                        MakeItem( pSock, pUser, 907 );
                        GoldSmithGump( pSock, pUser );
              			break;//Ringmail Arms
					case 5:
                        MakeItem( pSock, pUser, 909 );
                        GoldSmithGump( pSock, pUser );
              			break;//Ringmail Chest
					case 6:
                        MakeItem( pSock, pUser, 910 );
                        GoldSmithGump( pSock, pUser );
              			break;//Chain Coif
					case 7:
                        MakeItem( pSock, pUser, 911 );
                        GoldSmithGump( pSock, pUser );
              			break;//Chain Legs
					case 8:
                        MakeItem( pSock, pUser, 912 );
                        GoldSmithGump( pSock, pUser );
              			break;//Chain Chest
					case 9:
                        MakeItem( pSock, pUser, 915 );
                        GoldSmithGump( pSock, pUser );
              			break;//Plate Arms
					case 10:
                        MakeItem( pSock, pUser, 914 );
                        GoldSmithGump( pSock, pUser );
              			break;//Plate Gloves
					case 11:
                        MakeItem( pSock, pUser, 913 );
                        GoldSmithGump( pSock, pUser );
              			break;//Plate Gorget
					case 12:
                        MakeItem( pSock, pUser, 916 );
                        GoldSmithGump( pSock, pUser );
              			break;//Plate Legs
					case 13:
                        MakeItem( pSock, pUser, 917 );
                        GoldSmithGump( pSock, pUser );
              			break;//Plate Chest
					case 14:
                        MakeItem( pSock, pUser, 918 );
                        GoldSmithGump( pSock, pUser );
              			break;//Female Plate Chest
					case 15:
                        MakeItem( pSock, pUser, 920 );
                        GoldSmithGump( pSock, pUser );
              			break;//Bascinet
					case 16:
                        MakeItem( pSock, pUser, 922 );
                        GoldSmithGump( pSock, pUser );
              			break;//Close Helm
					case 17:
                        MakeItem( pSock, pUser, 919 );
                        GoldSmithGump( pSock, pUser );
              			break;//Helmet
					case 18:
                        MakeItem( pSock, pUser, 921 );
                        GoldSmithGump( pSock, pUser );
              			break;//Norse Helm
					case 19:
                        MakeItem( pSock, pUser, 923 );
                        GoldSmithGump( pSock, pUser );
              			break;//Plate Helm
					case 20:
                        MakeItem( pSock, pUser, 900 );
                        GoldSmithGump( pSock, pUser );
              			break;//Buckler
					case 21:
                        MakeItem( pSock, pUser, 901 );
                        GoldSmithGump( pSock, pUser );
              			break;//Bronze Shield
					case 22:
                        MakeItem( pSock, pUser, 905 );
                        GoldSmithGump( pSock, pUser );
              			break;//Heater Shield
					case 23:
                        MakeItem( pSock, pUser, 902 );
                        GoldSmithGump( pSock, pUser );
              			break;//Metal Shield
					case 24:
                        MakeItem( pSock, pUser, 904 );
                        GoldSmithGump( pSock, pUser );
