		...
		if( pUser.CheckSkill( 2, 0, pUser.skillCaps.animallore ))
		{
			...
			if( osiGumpEnabled )
			{
				...
				if( aosEnabled || coreShardEra >= EraStringToNum( "aos" ))
				{
					...
					animalLoreGump.AddHTMLGump( position, 92, 75, 18, false, false, ourObj.healthRegenBonus.toString() );
					...
					animalLoreGump.AddHTMLGump( position, 110, 75, 18, false, false, ourObj.staminaRegenBonus.toString() );
					...
					animalLoreGump.AddHTMLGump( position, 128, 75, 18, false, false, ourObj.manaRegenBonus.toString() );
