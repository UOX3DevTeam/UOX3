...
function onGumpPress( pSock, pButton, gumpData )
{
	...
	switch ( pButton )
	{
		...
		case 306:
			...
			pUser.StartTimer( gumpDelay, 3, true );
			pUser.SetTempTag( "MAKELAST", 306 );
			break;//Armoire
		case 307:
			MakeItem( pSock, pUser, 71 );
			pUser.StartTimer( gumpDelay, 3, true );
			pUser.SetTempTag( "MAKELAST", 307 );
			break;//Armoire
		case 308:
			MakeItem( pSock, pUser, 66 );
			pUser.StartTimer( gumpDelay, 3, true );
			pUser.SetTempTag( "MAKELAST", 308 );
			break;//Open Keg
		case 400:
		...
		case 706:
			...
			pUser.StartTimer( gumpDelay, 7, true );
			pUser.SetTempTag( "MAKELAST", 706 );
			break;//Dart Board ( S )
		case 707:
			MakeItem( pSock, pUser, 98 );
			pUser.StartTimer( gumpDelay, 7, true );
			pUser.SetTempTag( "MAKELAST", 707 );
			break;//Dart Board ( E )
		case 708:
			MakeItem( pSock, pUser, 99 );
			pUser.StartTimer( gumpDelay, 7, true );
			pUser.SetTempTag( "MAKELAST", 708 );
			break;//Ballot Box
		case 709:
			MakeItem( pSock, pUser, 100 );
			pUser.StartTimer( gumpDelay, 7, true );
			pUser.SetTempTag( "MAKELAST", 709 );
			break;//Pentagram
		case 710:
			MakeItem( pSock, pUser, 101 );
			pUser.StartTimer( gumpDelay, 7, true );
			pUser.SetTempTag( "MAKELAST", 710 );
			break;//Abbatoir
		case 800:
		...
		case 902:
			...
			pUser.StartTimer( gumpDelay, 9, true );
			pUser.SetTempTag( "MAKELAST", 902 );
			break;//Lg Forge ( S )
		case 903:
			MakeItem( pSock, pUser, 105 );
			pUser.StartTimer( gumpDelay, 9, true );
			pUser.SetTempTag( "MAKELAST", 903 );
			break;//Anvil ( E )
		case 904:
			MakeItem( pSock, pUser, 106 );
			pUser.StartTimer( gumpDelay, 9, true );
			pUser.SetTempTag( "MAKELAST", 904 );
			break;//Anvil ( S )
		case 1000:
			MakeItem( pSock, pUser, 111 );
			pUser.StartTimer( gumpDelay, 10, true );
			pUser.SetTempTag( "MAKELAST", 1000 );
			break;//Dummy ( E )
		case 1001:
			MakeItem( pSock, pUser, 112 );
			pUser.StartTimer( gumpDelay, 10, true );
			pUser.SetTempTag( "MAKELAST", 1001 );
			break;//Dummy ( S )
		case 1002:
			MakeItem( pSock, pUser, 113 );
			pUser.StartTimer( gumpDelay, 10, true );
			pUser.SetTempTag( "MAKELAST", 1002 );
			break;//Pickpocket ( E )
		case 1003:
			MakeItem( pSock, pUser, 114 );
			pUser.StartTimer( gumpDelay, 10, true );
			pUser.SetTempTag( "MAKELAST", 1003 );
			break;//Pickpocket ( S )
		case 2100:
			pSock.CloseGump( gumpID, 0 );
			pUser.SetTempTag( "ITEMDETAILS", 73 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Barrel Staves
		case 2101:
			pSock.CloseGump( gumpID, 0 );
			pUser.SetTempTag( "ITEMDETAILS", 74 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Barrel Lid
		case 2102:
			pSock.CloseGump( gumpID, 0 );
			pUser.SetTempTag( "ITEMDETAILS", 89 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//short music stand ( left )
		case 2103:
			pSock.CloseGump( gumpID, 0 );
			pUser.SetTempTag( "ITEMDETAILS", 90 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//short music stand ( right )
		case 2104:
			pUser.SetTempTag( "ITEMDETAILS", 91 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//tall music stand ( left )
		case 2105:
			pUser.SetTempTag( "ITEMDETAILS", 92 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//tall music stand ( left )
		case 2106:
			pUser.SetTempTag( "ITEMDETAILS", 76 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Easel ( S )
		case 2107:
			pUser.SetTempTag( "ITEMDETAILS", 77 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Easel ( E )
		case 2108:
			pUser.SetTempTag( "ITEMDETAILS", 78 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Easel ( N )
		case 2109:
			pUser.SetTempTag( "ITEMDETAILS", 79 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Fishing Pole
		case 2200:
			pUser.SetTempTag( "ITEMDETAILS", 50 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Barstool
		case 2201:
			pUser.SetTempTag( "ITEMDETAILS", 51 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Stool
		case 2202:
			pUser.SetTempTag( "ITEMDETAILS", 52 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Straw Chair
		case 2203:
			pUser.SetTempTag( "ITEMDETAILS", 53 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Wooden Chair
		case 2204:
			pUser.SetTempTag( "ITEMDETAILS", 57 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Vesper Style
		case 2205:
			pUser.SetTempTag( "ITEMDETAILS", 58 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Trinsic Style
		case 2206:
			pUser.SetTempTag( "ITEMDETAILS", 54 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Bench
		case 2207:
			pUser.SetTempTag( "ITEMDETAILS", 55 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Wooden Throne
		case 2208:
			pUser.SetTempTag( "ITEMDETAILS", 56 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Magincian Throne
		case 2209:
			pUser.SetTempTag( "ITEMDETAILS", 59 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			pUser.SetTempTag( "MAKELAST", 209 );
			break;//Small Table
		case 2210:
			pUser.SetTempTag( "ITEMDETAILS", 60 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Writing Table
		case 2211:
			pUser.SetTempTag( "ITEMDETAILS", 61 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Large Table
		case 2212:
			pUser.SetTempTag( "ITEMDETAILS", 62 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Yew-wood Table
		case 2300:
			pUser.SetTempTag( "ITEMDETAILS", 63 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Small Chest
		case 2301:
			pUser.SetTempTag( "ITEMDETAILS", 64 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Small Crate
		case 2302:
			pUser.SetTempTag( "ITEMDETAILS", 65 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Medium Crate
		case 2303:
			pUser.SetTempTag( "ITEMDETAILS", 67 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Large Crate
		case 2304:
			pUser.SetTempTag( "ITEMDETAILS", 68 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Chest
		case 2305:
			pUser.SetTempTag( "ITEMDETAILS", 69 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Bookshelf
		case 2306:
			pUser.SetTempTag( "ITEMDETAILS", 70 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Armoire
		case 2307:
			pUser.SetTempTag( "ITEMDETAILS", 71 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Armoire
		case 2308:
			pUser.SetTempTag( "ITEMDETAILS", 66 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Open Keg
		case 2400:
			pUser.SetTempTag( "ITEMDETAILS", 80 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Shepard's Crook
		case 2401:
			pUser.SetTempTag( "ITEMDETAILS", 81 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Quarter Staff
		case 2402:
			pUser.SetTempTag( "ITEMDETAILS", 82 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Gnarled Staff
		case 2403:
			pUser.SetTempTag( "ITEMDETAILS", 123 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Club
		case 2404:
			pUser.SetTempTag( "ITEMDETAILS", 124 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Black Staff
		case 2500:
			pUser.SetTempTag( "ITEMDETAILS", 75 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Wooden Shield
		case 2600:
			pUser.SetTempTag( "ITEMDETAILS", 83 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Lap Harp
		case 2601:
			pUser.SetTempTag( "ITEMDETAILS", 84 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Standing Harp
		case 2602:
			pUser.SetTempTag( "ITEMDETAILS", 85 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Drum
		case 2603:
			pUser.SetTempTag( "ITEMDETAILS", 86 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Lute
		case 2604:
			pUser.SetTempTag( "ITEMDETAILS", 87 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Tambourine
		case 2605:
			pUser.SetTempTag( "ITEMDETAILS", 88 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Tambourine ( tassel )
		case 2700:
			pUser.SetTempTag( "ITEMDETAILS", 93 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//bulletin board ( east )
		case 2701:
			pUser.SetTempTag( "ITEMDETAILS", 93 );
			...
			break;//bulletin board ( south )
		case 2702:
			pUser.SetTempTag( "ITEMDETAILS", 94 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Sm Bed ( E )
		case 2703:
			pUser.SetTempTag( "ITEMDETAILS", 93 );
			...
			break;//Sm Bed ( S )
		case 2704:
			pUser.SetTempTag( "ITEMDETAILS", 96 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Lg Bed ( E )
		case 2705:
			pUser.SetTempTag( "ITEMDETAILS", 95 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Lg Bed ( S )
		case 2706:
			pUser.SetTempTag( "ITEMDETAILS", 97 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Dart Board ( S )
		case 2707:
			pUser.SetTempTag( "ITEMDETAILS", 98 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Dart Board ( E )
		case 2708:
			pUser.SetTempTag( "ITEMDETAILS", 99 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Ballot Box
		case 2709:
			pUser.SetTempTag( "ITEMDETAILS", 100 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Pentagram
		case 2710:
			pUser.SetTempTag( "ITEMDETAILS", 101 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Abbatoir
		case 2800:
			pUser.SetTempTag( "ITEMDETAILS", 115 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Dressform
		case 2801:
			pUser.SetTempTag( "ITEMDETAILS", 116 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Dressform
		case 2802:
			pUser.SetTempTag( "ITEMDETAILS", 107 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Spin Wheel ( E )
		case 2803:
			pUser.SetTempTag( "ITEMDETAILS", 108 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Spin Wheel ( S )
		case 2804:
			pUser.SetTempTag( "ITEMDETAILS", 109 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Loom ( E )
		case 2805:
			pUser.SetTempTag( "ITEMDETAILS", 110 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Loom ( S )
		case 2806:
			pUser.SetTempTag( "ITEMDETAILS", 117 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Stone Oven ( E )
		case 2807:
			pUser.SetTempTag( "ITEMDETAILS", 118 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Stone Oven ( S )
		case 2808:
			pUser.SetTempTag( "ITEMDETAILS", 119 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Flour Mill ( E )
		case 2809:
			pUser.SetTempTag( "ITEMDETAILS", 120 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Flour Mill ( S )
		case 2810:
			pUser.SetTempTag( "ITEMDETAILS", 121 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Water Trough( E )
		case 2811:
			pUser.SetTempTag( "ITEMDETAILS", 122 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Water Trough( S )
		case 2900:
			pUser.SetTempTag( "ITEMDETAILS", 102 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Small Forge
		case 2901:
			pUser.SetTempTag( "ITEMDETAILS", 103 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Lg Forge ( E )
		case 2902:
			pUser.SetTempTag( "ITEMDETAILS", 104 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Lg Forge ( S )
		case 2903:
			pUser.SetTempTag( "ITEMDETAILS", 105 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Anvil ( E )
		case 2904:
			pUser.SetTempTag( "ITEMDETAILS", 106 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Anvil ( S )
		case 2950:
			pUser.SetTempTag( "ITEMDETAILS", 111 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Dummy ( E )
		case 2951:
			pUser.SetTempTag( "ITEMDETAILS", 112 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Dummy ( S )
		case 2952:
			pUser.SetTempTag( "ITEMDETAILS", 113 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Pickpocket ( E )
		case 2953:
			pUser.SetTempTag( "ITEMDETAILS", 114 );
			TriggerEvent( itemDetailsID, "ItemDetailGump", pUser );
			break;//Pickpocket ( S )
		case 5000:
