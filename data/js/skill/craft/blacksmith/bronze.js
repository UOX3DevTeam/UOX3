...
function onTimer(pUser, timerID)
{
	...
	{
		case 1:
			TriggerEvent(bronzeID, "page1", socket, pUser);
			break;
		case 2:
			TriggerEvent(bronzeID, "page2", socket, pUser);
			break;
		case 3:
			TriggerEvent(bronzeID, "page3", socket, pUser);
			break;
		case 4:
			TriggerEvent(bronzeID, "page4", socket, pUser);
			break;
		case 5:
			TriggerEvent(bronzeID, "page5", socket, pUser);
			break;
		case 6:
			TriggerEvent(bronzeID, "page6", socket, pUser);
			break;
		case 7:
			TriggerEvent(bronzeID, "page7", socket, pUser);
			break;
		case 8:
			TriggerEvent(bronzeID, "page8", socket, pUser);
			break;
	}
}
