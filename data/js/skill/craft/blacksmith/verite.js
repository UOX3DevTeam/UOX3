...
function onTimer(pUser, timerID)
{
	...
	{
		case 1:
			TriggerEvent(veriteID, "page1", socket, pUser);
			break;
		case 2:
			TriggerEvent(veriteID, "page2", socket, pUser);
			break;
		case 3:
			TriggerEvent(veriteID, "page3", socket, pUser);
			break;
		case 4:
			TriggerEvent(veriteID, "page4", socket, pUser);
			break;
		case 5:
			TriggerEvent(veriteID, "page5", socket, pUser);
			break;
		case 6:
			TriggerEvent(veriteID, "page6", socket, pUser);
			break;
		case 7:
			TriggerEvent(veriteID, "page7", socket, pUser);
			break;
		case 8:
			TriggerEvent(veriteID, "page8", socket, pUser);
			break;
	}
}
