...
function onTimer(pUser, timerID)
{
	...
	{
		case 1:
			TriggerEvent(copperID, "page1", socket, pUser);
			break;
		case 2:
			TriggerEvent(copperID, "page2", socket, pUser);
			break;
		case 3:
			TriggerEvent(copperID, "page3", socket, pUser);
			break;
		case 4:
			TriggerEvent(copperID, "page4", socket, pUser);
			break;
		case 5:
			TriggerEvent(copperID, "page5", socket, pUser);
			break;
		case 6:
			TriggerEvent(copperID, "page6", socket, pUser);
			break;
		case 7:
			TriggerEvent(copperID, "page7", socket, pUser);
			break;
		case 8:
			TriggerEvent(copperID, "page8", socket, pUser);
			break;
	}
}
