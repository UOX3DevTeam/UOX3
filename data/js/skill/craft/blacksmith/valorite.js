...
function onTimer(pUser, timerID)
{
	...
	{
		case 1:
			TriggerEvent(valoriteID, "page1", socket, pUser);
			break;
		case 2:
			TriggerEvent(valoriteID, "page2", socket, pUser);
			break;
		case 3:
			TriggerEvent(valoriteID, "page3", socket, pUser);
			break;
		case 4:
			TriggerEvent(valoriteID, "page4", socket, pUser);
			break;
		case 5:
			TriggerEvent(valoriteID, "page5", socket, pUser);
			break;
		case 6:
			TriggerEvent(valoriteID, "page6", socket, pUser);
			break;
		case 7:
			TriggerEvent(valoriteID, "page7", socket, pUser);
			break;
		case 8:
			TriggerEvent(valoriteID, "page8", socket, pUser);
			break;
	}
}
