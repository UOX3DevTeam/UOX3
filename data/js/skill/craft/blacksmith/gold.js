...
function onTimer(pUser, timerID)
{
	...
	{
		case 1:
			TriggerEvent(goldID, "page1", socket, pUser);
			break;
		case 2:
			TriggerEvent(goldID, "page2", socket, pUser);
			break;
		case 3:
			TriggerEvent(goldID, "page3", socket, pUser);
			break;
		case 4:
			TriggerEvent(goldID, "page4", socket, pUser);
			break;
		case 5:
			TriggerEvent(goldID, "page5", socket, pUser);
			break;
		case 6:
			TriggerEvent(goldID, "page6", socket, pUser);
			break;
		case 7:
			TriggerEvent(goldID, "page7", socket, pUser);
			break;
		case 8:
			TriggerEvent(goldID, "page8", socket, pUser);
			break;
	}
}
