...
function onTimer(pUser, timerID)
{
	...
	{
		case 1:
			TriggerEvent(agapiteID, "page1", socket, pUser);
			break;
		case 2:
			TriggerEvent(agapiteID, "page2", socket, pUser);
			break;
		case 3:
			TriggerEvent(agapiteID, "page3", socket, pUser);
			break;
		case 4:
			TriggerEvent(agapiteID, "page4", socket, pUser);
			break;
		case 5:
			TriggerEvent(agapiteID, "page5", socket, pUser);
			break;
		case 6:
			TriggerEvent(agapiteID, "page6", socket, pUser);
			break;
		case 7:
			TriggerEvent(agapiteID, "page7", socket, pUser);
			break;
		case 8:
			TriggerEvent(agapiteID, "page8", socket, pUser);
			break;
	}
}
