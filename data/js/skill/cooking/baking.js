...
{
	Baking(tSock, targSerial)
}

function Baking(tSock, targSerial)
{
...
function onTimer(pUser, timerID)
{
	...
	switch (timerID)
	{
		case 1:
			...
			socket.SysMessage("you baked a pie");
		...
		case 7:
			...
			socket.SysMessage("you baked a cake");
			pUser.SetTag("CookingDelay", null)
			break;
		case 8:
			CreateDFNItem(socket, pUser, "0x160B", 1, "ITEM", true);
			socket.SysMessage("you baked a cookies");
			pUser.SetTag("CookingDelay", null)
			break;
	}
}
