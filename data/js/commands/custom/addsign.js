...
var signtypes = [0xB95, 0xB96, 0xBA3, 0xBA4, 0xBA5, 0xBA6, 0xBA7, 0xBA8, 0xBA9, 0xBAA, 0xBAB, 0xBAC, 0xBAD, 0xBAE, 0xBAF, 0xBB0, 0xBB1, 0xBB2, 0xBB3, 0xBB4,
...
{
	myGump.AddBackground( 0, 0, width - 00, height - 00, 0xE10 );
	myGump.AddBackground( 8, 5, width - 16, height - 11, 0x053 );
	myGump.AddTiledGump( 15, 14, width - 29, height - 29, 0xE14 );
	myGump.AddCheckerTrans( 15, 14, width - 29, height - 29 );
}
	...
	for ( var i = 0; i < signtypes.length; i++ )
	{
		switch ( pButton )
		{
			case 0:
				break;
			case i + 1:
				pUser.ExecuteCommand( "radd " + signtypes[i] );
