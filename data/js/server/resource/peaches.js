...
{ 
	...
	if( loot == 1 || loot == 2 )
	{
		srcSock.SysMessage( "You don't manage to pick peaches." );
		return;
	}
	if( loot == 3 ) 
	{
		srcSock.SysMessage( "You pick a peach." );
		var itemMade = SpawnItem( srcSock, pUser, "0x09d2", false );	// makes an item and puts in Char's pack
