...
// Object Types
  ...
  interface Item extends BaseObject {
    ...
    readonly  canBeLockedDown:   boolean;
              cannonActionTime:  number;
              cannonArtEast:     number;
              cannonArtNorth:    number;
              cannonArtSouth:    number;
              cannonArtWest:     number;
              cannonLinkSerial:  number;
              cannonPower:       number;
              cannonRange:       number;
              cannonRole:        number;
              cannonStage:       number;
    ...
    readonly  isShipCannon:      boolean;
    readonly  isWeaponPad:       boolean;
              isWipeable:        boolean;
              itemsinside:       number;
              layer:             number;
              lodamage:          number;
  ...
  interface Multi extends Item {
    ...
    CanCommandShip( toCheck: Character ): boolean;
    CheckDryDock(): number;
    ClearBanList(): void;
    ClearFriendList(): void;
    ClearGuestList(): void;
    ClearOwnerList(): void;
    DamageHull( amount: number ): boolean;
    DeleteForDryDock( deed: Item ): boolean;
    FinishedChars( listType?: string ): boolean;
    FirstChar( listType?: string ): CharOrNull;
    GetHold(): ItemOrNull;
    GetHullHits(): number;
    GetHullMaxHits(): number;
    GetMultiCorner( corner: number ): string;
    GetSecurityLevel( toCheck: Character ): number;
    GetShipAccessSetting( setting: number ): number;
    GetTiller(): ItemOrNull;
    HasShipAccess( toCheck: Character ): boolean;
    IsInMulti( toCheck: BaseObject ): boolean;
    IsNearLandOrDocks(): boolean;
    ...
    RemoveShipPaint(): boolean;
    RemoveTrashCont( toRemove: Item ): boolean;
    RemoveVendor( vendorToRemove: Character ): boolean;
    RepairHull( amount: number ): number;
    ResetShipSecurity(): boolean;
    SailBoat( direction: number ): void;
    SecureContainer( toSecure: Item ): boolean;
    SetSecurityLevel( character: Character, level: number ): boolean;
    SetShipAccessSetting( setting: number, value: number ): boolean;
    StartEmergencyRepairs( seconds: number ): boolean;
...
// Event Functions
  ...
  function onSellToVendor( targSock: Socket, objVendor: Character, objItemSold: BaseObject, numItemsSelling: number ): boolean;
  function onSkill( skillUse: BaseObject, skillUsed: number, objType: 0 | 1 ): boolean;
  function onSkillChange( player: Character, skill: number, skillAmtChanged: number ): void;
  function onSkillCheck( myChar: Character, skill: number, lowSkill: number, highSkill: number, isCraftSkill: boolean ): boolean;
  function onSkillGain( player: Character, skill: number, skillAmtGained: number ): boolean;
  function onSkillGump( mChar: Character ): boolean;
  ...
  function onSpawn( objSpawned: BaseObject, spawnRegion: number ): void;
  ...
  function onStatGained( player: Character, stat: number, skill: number, statGainedAmount: number ): boolean;
  function onStatLoss( player: Character, stat: number, statLossAmount: number ): boolean;
  ...
  function onSwing( swinging: Item, swinger: Character, swingTarg: Character ): boolean;
  function onSystemSlice(): void;
  function onTalk( myChar: Character, mySpeech: string ): boolean;
  function onTempChange( tObject: BaseObject, temp: number ): void;
  function onThirstChange( pChanging: Character, newStatus: number ): boolean;
  function onTimer( tObject: BaseObject, timerId: number ): void;
  function onTooltip( myObj: BaseObject, pSocket: Socket ): string;
  function onUnequip( equipper: Character, equipping: Item ): boolean;
  function onUnequipAttempt( equipper: Character, equipping: Item ): boolean;
  function onUseBandageMacro( mSock: Socket, targChar: Character, bandageItem: Item ): boolean;
  function onUseChecked( user: Character, iUsing: Item ): boolean;
  function onUseUnChecked( user: Character, iUsing: Item ): boolean;
  function onVirtueGumpPress( mChar: Character, tChar: Character, buttonId: number ): boolean;
  function onWarModeToggle( mChar: Character ): boolean;
