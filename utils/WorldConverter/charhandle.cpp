...
//o---------------------------------------------------------------------------o
CChar& cCharacterHandle::operator[] ( long int Num )
{
	...
	{
		printf( "ERROR: Chars[%i] referenced is invalid. Crash averted!", Num );
	}  
